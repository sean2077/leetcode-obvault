...
aliases:
  ...
  - vvXgSW
  - 合并 K 个升序链表
lcLink: https://leetcode.com/problems/vvXgSW/
lcTopics:
  - '[[linked-list]]'
  - '[[divide-and-conquer]]'
  - '[[heap-priority-queue]]'
...
**Nav:** << previous: [[LCR 077.7WHec2]] | next: [[LCR 079.TVdhkn]] >>
...
[submissions](https://leetcode.com/problems/vvXgSW/submissions/) | [solutions](https://leetcode.com/problems/vvXgSW/solutions/)
