...
aliases:
  ...
  - number-of-good-paths
  - 好路径的数目
lcLink: https://leetcode.com/problems/number-of-good-paths/
lcTopics:
  - '[[tree]]'
  - '[[union-find]]'
  - '[[graph]]'
...
similarQuestions:
  ...
  - '[[1865.checking-existence-of-edge-length-limited-paths-ii|1865.检查边长度限制的路径是否存在
    II]]'
  - '[[1873.longest-nice-substring|1873.最长的美好子字符串]]'
  - '[[2280.count-good-triplets-in-an-array|2280.统计数组中好三元组数目]]'
  - '[[2594.count-pairs-of-similar-strings|2594.统计相似字符串对的数目]]'
grade: ⭐⭐⭐⭐⭐
likes: 2232
dislikes: 104
favorites: []
...
**Nav:** << previous: [[2504.find-all-good-indices]] | next: [[2506.minimize-maximum-value-in-a-grid]] >>
