...
aliases:
  ...
  - find-the-winning-player-in-coin-game
  - 求出硬币游戏的赢家
lcLink: https://leetcode.com/problems/find-the-winning-player-in-coin-game/
lcTopics:
  - '[[math]]'
  - '[[game-theory]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[3508.number-of-bit-changes-to-make-two-integers-equal]] | next: [[3512.bitwise-user-permissions-analysis]] >>
