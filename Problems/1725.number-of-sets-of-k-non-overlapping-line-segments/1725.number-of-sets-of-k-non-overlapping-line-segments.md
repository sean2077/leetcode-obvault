...
aliases:
  ...
  - number-of-sets-of-k-non-overlapping-line-segments
  - 大小为 K 的不重叠线段的数目
lcLink: https://leetcode.com/problems/number-of-sets-of-k-non-overlapping-line-segments/
lcTopics:
  - '[[math]]'
  - '[[dynamic-programming]]'
  - '[[combinatorics]]'
...
**Nav:** << previous: [[1724.customer-who-visited-but-did-not-make-any-transactions]] | next: [[1726.coordinate-with-maximum-network-quality]] >>
