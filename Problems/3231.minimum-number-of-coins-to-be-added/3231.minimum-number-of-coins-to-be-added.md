...
aliases:
  ...
  - minimum-number-of-coins-to-be-added
  - 需要添加的硬币的最小数量
lcLink: https://leetcode.com/problems/minimum-number-of-coins-to-be-added/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[3230.remove-adjacent-almost-equal-characters]] | next: [[3232.maximum-gcd-sum-of-a-subarray]] >>
