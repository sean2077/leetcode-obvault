...
aliases:
  ...
  - minimum-cost-to-make-array-equalindromic
  - 使数组成为等数数组的最小代价
lcLink: https://leetcode.com/problems/minimum-cost-to-make-array-equalindromic/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[math]]'
...
**Nav:** << previous: [[3228.maximum-size-of-a-set-after-removals]] | next: [[3230.remove-adjacent-almost-equal-characters]] >>
