...
aliases:
  ...
  - stone-game-iv
  - 石子游戏 IV
lcLink: https://leetcode.com/problems/stone-game-iv/
lcTopics:
  - '[[math]]'
  - '[[dynamic-programming]]'
  - '[[game-theory]]'
...
**Nav:** << previous: [[1616.minimum-difference-between-largest-and-smallest-value-in-three-moves]] | next: [[1618.delete-n-nodes-after-m-nodes-of-a-linked-list]] >>
