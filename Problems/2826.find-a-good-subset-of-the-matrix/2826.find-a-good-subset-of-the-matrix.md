...
aliases:
  ...
  - find-a-good-subset-of-the-matrix
  - 找到矩阵中的好子集
lcLink: https://leetcode.com/problems/find-a-good-subset-of-the-matrix/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2825.minimize-string-length]] | next: [[2827.greatest-common-divisor-traversal]] >>
