...
aliases:
  ...
  - maximum-total-reward-using-operations-i
  - 执行操作可获得的最大总奖励 I
lcLink: https://leetcode.com/problems/maximum-total-reward-using-operations-i/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3441.equalize-strings-by-adding-or-removing-characters-at-ends]] | next: [[3443.maximum-total-reward-using-operations-ii]] >>
