...
aliases:
  ...
  - minimize-maximum-of-array
  - 最小化数组中的最大值
lcLink: https://leetcode.com/problems/minimize-maximum-of-array/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[2529.range-product-queries-of-powers]] | next: [[2531.create-components-with-same-value]] >>
