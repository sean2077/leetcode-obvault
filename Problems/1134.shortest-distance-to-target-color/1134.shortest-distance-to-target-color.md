...
aliases:
  ...
  - shortest-distance-to-target-color
  - 与目标颜色间的最短距离
lcLink: https://leetcode.com/problems/shortest-distance-to-target-color/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1133.last-substring-in-lexicographical-order]] | next: [[1135.customers-who-bought-all-products]] >>
