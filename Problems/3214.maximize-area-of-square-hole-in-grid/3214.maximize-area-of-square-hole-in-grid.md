...
aliases:
  ...
  - maximize-area-of-square-hole-in-grid
  - 最大化网格图中正方形空洞的面积
lcLink: https://leetcode.com/problems/maximize-area-of-square-hole-in-grid/
lcTopics:
  - '[[array]]'
  - '[[sorting]]'
lcDifficulty: Medium
...
similarQuestions:
  ...
  - '[[3250.maximum-square-area-by-removing-fences-from-a-field|3250.移除栅栏得到的正方形田地的最大面积]]'
grade: ⭐⭐
likes: 224
dislikes: 146
favorites: []
...
**Nav:** << previous: [[3213.count-subarrays-where-max-element-appears-at-least-k-times]] | next: [[3215.matrix-similarity-after-cyclic-shifts]] >>
