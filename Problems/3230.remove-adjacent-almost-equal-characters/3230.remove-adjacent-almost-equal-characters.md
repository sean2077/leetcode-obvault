...
aliases:
  ...
  - remove-adjacent-almost-equal-characters
  - 消除相邻近似相等字符
lcLink: https://leetcode.com/problems/remove-adjacent-almost-equal-characters/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 52.5%
similarQuestions:
  - '[[1884.minimum-changes-to-make-alternating-binary-string|1884.生成交替二进制字符串的最少操作数]]'
grade: ⭐⭐⭐⭐
likes: 160
dislikes: 20
favorites: []
...
**Nav:** << previous: [[3229.minimum-cost-to-make-array-equalindromic]] | next: [[3231.minimum-number-of-coins-to-be-added]] >>
