...
aliases:
  ...
  - number-of-good-ways-to-split-a-string
  - 字符串的好分割数目
lcLink: https://leetcode.com/problems/number-of-good-ways-to-split-a-string/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[1631.number-of-sub-arrays-with-odd-sum]] | next: [[1633.minimum-number-of-increments-on-subarrays-to-form-a-target-array]] >>
