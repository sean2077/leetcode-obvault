...
aliases:
  ...
  - redistribute-characters-to-make-all-strings-equal
  - 重新分配字符使所有字符串都相等
lcLink: https://leetcode.com/problems/redistribute-characters-to-make-all-strings-equal/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[counting]]'
...
**Nav:** << previous: [[2024.calculate-special-bonus]] | next: [[2026.merge-triplets-to-form-target-triplet]] >>
