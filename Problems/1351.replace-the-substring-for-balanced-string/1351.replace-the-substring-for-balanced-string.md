...
aliases:
  ...
  - replace-the-substring-for-balanced-string
  - 替换子串得到平衡字符串
lcLink: https://leetcode.com/problems/replace-the-substring-for-balanced-string/
lcTopics:
  - '[[string]]'
  - '[[sliding-window]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1350.remove-sub-folders-from-the-filesystem]] | next: [[1352.maximum-profit-in-job-scheduling]] >>
