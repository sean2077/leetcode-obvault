...
aliases:
  ...
  - sender-with-largest-word-count
  - 最多单词数的发件人
lcLink: https://leetcode.com/problems/sender-with-largest-word-count/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[2377.check-if-number-has-equal-digit-count-and-digit-value]] | next: [[2379.maximum-total-importance-of-roads]] >>
