...
aliases:
  ...
  - xor-queries-of-a-subarray
  - 子数组异或查询
lcLink: https://leetcode.com/problems/xor-queries-of-a-subarray/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[1434.decrypt-string-from-alphabet-to-integer-mapping]] | next: [[1436.get-watched-videos-by-your-friends]] >>
