...
aliases:
  ...
  - removing-minimum-number-of-magic-beans
  - 拿出最少数目的魔法豆
lcLink: https://leetcode.com/problems/removing-minimum-number-of-magic-beans/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[enumeration]]'
...
**Nav:** << previous: [[2289.minimum-operations-to-make-the-array-alternating]] | next: [[2291.maximum-and-sum-of-array]] >>
