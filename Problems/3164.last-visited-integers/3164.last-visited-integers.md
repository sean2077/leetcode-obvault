...
aliases:
  ...
  - last-visited-integers
  - 上一个遍历的整数
lcLink: https://leetcode.com/problems/last-visited-integers/
lcTopics:
  - '[[array]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3163.subarrays-distinct-element-sum-of-squares-i]] | next: [[3165.find-indices-with-index-and-value-difference-i]] >>
