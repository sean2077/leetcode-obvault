...
lcAcRate: 20.9%
similarQuestions:
  - '[[1041.available-captures-for-rook|1041.可以被一步捕获的棋子数]]'
  - '[[1342.queens-that-can-attack-the-king|1342.可以攻击国王的皇后]]'
grade: ⭐
likes: 150
dislikes: 194
favorites: []
...
**Nav:** << previous: [[3269.number-of-subarrays-that-match-a-pattern-i]] | next: [[3271.count-the-number-of-houses-at-a-certain-distance-i]] >>
