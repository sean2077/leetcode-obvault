...
aliases:
  ...
  - divide-players-into-teams-of-equal-skill
  - 划分技能点相等的团队
lcLink: https://leetcode.com/problems/divide-players-into-teams-of-equal-skill/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[two-pointers]]'
...
**Nav:** << previous: [[2580.circular-sentence]] | next: [[2582.minimum-score-of-a-path-between-two-cities]] >>
