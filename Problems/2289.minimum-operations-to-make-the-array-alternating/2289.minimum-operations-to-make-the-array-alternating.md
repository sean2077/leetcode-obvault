...
aliases:
  ...
  - minimum-operations-to-make-the-array-alternating
  - 使数组变成交替数组的最少操作数
lcLink: https://leetcode.com/problems/minimum-operations-to-make-the-array-alternating/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
similarQuestions:
  ...
  - '[[2017.minimum-number-of-flips-to-make-the-binary-string-alternating|2017.使二进制字符串字符交替的最少反转次数]]'
grade: ⭐⭐
likes: 579
dislikes: 331
favorites: []
...
**Nav:** << previous: [[2288.count-operations-to-obtain-zero]] | next: [[2290.removing-minimum-number-of-magic-beans]] >>
