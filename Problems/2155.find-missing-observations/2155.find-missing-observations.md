...
aliases:
  ...
  - find-missing-observations
  - 找出缺失的观测数据
lcLink: https://leetcode.com/problems/find-missing-observations/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[simulation]]'
...
lcAcRate: 46.8%
similarQuestions:
  - '[[1263.number-of-dice-rolls-with-target-sum|1263.掷骰子等于目标和的方法数]]'
...
**Nav:** << previous: [[2154.minimum-moves-to-convert-string]] | next: [[2156.stone-game-ix]] >>
