...
aliases:
  ...
  - maximum-number-of-coins-you-can-get
  - 你可以获得的最大硬币数目
lcLink: https://leetcode.com/problems/maximum-number-of-coins-you-can-get/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[math]]'
...
**Nav:** << previous: [[1682.most-visited-sector-in-a-circular-track]] | next: [[1684.find-latest-group-of-size-m]] >>
