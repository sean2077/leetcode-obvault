...
aliases:
  ...
  - using-a-robot-to-print-the-lexicographically-smallest-string
  - 使用机器人打印字典序最小的字符串
lcLink: https://leetcode.com/problems/using-a-robot-to-print-the-lexicographically-smallest-string/
lcTopics:
  - '[[stack]]'
  - '[[greedy]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2519.find-the-original-array-of-prefix-xor]] | next: [[2521.paths-in-matrix-whose-sum-is-divisible-by-k]] >>
