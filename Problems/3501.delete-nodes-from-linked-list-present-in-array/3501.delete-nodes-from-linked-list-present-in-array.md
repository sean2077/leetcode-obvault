...
aliases:
  ...
  - delete-nodes-from-linked-list-present-in-array
  - 从链表中移除在数组中存在的节点
lcLink: https://leetcode.com/problems/delete-nodes-from-linked-list-present-in-array/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[linked-list]]'
...
**Nav:** << previous: [[3500.minimum-cost-for-cutting-cake-ii]] | next: [[3503.find-top-scoring-students-ii]] >>
