...
aliases:
  ...
  - number-of-ways-to-reconstruct-a-tree
  - 重构一棵树的方案数
lcLink: https://leetcode.com/problems/number-of-ways-to-reconstruct-a-tree/
lcTopics:
  - '[[tree]]'
  - '[[graph]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[2590.maximum-star-sum-of-a-graph|2590.图中最大星和]]'
grade: ⭐
likes: 218
dislikes: 153
favorites: []
...
**Nav:** << previous: [[1819.construct-the-lexicographically-largest-valid-sequence]] | next: [[1821.products-worth-over-invoices]] >>
