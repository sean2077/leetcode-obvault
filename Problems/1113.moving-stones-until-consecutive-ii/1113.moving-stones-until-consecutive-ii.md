...
aliases:
  ...
  - moving-stones-until-consecutive-ii
  - 移动石子直到连续 II
lcLink: https://leetcode.com/problems/moving-stones-until-consecutive-ii/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[two-pointers]]'
...
**Nav:** << previous: [[1112.find-words-that-can-be-formed-by-characters]] | next: [[1114.binary-search-tree-to-greater-sum-tree]] >>
