...
aliases:
  ...
  - partition-string-into-substrings-with-values-at-most-k
  - 将字符串分割成值不超过 K 的子字符串
lcLink: https://leetcode.com/problems/partition-string-into-substrings-with-values-at-most-k/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[2510.maximum-deletions-on-a-string]] | next: [[2512.longest-uploaded-prefix]] >>
