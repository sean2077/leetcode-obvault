...
aliases:
  ...
  - split-with-minimum-sum
  - 最小和分割
lcLink: https://leetcode.com/problems/split-with-minimum-sum/
lcTopics:
  - '[[greedy]]'
  - '[[math]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[2649.count-total-number-of-colored-cells]] | next: [[2651.count-ways-to-group-overlapping-ranges]] >>
