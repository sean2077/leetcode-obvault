...
aliases:
  ...
  - removing-minimum-and-maximum-from-array
  - 从数组中移除最大值和最小值
lcLink: https://leetcode.com/problems/removing-minimum-and-maximum-from-array/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2211.k-radius-subarray-averages]] | next: [[2213.find-all-people-with-secret]] >>
