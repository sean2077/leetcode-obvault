...
aliases:
  ...
  - shortest-way-to-form-string
  - 形成字符串的最短路径
lcLink: https://leetcode.com/problems/shortest-way-to-form-string/
lcTopics:
  - '[[greedy]]'
  - '[[two-pointers]]'
  - '[[string]]'
...
**Nav:** << previous: [[1050.construct-binary-search-tree-from-preorder-traversal]] | next: [[1052.campus-bikes]] >>
