...
aliases:
  ...
  - count-subarrays-where-max-element-appears-at-least-k-times
  - 统计最大元素出现至少 K 次的子数组
lcLink: https://leetcode.com/problems/count-subarrays-where-max-element-appears-at-least-k-times/
lcTopics:
  - '[[array]]'
  - '[[sliding-window]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3212.count-the-number-of-good-partitions]] | next: [[3214.maximize-area-of-square-hole-in-grid]] >>
