...
lcAcRate: 51.8%
similarQuestions:
  - '[[1679.shortest-subarray-to-be-removed-to-make-array-sorted|1679.删除最短的子数组使剩余数组有序]]'
  - '[[3269.number-of-subarrays-that-match-a-pattern-i|3269.匹配模式数组的子数组数目 I]]'
grade: ⭐⭐
likes: 144
dislikes: 90
favorites: []
...
**Nav:** << previous: [[3251.maximum-area-of-longest-diagonal-rectangle]] | next: [[3253.symmetric-coordinates]] >>
