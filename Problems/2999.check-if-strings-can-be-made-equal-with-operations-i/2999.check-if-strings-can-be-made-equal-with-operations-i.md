...
aliases:
  ...
  - check-if-strings-can-be-made-equal-with-operations-i
  - 判断通过操作能否让字符串相等 I
lcLink: https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-i/
lcTopics:
  - '[[string]]'
lcDifficulty: Easy
lcAcRate: 47.1%
...
**Nav:** << previous: [[2998.count-symmetric-integers]] | next: [[3000.minimum-absolute-difference-between-elements-with-constraint]] >>
