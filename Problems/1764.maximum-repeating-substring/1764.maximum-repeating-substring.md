...
aliases:
  ...
  - maximum-repeating-substring
  - 最大重复子字符串
lcLink: https://leetcode.com/problems/maximum-repeating-substring/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
  - '[[string-matching]]'
...
lcAcRate: 38.8%
similarQuestions:
  - '[[1689.detect-pattern-of-length-m-repeated-k-or-more-times|1689.重复至少 K 次且长度为
    M 的模式]]'
  - '[[3384.minimum-number-of-operations-to-make-word-k-periodic|3384.K 周期字符串需要的最少操作次数]]'
grade: ⭐⭐⭐
likes: 699
dislikes: 266
favorites: []
...
**Nav:** << previous: [[1763.all-valid-triplets-that-can-represent-a-country]] | next: [[1765.merge-in-between-linked-lists]] >>
