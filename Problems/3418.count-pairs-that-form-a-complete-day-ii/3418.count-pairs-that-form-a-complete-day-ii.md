...
aliases:
  ...
  - count-pairs-that-form-a-complete-day-ii
  - 构成整天的下标对数目 II
lcLink: https://leetcode.com/problems/count-pairs-that-form-a-complete-day-ii/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[counting]]'
...
**Nav:** << previous: [[3417.find-the-index-of-permutation]] | next: [[3419.maximum-points-inside-the-square]] >>
