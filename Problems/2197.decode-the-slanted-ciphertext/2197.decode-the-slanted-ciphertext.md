...
aliases:
  ...
  - decode-the-slanted-ciphertext
  - 解码斜向换位密码
lcLink: https://leetcode.com/problems/decode-the-slanted-ciphertext/
lcTopics:
  - '[[string]]'
  - '[[simulation]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2196.reverse-nodes-in-even-length-groups]] | next: [[2198.process-restricted-friend-requests]] >>
