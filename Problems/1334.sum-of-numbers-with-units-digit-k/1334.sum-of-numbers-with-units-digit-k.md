...
aliases:
  ...
  - sum-of-numbers-with-units-digit-k
  - 个位数字为 K 的整数之和
lcLink: https://leetcode.com/problems/sum-of-numbers-with-units-digit-k/
lcTopics:
  - '[[greedy]]'
  - '[[math]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 26.8%
similarQuestions:
  - '[[1068.digit-count-in-range|1068.范围内的数字计数]]'
  - '[[2298.count-integers-with-even-digit-sum|2298.统计各位数字之和为偶数的整数个数]]'
  - '[[2541.sum-of-number-and-its-reverse|2541.反转之后的数字和]]'
grade: ⭐
likes: 404
dislikes: 326
favorites: []
...
**Nav:** << previous: [[1333.sort-the-jumbled-numbers]] | next: [[1335.maximum-candies-allocated-to-k-children]] >>
