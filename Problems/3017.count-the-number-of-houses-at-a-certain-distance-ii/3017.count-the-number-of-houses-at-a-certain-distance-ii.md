...
aliases:
  ...
  - count-the-number-of-houses-at-a-certain-distance-ii
  - 按距离统计房屋对数目 II
lcLink: https://leetcode.com/problems/count-the-number-of-houses-at-a-certain-distance-ii/
lcTopics:
  - '[[graph]]'
  - '[[prefix-sum]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[3016.minimum-number-of-pushes-to-type-word-ii]] | next: [[3018.maximum-number-of-removal-queries-that-can-be-processed-i]] >>
