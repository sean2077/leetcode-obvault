...
aliases:
  ...
  - extract-kth-character-from-the-rope-tree
  - 从 Rope 树中提取第 K 个字符
lcLink: https://leetcode.com/problems/extract-kth-character-from-the-rope-tree/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[binary-tree]]'
...
**Nav:** << previous: [[2842.find-active-users]] | next: [[2844.sum-of-squares-of-special-elements]] >>
