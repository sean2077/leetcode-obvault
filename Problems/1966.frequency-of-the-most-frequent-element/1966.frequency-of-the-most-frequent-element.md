...
lcAcRate: 44.3%
similarQuestions:
  - '[[2270.find-all-lonely-numbers-in-the-array|2270.找出数组中的所有孤独数字]]'
  - '[[2478.longest-nice-subarray|2478.最长优雅子数组]]'
  - '[[3196.apply-operations-to-maximize-frequency-score|3196.执行操作使频率分数最大]]'
grade: ⭐⭐⭐⭐⭐
likes: 4620
dislikes: 209
favorites: []
...
**Nav:** << previous: [[1965.sum-of-digits-in-base-k]] | next: [[1967.longest-substring-of-all-vowels-in-order]] >>
