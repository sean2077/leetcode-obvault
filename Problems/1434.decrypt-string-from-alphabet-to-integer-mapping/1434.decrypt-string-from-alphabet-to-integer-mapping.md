...
aliases:
  ...
  - decrypt-string-from-alphabet-to-integer-mapping
  - 解码字母到整数映射
lcLink: https://leetcode.com/problems/decrypt-string-from-alphabet-to-integer-mapping/
lcTopics:
  - '[[string]]'
lcDifficulty: Easy
lcAcRate: 79.8%
...
**Nav:** << previous: [[1433.encrypt-and-decrypt-strings]] | next: [[1435.xor-queries-of-a-subarray]] >>
