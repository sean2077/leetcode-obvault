...
lcLink: https://leetcode.com/problems/minimum-operations-to-make-binary-array-elements-equal-to-one-i/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[queue]]'
  - '[[array]]'
...
**Nav:** << previous: [[3474.better-compression-of-string]] | next: [[3476.find-minimum-operations-to-make-all-elements-divisible-by-three]] >>
