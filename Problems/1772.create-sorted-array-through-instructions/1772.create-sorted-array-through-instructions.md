...
aliases:
  ...
  - create-sorted-array-through-instructions
  - 通过指令创建有序数组
lcLink: https://leetcode.com/problems/create-sorted-array-through-instructions/
lcTopics:
  - '[[binary-indexed-tree]]'
  - '[[segment-tree]]'
  - '[[array]]'
...
**Nav:** << previous: [[1771.sell-diminishing-valued-colored-balls]] | next: [[1773.percentage-of-users-attended-a-contest]] >>
