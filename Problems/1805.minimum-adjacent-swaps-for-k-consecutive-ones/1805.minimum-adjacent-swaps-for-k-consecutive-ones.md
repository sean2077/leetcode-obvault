...
lcAcRate: 42.7%
similarQuestions:
  - '[[1107.minimum-swaps-to-group-all-1s-together|1107.最少交换次数来组合所有的 1]]'
  - '[[2119.minimum-number-of-operations-to-make-array-continuous|2119.使数组连续的最少操作数]]'
  - '[[2474.minimum-adjacent-swaps-to-make-a-valid-array|2474.生成有效数组的最少交换次数]]'
grade: ⭐⭐⭐⭐⭐
likes: 713
dislikes: 26
favorites: []
...
**Nav:** << previous: [[1804.maximum-binary-string-after-change]] | next: [[1806.count-of-matches-in-tournament]] >>
