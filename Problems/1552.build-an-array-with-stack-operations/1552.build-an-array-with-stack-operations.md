...
aliases:
  ...
  - build-an-array-with-stack-operations
  - 用栈操作构建数组
lcLink: https://leetcode.com/problems/build-an-array-with-stack-operations/
lcTopics:
  - '[[stack]]'
  - '[[array]]'
  - '[[simulation]]'
...
lcAcRate: 80.0%
similarQuestions:
  - '[[3044.minimum-operations-to-collect-elements|3044.收集元素的最少操作次数]]'
grade: ⭐⭐
likes: 981
dislikes: 481
favorites: []
...
**Nav:** << previous: [[1551.npv-queries]] | next: [[1553.count-triplets-that-can-form-two-arrays-of-equal-xor]] >>
