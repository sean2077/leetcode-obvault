...
aliases:
  ...
  - the-number-of-beautiful-subsets
  - 美丽子集的数目
lcLink: https://leetcode.com/problems/the-number-of-beautiful-subsets/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[math]]'
...
lcAcRate: 51.2%
similarQuestions:
  - '[[1819.construct-the-lexicographically-largest-valid-sequence|1819.构建字典序最大的可行序列]]'
grade: ⭐⭐⭐⭐
likes: 1189
dislikes: 172
favorites: []
...
**Nav:** << previous: [[2695.find-score-of-an-array-after-marking-all-elements]] | next: [[2697.minimum-number-of-visited-cells-in-a-grid]] >>
