...
aliases:
  ...
  - minimum-number-of-work-sessions-to-finish-the-tasks
  - 完成任务的最少工作时间段
lcLink: https://leetcode.com/problems/minimum-number-of-work-sessions-to-finish-the-tasks/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
similarQuestions:
  ...
  - '[[1825.find-minimum-time-to-finish-all-jobs|1825.完成所有工作的最短时间]]'
  - '[[2458.find-minimum-time-to-finish-all-jobs-ii|2458.完成所有工作的最短时间 II]]'
grade: ⭐⭐⭐⭐⭐
likes: 1114
dislikes: 67
favorites: []
...
**Nav:** << previous: [[2113.find-the-kth-largest-integer-in-the-array]] | next: [[2115.number-of-unique-good-subsequences]] >>
