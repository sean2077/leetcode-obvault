...
aliases:
  ...
  - apply-operations-to-make-two-strings-equal
  - 执行操作使两个字符串相等
lcLink: https://leetcode.com/problems/apply-operations-to-make-two-strings-equal/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3032.maximize-value-of-function-in-a-ball-passing-game]] | next: [[3034.points-that-intersect-with-cars]] >>
