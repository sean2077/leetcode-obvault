...
aliases:
  ...
  - maximum-array-hopping-score-i
  - 最大数组跳跃得分 I
lcLink: https://leetcode.com/problems/maximum-array-hopping-score-i/
lcTopics:
  - '[[stack]]'
  - '[[greedy]]'
  - '[[array]]'
...
**Nav:** << previous: [[3512.bitwise-user-permissions-analysis]] | next: [[3514.shortest-distance-after-road-addition-queries-ii]] >>
