...
aliases:
  ...
  - count-substrings-that-differ-by-one-character
  - 统计只差一个字符的子串数目
lcLink: https://leetcode.com/problems/count-substrings-that-differ-by-one-character/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1742.widest-vertical-area-between-two-points-containing-no-points]] | next: [[1744.number-of-ways-to-form-a-target-string-given-a-dictionary]] >>
