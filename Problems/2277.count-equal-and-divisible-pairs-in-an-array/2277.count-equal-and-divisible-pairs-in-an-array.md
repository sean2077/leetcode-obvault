...
aliases:
  ...
  - count-equal-and-divisible-pairs-in-an-array
  - 统计数组中相等且可以被整除的数对
lcLink: https://leetcode.com/problems/count-equal-and-divisible-pairs-in-an-array/
lcTopics:
  - '[[array]]'
lcDifficulty: Easy
lcAcRate: 79.6%
...
**Nav:** << previous: [[2276.groups-of-strings]] | next: [[2278.find-three-consecutive-integers-that-sum-to-a-given-number]] >>
