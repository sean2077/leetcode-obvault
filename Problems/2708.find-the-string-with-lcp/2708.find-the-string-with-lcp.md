...
aliases:
  ...
  - find-the-string-with-lcp
  - 找出对应 LCP 矩阵的字符串
lcLink: https://leetcode.com/problems/find-the-string-with-lcp/
lcTopics:
  - '[[greedy]]'
  - '[[union-find]]'
  - '[[array]]'
...
**Nav:** << previous: [[2707.merge-two-2d-arrays-by-summing-values]] | next: [[2709.count-the-number-of-square-free-subsets]] >>
