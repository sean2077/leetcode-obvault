...
aliases:
  ...
  - plates-between-candles
  - 蜡烛之间的盘子
lcLink: https://leetcode.com/problems/plates-between-candles/
lcTopics:
  - '[[array]]'
  - '[[string]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[2164.two-best-non-overlapping-events]] | next: [[2166.number-of-valid-move-combinations-on-chessboard]] >>
