...
aliases:
  ...
  - tuple-with-same-product
  - 同积元组
lcLink: https://leetcode.com/problems/tuple-with-same-product/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[counting]]'
...
**Nav:** << previous: [[1363.greatest-english-letter-in-upper-and-lower-case]] | next: [[1366.first-unique-number]] >>
