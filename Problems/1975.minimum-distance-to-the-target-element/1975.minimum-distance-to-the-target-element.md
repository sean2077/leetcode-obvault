...
aliases:
  ...
  - minimum-distance-to-the-target-element
  - 到目标元素的最小距离
lcLink: https://leetcode.com/problems/minimum-distance-to-the-target-element/
lcTopics:
  - '[[array]]'
lcDifficulty: Easy
lcAcRate: 54.5%
...
**Nav:** << previous: [[1974.find-customers-with-positive-revenue-this-year]] | next: [[1976.splitting-a-string-into-descending-consecutive-values]] >>
