...
aliases:
  ...
  - find-the-middle-index-in-array
  - 找到数组的中间位置
lcLink: https://leetcode.com/problems/find-the-middle-index-in-array/
lcTopics:
  - '[[array]]'
  - '[[prefix-sum]]'
lcDifficulty: Easy
...
similarQuestions:
  ...
  - '[[1062.partition-array-into-three-parts-with-equal-sum|1062.将数组分成和相等的三个部分]]'
...
**Nav:** << previous: [[2101.last-day-where-you-can-still-cross]] | next: [[2103.find-all-groups-of-farmland]] >>
