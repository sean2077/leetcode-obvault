...
aliases:
  ...
  - maximum-number-of-pairs-in-array
  - 数组能形成多少数对
lcLink: https://leetcode.com/problems/maximum-number-of-pairs-in-array/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[counting]]'
...
**Nav:** << previous: [[2420.closest-node-to-path-in-tree]] | next: [[2422.query-kth-smallest-trimmed-number]] >>
