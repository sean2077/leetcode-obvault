...
aliases:
  ...
  - count-the-number-of-special-characters-i
  - 统计特殊字母的数量 I
lcLink: https://leetcode.com/problems/count-the-number-of-special-characters-i/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3407.find-all-possible-stable-binary-arrays-ii]] | next: [[3409.find-trending-hashtags-ii]] >>
