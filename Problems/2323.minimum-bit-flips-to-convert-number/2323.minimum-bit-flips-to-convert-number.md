...
lcAcRate: 85.2%
similarQuestions:
  - '[[1441.minimum-flips-to-make-a-or-b-equal-to-c|1441.或运算的最小翻转次数]]'
  - '[[3249.minimum-number-of-operations-to-make-array-xor-equal-to-k|3249.使数组异或和等于
    K 的最少操作次数]]'
grade: ⭐⭐⭐⭐⭐
likes: 926
dislikes: 20
...
**Nav:** << previous: [[2322.number-of-ways-to-build-sturdy-brick-wall]] | next: [[2324.find-triangular-sum-of-an-array]] >>
