...
aliases:
  ...
  - sort-the-students-by-their-kth-score
  - 根据第 K 场考试的分数排序
lcLink: https://leetcode.com/problems/sort-the-students-by-their-kth-score/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[sorting]]'
...
similarQuestions:
  ...
  - '[[807.custom-sort-string|807.自定义字符串排序]]'
...
**Nav:** << previous: [[2630.alternating-digit-sum]] | next: [[2632.apply-bitwise-operations-to-make-strings-equal]] >>
