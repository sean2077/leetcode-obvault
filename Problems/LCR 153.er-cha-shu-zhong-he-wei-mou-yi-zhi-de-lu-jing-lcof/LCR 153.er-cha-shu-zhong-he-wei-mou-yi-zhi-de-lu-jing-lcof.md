...
aliases:
  ...
  - 二叉树中和为目标值的路径
lcLink: https://leetcode.com/problems/er-cha-shu-zhong-he-wei-mou-yi-zhi-de-lu-jing-lcof/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[backtracking]]'
...
**Nav:** << previous: [[LCR 152.er-cha-sou-suo-shu-de-hou-xu-bian-li-xu-lie-lcof]] | next: [[LCR 154.fu-za-lian-biao-de-fu-zhi-lcof]] >>
...
[submissions](https://leetcode.com/problems/er-cha-shu-zhong-he-wei-mou-yi-zhi-de-lu-jing-lcof/submissions/) | [solutions](https://leetcode.com/problems/er-cha-shu-zhong-he-wei-mou-yi-zhi-de-lu-jing-lcof/solutions/)
...
(define/contract (path-target root target)
...
defmodule Solution do
  @spec path_target(root :: TreeNode.t | nil, target :: integer) :: [[integer]]
  def path_target(root, target) do
