...
aliases:
  ...
  - number-of-laser-beams-in-a-bank
  - 银行中的激光束数量
lcLink: https://leetcode.com/problems/number-of-laser-beams-in-a-bank/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[string]]'
...
**Nav:** << previous: [[2243.check-if-all-as-appears-before-all-bs]] | next: [[2245.destroying-asteroids]] >>
