...
aliases:
  ...
  - count-number-of-ways-to-place-houses
  - 统计放置房子的方式数
lcLink: https://leetcode.com/problems/count-number-of-ways-to-place-houses/
lcTopics:
  - '[[dynamic-programming]]'
lcDifficulty: Medium
lcAcRate: 42.0%
...
**Nav:** << previous: [[2396.design-video-sharing-platform]] | next: [[2398.check-if-matrix-is-x-matrix]] >>
