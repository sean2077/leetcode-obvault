...
aliases:
  ...
  - minimum-recolors-to-get-k-consecutive-black-blocks
  - 得到 K 个黑块的最少涂色次数
lcLink: https://leetcode.com/problems/minimum-recolors-to-get-k-consecutive-black-blocks/
lcTopics:
  - '[[string]]'
  - '[[sliding-window]]'
lcDifficulty: Easy
...
similarQuestions:
  ...
  - '[[1567.maximum-number-of-vowels-in-a-substring-of-given-length|1567.定长子串中元音的最大数目]]'
grade: ⭐⭐⭐⭐⭐
likes: 732
dislikes: 20
favorites: []
...
**Nav:** << previous: [[2462.find-the-k-sum-of-an-array]] | next: [[2464.time-needed-to-rearrange-a-binary-string]] >>
