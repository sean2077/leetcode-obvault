...
aliases:
  ...
  - generate-fibonacci-sequence
  - 生成斐波那契数列
lcLink: https://leetcode.com/problems/generate-fibonacci-sequence/
lcTopics: []
lcDifficulty: Easy
lcAcRate: 83.1%
similarQuestions:
  - '[[2783.nested-array-generator|2783.嵌套数组生成器]]'
...
**Nav:** << previous: [[2774.differences-between-two-objects]] | next: [[2776.make-object-immutable]] >>
