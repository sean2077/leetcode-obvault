...
aliases:
  ...
  - count-pairs-in-two-arrays
  - 统计数对
lcLink: https://leetcode.com/problems/count-pairs-in-two-arrays/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[binary-search]]'
...
lcAcRate: 60.9%
similarQuestions:
  - '[[1622.max-value-of-equation|1622.满足不等式的最大值]]'
...
**Nav:** << previous: [[2035.count-sub-islands]] | next: [[2037.count-square-sum-triples]] >>
