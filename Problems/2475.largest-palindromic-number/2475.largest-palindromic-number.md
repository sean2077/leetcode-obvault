...
aliases:
  ...
  - largest-palindromic-number
  - 最大回文数字
lcLink: https://leetcode.com/problems/largest-palindromic-number/
lcTopics:
  - '[[greedy]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[2474.minimum-adjacent-swaps-to-make-a-valid-array]] | next: [[2476.check-distances-between-same-letters]] >>
