...
aliases:
  ...
  - find-the-k-or-of-an-array
  - 找出数组中的 K-or 值
lcLink: https://leetcode.com/problems/find-the-k-or-of-an-array/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
lcDifficulty: Easy
...
similarQuestions:
  ...
  - '[[3093.sum-of-values-at-indices-with-k-set-bits|3093.计算 K 置位下标对应元素的和]]'
grade: ⭐
likes: 219
dislikes: 269
favorites: []
...
**Nav:** << previous: [[3182.maximum-linear-stock-score]] | next: [[3184.maximum-balanced-subsequence-sum]] >>
