...
aliases:
  ...
  - prime-in-diagonal
  - 对角线上的质数
lcLink: https://leetcode.com/problems/prime-in-diagonal/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[matrix]]'
...
**Nav:** << previous: [[2721.sum-of-distances]] | next: [[2723.find-the-longest-balanced-substring-of-a-binary-string]] >>
