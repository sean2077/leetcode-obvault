...
aliases:
  ...
  - number-of-squareful-arrays
  - 平方数组的数目
lcLink: https://leetcode.com/problems/number-of-squareful-arrays/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[1037.minimum-number-of-k-consecutive-bit-flips]] | next: [[1039.find-the-town-judge]] >>
