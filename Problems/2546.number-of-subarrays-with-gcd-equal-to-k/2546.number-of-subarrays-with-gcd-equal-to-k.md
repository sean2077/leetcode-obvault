...
aliases:
  ...
  - number-of-subarrays-with-gcd-equal-to-k
  - 最大公因数等于 K 的子数组数目
lcLink: https://leetcode.com/problems/number-of-subarrays-with-gcd-equal-to-k/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[number-theory]]'
...
similarQuestions:
  ...
  - '[[2557.number-of-subarrays-with-lcm-equal-to-k|2557.最小公倍数为 K 的子数组数目]]'
grade: ⭐⭐⭐⭐
likes: 443
dislikes: 67
favorites: []
...
**Nav:** << previous: [[2545.height-of-binary-tree-after-subtree-removal-queries]] | next: [[2547.odd-string-difference]] >>
