...
aliases:
  ...
  - rank-transform-of-a-matrix
  - 矩阵转换后的秩
lcLink: https://leetcode.com/problems/rank-transform-of-a-matrix/
lcTopics:
  - '[[union-find]]'
  - '[[graph]]'
  - '[[topological-sort]]'
...
similarQuestions:
  ...
  - '[[2125.gcd-sort-of-an-array|2125.数组的最大公因数排序]]'
grade: ⭐⭐⭐⭐⭐
likes: 872
dislikes: 55
favorites: []
...
**Nav:** << previous: [[1256.rank-transform-of-an-array]] | next: [[1258.article-views-i]] >>
