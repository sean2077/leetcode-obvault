...
aliases:
  ...
  - largest-number-after-digit-swaps-by-parity
  - 按奇偶性交换后的最大数字
lcLink: https://leetcode.com/problems/largest-number-after-digit-swaps-by-parity/
lcTopics:
  - '[[sorting]]'
  - '[[heap-priority-queue]]'
lcDifficulty: Easy
lcAcRate: 61.9%
similarQuestions:
  - '[[748.largest-number-at-least-twice-of-others|748.至少是其他数字两倍的最大数]]'
...
**Nav:** << previous: [[2326.sum-of-scores-of-built-strings]] | next: [[2328.minimize-result-by-adding-parentheses-to-expression]] >>
