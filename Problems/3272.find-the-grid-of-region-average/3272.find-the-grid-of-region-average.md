...
aliases:
  ...
  - find-the-grid-of-region-average
  - 找出网格的区域平均强度
lcLink: https://leetcode.com/problems/find-the-grid-of-region-average/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3271.count-the-number-of-houses-at-a-certain-distance-i]] | next: [[3273.most-expensive-item-that-can-not-be-bought]] >>
