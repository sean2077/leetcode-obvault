...
aliases:
  ...
  - minimum-number-of-operations-to-convert-time
  - 转化时间需要的最少操作数
lcLink: https://leetcode.com/problems/minimum-number-of-operations-to-convert-time/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[2344.escape-the-spreading-fire]] | next: [[2346.largest-3-same-digit-number-in-string]] >>
