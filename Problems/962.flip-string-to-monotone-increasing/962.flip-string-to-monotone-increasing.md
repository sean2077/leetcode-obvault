...
aliases:
  ...
  - flip-string-to-monotone-increasing
  - 将字符串翻转到单调递增
lcLink: https://leetcode.com/problems/flip-string-to-monotone-increasing/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
lcAcRate: 61.5%
similarQuestions:
  - '[[2817.minimum-cost-to-make-all-characters-equal|2817.使所有字符相等的最小成本]]'
grade: ⭐⭐⭐⭐⭐
likes: 4422
dislikes: 178
favorites: []
...
**Nav:** << previous: [[961.long-pressed-name]] | next: [[963.three-equal-parts]] >>
