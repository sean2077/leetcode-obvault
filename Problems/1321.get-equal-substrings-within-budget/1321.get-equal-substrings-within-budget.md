...
aliases:
  ...
  - get-equal-substrings-within-budget
  - 尽可能使字符串相等
lcLink: https://leetcode.com/problems/get-equal-substrings-within-budget/
lcTopics:
  - '[[string]]'
  - '[[binary-search]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[1320.remove-all-adjacent-duplicates-in-string-ii]] | next: [[1322.minimum-moves-to-reach-target-with-rotations]] >>
