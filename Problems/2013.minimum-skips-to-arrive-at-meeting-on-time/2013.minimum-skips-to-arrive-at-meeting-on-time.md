...
aliases:
  ...
  - minimum-skips-to-arrive-at-meeting-on-time
  - 准时抵达会议现场的最小跳过休息次数
lcLink: https://leetcode.com/problems/minimum-skips-to-arrive-at-meeting-on-time/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[2295.minimum-time-to-finish-the-race|2295.完成比赛的最少时间]]'
grade: ⭐⭐⭐⭐
likes: 335
dislikes: 50
favorites: []
...
**Nav:** << previous: [[2012.process-tasks-using-servers]] | next: [[2014.orders-with-maximum-quantity-above-average]] >>
