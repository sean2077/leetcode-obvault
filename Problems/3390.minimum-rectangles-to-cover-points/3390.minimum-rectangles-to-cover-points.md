...
aliases:
  ...
  - minimum-rectangles-to-cover-points
  - 覆盖所有点的最少矩形数目
lcLink: https://leetcode.com/problems/minimum-rectangles-to-cover-points/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
lcAcRate: 63.7%
similarQuestions:
  - '[[976.minimum-area-rectangle|976.最小面积矩形]]'
...
**Nav:** << previous: [[3389.minimum-time-to-visit-disappearing-nodes]] | next: [[3391.maximum-difference-score-in-a-grid]] >>
