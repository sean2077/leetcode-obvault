...
aliases:
  ...
  - minimum-flips-in-binary-tree-to-get-result
  - 二叉树中得到结果所需的最少翻转次数
lcLink: https://leetcode.com/problems/minimum-flips-in-binary-tree-to-get-result/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[2398.check-if-matrix-is-x-matrix]] | next: [[2400.minimum-score-after-removals-on-a-tree]] >>
