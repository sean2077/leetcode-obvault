...
aliases:
  ...
  - smallest-string-with-swaps
  - 交换字符串中的元素
lcLink: https://leetcode.com/problems/smallest-string-with-swaps/
lcTopics:
  - '[[depth-first-search]]'
...
lcAcRate: 58.5%
similarQuestions:
  - '[[1840.minimize-hamming-distance-after-swap-operations|1840.执行交换操作后的最小汉明距离]]'
  - '[[2198.process-restricted-friend-requests|2198.处理含限制条件的好友请求]]'
  - '[[2327.largest-number-after-digit-swaps-by-parity|2327.按奇偶性交换后的最大数字]]'
  - '[[2687.lexicographically-smallest-beautiful-string|2687.字典序最小的美丽字符串]]'
  - '[[3219.make-lexicographically-smallest-array-by-swapping-elements|3219.交换得到字典序最小的数组]]'
grade: ⭐⭐⭐⭐⭐
likes: 3686
dislikes: 141
favorites: []
...
**Nav:** << previous: [[1307.ugly-number-iii]] | next: [[1309.sort-items-by-groups-respecting-dependencies]] >>
