...
aliases:
  ...
  - longest-binary-subsequence-less-than-or-equal-to-k
  - 小于等于 K 的最长二进制子序列
lcLink: https://leetcode.com/problems/longest-binary-subsequence-less-than-or-equal-to-k/
lcTopics:
  - '[[greedy]]'
  - '[[memoization]]'
  - '[[string]]'
...
lcAcRate: 38.0%
similarQuestions:
  - '[[1804.maximum-binary-string-after-change|1804.修改后的最大二进制字符串]]'
grade: ⭐⭐⭐⭐⭐
likes: 684
dislikes: 50
favorites: []
...
**Nav:** << previous: [[2394.count-subarrays-with-score-less-than-k]] | next: [[2396.design-video-sharing-platform]] >>
