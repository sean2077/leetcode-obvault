...
aliases:
  ...
  - node-with-highest-edge-score
  - 边积分最高的节点
lcLink: https://leetcode.com/problems/node-with-highest-edge-score/
lcTopics:
  - '[[graph]]'
  - '[[hash-table]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2454.largest-local-values-in-a-matrix]] | next: [[2456.construct-smallest-number-from-di-string]] >>
