...
aliases:
  ...
  - maximum-square-area-by-removing-fences-from-a-field
  - 移除栅栏得到的正方形田地的最大面积
lcLink: https://leetcode.com/problems/maximum-square-area-by-removing-fences-from-a-field/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[enumeration]]'
...
**Nav:** << previous: [[3249.minimum-number-of-operations-to-make-array-xor-equal-to-k]] | next: [[3251.maximum-area-of-longest-diagonal-rectangle]] >>
