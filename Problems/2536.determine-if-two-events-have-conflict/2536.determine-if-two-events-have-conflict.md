...
aliases:
  ...
  - determine-if-two-events-have-conflict
  - 判断两个事件是否存在冲突
lcLink: https://leetcode.com/problems/determine-if-two-events-have-conflict/
lcTopics:
  - '[[array]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[2535.count-strictly-increasing-subarrays]] | next: [[2537.minimum-time-to-kill-all-monsters]] >>
