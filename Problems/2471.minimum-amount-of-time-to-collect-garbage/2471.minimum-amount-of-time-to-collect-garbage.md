...
aliases:
  ...
  - minimum-amount-of-time-to-collect-garbage
  - 收集垃圾的最少总时间
lcLink: https://leetcode.com/problems/minimum-amount-of-time-to-collect-garbage/
lcTopics:
  - '[[array]]'
  - '[[string]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[2470.removing-stars-from-a-string]] | next: [[2472.build-a-matrix-with-conditions]] >>
