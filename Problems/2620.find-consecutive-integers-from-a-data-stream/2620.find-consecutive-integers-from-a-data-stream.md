...
aliases:
  ...
  - find-consecutive-integers-from-a-data-stream
  - 找到数据流中的连续整数
lcLink: https://leetcode.com/problems/find-consecutive-integers-from-a-data-stream/
lcTopics:
  - '[[design]]'
  - '[[queue]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2619.categorize-box-according-to-criteria]] | next: [[2621.find-xor-beauty-of-array]] >>
