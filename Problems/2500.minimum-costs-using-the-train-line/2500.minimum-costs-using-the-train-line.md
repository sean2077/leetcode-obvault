...
aliases:
  ...
  - minimum-costs-using-the-train-line
  - 乘坐火车路线的最少费用
lcLink: https://leetcode.com/problems/minimum-costs-using-the-train-line/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
lcAcRate: 78.8%
similarQuestions:
  - '[[833.bus-routes|833.公交路线]]'
  - '[[1287.distance-between-bus-stops|1287.公交站间的距离]]'
grade: ⭐⭐⭐⭐
likes: 183
dislikes: 32
favorites: []
...
**Nav:** << previous: [[2499.minimum-money-required-before-transactions]] | next: [[2501.generate-the-invoice]] >>
