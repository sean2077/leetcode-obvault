...
aliases:
  ...
  - sellers-with-no-sales
  - 没有卖出的卖家
lcLink: https://leetcode.com/problems/sellers-with-no-sales/
lcTopics:
  - '[[database]]'
lcDifficulty: Easy
lcAcRate: 54.3%
similarQuestions:
  - '[[1724.customer-who-visited-but-did-not-make-any-transactions|1724.进店却未进行过交易的顾客]]'
grade: ⭐⭐⭐⭐⭐
likes: 132
dislikes: 14
favorites: []
...
**Nav:** << previous: [[1748.best-team-with-no-conflicts]] | next: [[1750.check-if-two-expression-trees-are-equivalent]] >>
