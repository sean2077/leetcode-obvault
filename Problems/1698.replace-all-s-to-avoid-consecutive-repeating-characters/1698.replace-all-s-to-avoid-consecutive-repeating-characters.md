...
aliases:
  ...
  - replace-all-s-to-avoid-consecutive-repeating-characters
  - 替换所有的问号
lcLink: https://leetcode.com/problems/replace-all-s-to-avoid-consecutive-repeating-characters/
lcTopics:
  - '[[string]]'
lcDifficulty: Easy
lcAcRate: 46.3%
...
**Nav:** << previous: [[1697.strings-differ-by-one-character]] | next: [[1699.number-of-ways-where-square-of-number-is-equal-to-product-of-two-numbers]] >>
