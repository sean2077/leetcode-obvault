...
aliases:
  ...
  - sum-multiples
  - 倍数求和
lcLink: https://leetcode.com/problems/sum-multiples/
lcTopics:
  - '[[math]]'
lcDifficulty: Easy
lcAcRate: 85.6%
...
**Nav:** << previous: [[2751.sliding-subarray-beauty]] | next: [[2753.minimum-number-of-operations-to-make-all-array-elements-equal-to-1]] >>
