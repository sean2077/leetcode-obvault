...
aliases:
  ...
  - maximum-palindromes-after-operations
  - 回文字符串的最大数量
lcLink: https://leetcode.com/problems/maximum-palindromes-after-operations/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[3316.find-the-sum-of-subsequence-powers]] | next: [[3318.maximum-number-of-operations-with-the-same-score-ii]] >>
