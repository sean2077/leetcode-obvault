...
aliases:
  ...
  - average-time-of-process-per-machine
  - 每台机器的进程平均运行时间
lcLink: https://leetcode.com/problems/average-time-of-process-per-machine/
lcTopics:
  - '[[database]]'
lcDifficulty: Easy
lcAcRate: 67.7%
...
**Nav:** << previous: [[1800.concatenation-of-consecutive-binary-numbers]] | next: [[1802.number-of-students-unable-to-eat-lunch]] >>
