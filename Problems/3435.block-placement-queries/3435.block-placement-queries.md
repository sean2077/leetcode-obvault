...
aliases:
  ...
  - block-placement-queries
  - 物块放置查询
lcLink: https://leetcode.com/problems/block-placement-queries/
lcTopics:
  - '[[binary-indexed-tree]]'
  - '[[segment-tree]]'
  - '[[array]]'
...
**Nav:** << previous: [[3434.find-the-number-of-distinct-colors-among-the-balls]] | next: [[3436.find-subarray-with-bitwise-or-closest-to-k]] >>
