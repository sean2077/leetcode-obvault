...
similarQuestions:
  ...
  - '[[1393.maximum-value-of-k-coins-from-piles|1393.从栈中取出 K 个硬币的最大面值和]]'
  - '[[2345.minimum-number-of-operations-to-convert-time|2345.转化时间需要的最少操作数]]'
  - '[[2633.minimum-cost-to-split-an-array|2633.拆分数组的最小代价]]'
  - '[[3091.count-of-sub-multisets-with-bounded-sum|3091.和带限制的子多重集合的数目]]'
  ...
  - '[[3273.most-expensive-item-that-can-not-be-bought|3273.最贵的无法购买的商品]]'
grade: ⭐⭐⭐⭐⭐
likes: 18956
dislikes: 452
favorites: []
