...
aliases:
  ...
  - minimize-result-by-adding-parentheses-to-expression
  - 向表达式添加括号后的最小结果
lcLink: https://leetcode.com/problems/minimize-result-by-adding-parentheses-to-expression/
lcTopics:
  - '[[string]]'
  - '[[enumeration]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2327.largest-number-after-digit-swaps-by-parity]] | next: [[2329.maximum-product-after-k-increments]] >>
