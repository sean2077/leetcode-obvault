...
aliases:
  ...
  - count-pairs-of-similar-strings
  - 统计相似字符串对的数目
lcLink: https://leetcode.com/problems/count-pairs-of-similar-strings/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[hash-table]]'
...
similarQuestions:
  ...
  - '[[1786.count-the-number-of-consistent-strings|1786.统计一致字符串的数目]]'
...
**Nav:** << previous: [[2593.number-of-distinct-binary-strings-after-applying-operations]] | next: [[2595.smallest-value-after-replacing-with-sum-of-prime-factors]] >>
