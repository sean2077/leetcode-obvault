...
aliases:
  ...
  - maximum-number-of-alloys
  - 最大合金数
lcLink: https://leetcode.com/problems/maximum-number-of-alloys/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3094.minimum-number-of-operations-to-make-array-empty]] | next: [[3097.total-traveled-distance]] >>
