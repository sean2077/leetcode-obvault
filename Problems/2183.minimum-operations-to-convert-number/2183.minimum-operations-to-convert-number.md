...
aliases:
  ...
  - minimum-operations-to-convert-number
  - 转化数字的最小运算数
lcLink: https://leetcode.com/problems/minimum-operations-to-convert-number/
lcTopics:
...
lcAcRate: 49.4%
similarQuestions:
  - '[[1776.minimum-operations-to-reduce-x-to-zero|1776.将 x 减到 0 的最小操作数]]'
grade: ⭐⭐⭐⭐⭐
likes: 635
dislikes: 33
favorites: []
...
**Nav:** << previous: [[2182.find-the-minimum-and-maximum-number-of-nodes-between-critical-points]] | next: [[2184.check-if-an-original-string-exists-given-two-encoded-strings]] >>
