...
aliases:
  ...
  - maximum-count-of-positive-integer-and-negative-integer
  - 正整数和负整数的最大计数
lcLink: https://leetcode.com/problems/maximum-count-of-positive-integer-and-negative-integer/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[counting]]'
...
lcAcRate: 71.0%
similarQuestions:
  - '[[792.binary-search|792.二分查找]]'
  - '[[1476.count-negative-numbers-in-a-sorted-matrix|1476.统计有序矩阵中的负数]]'
grade: ⭐⭐⭐⭐⭐
likes: 899
dislikes: 52
favorites: []
...
**Nav:** << previous: [[2613.customers-with-strictly-increasing-purchases]] | next: [[2615.make-number-of-distinct-characters-equal]] >>
