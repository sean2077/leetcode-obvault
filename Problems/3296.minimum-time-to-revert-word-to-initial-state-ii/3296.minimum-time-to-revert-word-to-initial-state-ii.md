...
aliases:
  ...
  - minimum-time-to-revert-word-to-initial-state-ii
  - 将单词恢复初始状态所需的最短时间 II
lcLink: https://leetcode.com/problems/minimum-time-to-revert-word-to-initial-state-ii/
lcTopics:
  - '[[string]]'
  - '[[string-matching]]'
  - '[[hash-function]]'
...
**Nav:** << previous: [[3294.number-of-self-divisible-permutations]] | next: [[3297.minimum-time-to-revert-word-to-initial-state-i]] >>
