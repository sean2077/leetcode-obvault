...
aliases:
  ...
  - remove-letter-to-equalize-frequency
  - 删除字符使频率相同
lcLink: https://leetcode.com/problems/remove-letter-to-equalize-frequency/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[counting]]'
...
**Nav:** << previous: [[2531.create-components-with-same-value]] | next: [[2533.bitwise-xor-of-all-pairings]] >>
