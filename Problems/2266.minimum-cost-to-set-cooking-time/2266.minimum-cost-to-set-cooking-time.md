...
aliases:
  ...
  - minimum-cost-to-set-cooking-time
  - 设置时间的最少代价
lcLink: https://leetcode.com/problems/minimum-cost-to-set-cooking-time/
lcTopics:
  - '[[math]]'
  - '[[enumeration]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2265.partition-array-according-to-given-pivot]] | next: [[2267.minimum-difference-in-sums-after-removal-of-elements]] >>
