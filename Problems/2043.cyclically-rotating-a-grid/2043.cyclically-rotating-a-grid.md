...
aliases:
  ...
  - cyclically-rotating-a-grid
  - 循环轮转矩阵
lcLink: https://leetcode.com/problems/cyclically-rotating-a-grid/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[2042.maximum-product-difference-between-two-pairs]] | next: [[2044.number-of-wonderful-substrings]] >>
