...
aliases:
  ...
  - subrectangle-queries
  - 子矩形查询
lcLink: https://leetcode.com/problems/subrectangle-queries/
lcTopics:
  - '[[design]]'
  - '[[array]]'
  - '[[matrix]]'
...
**Nav:** << previous: [[1571.allocate-mailboxes]] | next: [[1573.find-two-non-overlapping-sub-arrays-each-with-target-sum]] >>
