...
aliases:
  ...
  - apply-bitwise-operations-to-make-strings-equal
  - 执行逐位运算使字符串相等
lcLink: https://leetcode.com/problems/apply-bitwise-operations-to-make-strings-equal/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2631.sort-the-students-by-their-kth-score]] | next: [[2633.minimum-cost-to-split-an-array]] >>
