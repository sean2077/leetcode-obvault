...
aliases:
  ...
  - maximum-number-of-words-found-in-sentences
  - 句子中的最多单词数
lcLink: https://leetcode.com/problems/maximum-number-of-words-found-in-sentences/
lcTopics:
  - '[[array]]'
  - '[[string]]'
lcDifficulty: Easy
lcAcRate: 86.5%
similarQuestions:
  - '[[2173.number-of-valid-words-in-a-sentence|2173.句子中的有效单词数]]'
grade: ⭐⭐⭐⭐⭐
likes: 1740
dislikes: 60
favorites: []
...
**Nav:** << previous: [[2218.paths-in-maze-that-lead-to-same-room]] | next: [[2220.find-all-possible-recipes-from-given-supplies]] >>
