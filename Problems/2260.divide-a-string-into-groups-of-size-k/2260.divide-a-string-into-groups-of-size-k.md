...
aliases:
  ...
  - divide-a-string-into-groups-of-size-k
  - 将字符串拆分为若干长度为 k 的组
lcLink: https://leetcode.com/problems/divide-a-string-into-groups-of-size-k/
lcTopics:
  - '[[string]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
similarQuestions:
  ...
  - '[[857.positions-of-large-groups|857.较大分组的位置]]'
grade: ⭐⭐⭐⭐⭐
likes: 463
dislikes: 22
favorites: []
...
**Nav:** << previous: [[2259.minimum-operations-to-remove-adjacent-ones-in-matrix]] | next: [[2261.all-divisions-with-the-highest-score-of-a-binary-array]] >>
