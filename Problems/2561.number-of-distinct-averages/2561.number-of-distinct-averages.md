...
aliases:
  ...
  - number-of-distinct-averages
  - 不同的平均值数目
lcLink: https://leetcode.com/problems/number-of-distinct-averages/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[two-pointers]]'
...
similarQuestions:
  ...
  - '[[3471.minimum-average-of-smallest-and-largest-elements|3471.最小元素和最大元素的最小平均值]]'
grade: ⭐⭐⭐⭐⭐
likes: 370
dislikes: 27
favorites: []
...
**Nav:** << previous: [[2560.closest-fair-integer]] | next: [[2562.count-ways-to-build-good-strings]] >>
