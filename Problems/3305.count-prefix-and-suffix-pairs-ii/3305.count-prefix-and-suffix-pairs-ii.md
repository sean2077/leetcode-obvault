...
aliases:
  ...
  - count-prefix-and-suffix-pairs-ii
  - 统计前后缀下标对 II
lcLink: https://leetcode.com/problems/count-prefix-and-suffix-pairs-ii/
lcTopics:
  - '[[trie]]'
  - '[[array]]'
  - '[[string]]'
...
**Nav:** << previous: [[3304.maximum-subtree-of-the-same-color]] | next: [[3306.mark-elements-on-array-by-performing-queries]] >>
