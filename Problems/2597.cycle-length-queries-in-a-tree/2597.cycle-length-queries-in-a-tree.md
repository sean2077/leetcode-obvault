...
aliases:
  ...
  - cycle-length-queries-in-a-tree
  - 查询树中环的长度
lcLink: https://leetcode.com/problems/cycle-length-queries-in-a-tree/
lcTopics:
  - '[[tree]]'
  - '[[array]]'
  - '[[binary-tree]]'
...
similarQuestions:
  ...
  - '[[1194.path-in-zigzag-labelled-binary-tree|1194.二叉树寻路]]'
grade: ⭐⭐⭐⭐⭐
likes: 349
dislikes: 29
favorites: []
...
**Nav:** << previous: [[2596.add-edges-to-make-degrees-of-all-nodes-even]] | next: [[2598.shortest-distance-to-target-string-in-a-circular-array]] >>
