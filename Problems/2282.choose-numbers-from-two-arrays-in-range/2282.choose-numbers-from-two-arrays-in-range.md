...
aliases:
  ...
  - choose-numbers-from-two-arrays-in-range
  - 在两个数组的区间中选取数字
lcLink: https://leetcode.com/problems/choose-numbers-from-two-arrays-in-range/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[2029.minimize-product-sum-of-two-arrays|2029.两个数组的最小乘积和]]'
grade: ⭐⭐⭐⭐⭐
likes: 37
dislikes: 4
favorites: []
...
**Nav:** << previous: [[2281.the-number-of-passengers-in-each-bus-i]] | next: [[2283.sort-even-and-odd-indices-independently]] >>
