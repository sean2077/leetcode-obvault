...
aliases:
  ...
  - longest-palindromic-subsequence-ii
  - 最长回文子序列 II
lcLink: https://leetcode.com/problems/longest-palindromic-subsequence-ii/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1821.products-worth-over-invoices]] | next: [[1823.determine-if-string-halves-are-alike]] >>
