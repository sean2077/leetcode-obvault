...
aliases:
  ...
  - minimum-falling-path-sum-ii
  - 下降路径最小和  II
lcLink: https://leetcode.com/problems/minimum-falling-path-sum-ii/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
  - '[[matrix]]'
...
lcAcRate: 64.3%
similarQuestions:
  - '[[967.minimum-falling-path-sum|967.下降路径最小和]]'
grade: ⭐⭐⭐⭐⭐
likes: 2250
dislikes: 123
favorites: []
...
**Nav:** << previous: [[1223.graph-connectivity-with-threshold]] | next: [[1225.active-businesses]] >>
