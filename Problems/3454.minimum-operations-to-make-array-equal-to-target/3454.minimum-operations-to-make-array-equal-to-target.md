...
aliases:
  ...
  - minimum-operations-to-make-array-equal-to-target
  - 使数组等于目标数组所需的最少操作次数
lcLink: https://leetcode.com/problems/minimum-operations-to-make-array-equal-to-target/
lcTopics:
  - '[[stack]]'
  - '[[greedy]]'
  - '[[array]]'
...
**Nav:** << previous: [[3453.generate-binary-strings-without-adjacent-zeros]] | next: [[3455.minimum-length-of-string-after-operations]] >>
