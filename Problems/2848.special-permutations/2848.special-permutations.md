...
aliases:
  ...
  - special-permutations
  - 特别的排列
lcLink: https://leetcode.com/problems/special-permutations/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[2847.find-maximum-number-of-string-pairs]] | next: [[2849.sum-of-imbalance-numbers-of-all-subarrays]] >>
