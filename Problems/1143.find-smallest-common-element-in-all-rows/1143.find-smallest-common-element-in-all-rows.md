...
aliases:
  ...
  - find-smallest-common-element-in-all-rows
  - 找出所有行中最小公共元素
lcLink: https://leetcode.com/problems/find-smallest-common-element-in-all-rows/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[1142.minimum-knight-moves]] | next: [[1144.optimize-water-distribution-in-a-village]] >>
