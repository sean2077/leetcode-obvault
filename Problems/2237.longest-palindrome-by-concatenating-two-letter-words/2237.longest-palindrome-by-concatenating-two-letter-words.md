...
aliases:
  ...
  - longest-palindrome-by-concatenating-two-letter-words
  - 连接两字母单词得到的最长回文串
lcLink: https://leetcode.com/problems/longest-palindrome-by-concatenating-two-letter-words/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2236.maximum-twin-sum-of-a-linked-list]] | next: [[2238.a-number-after-a-double-reversal]] >>
