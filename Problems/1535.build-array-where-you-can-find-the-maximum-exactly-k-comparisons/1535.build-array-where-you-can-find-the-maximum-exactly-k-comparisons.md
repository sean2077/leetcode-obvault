...
aliases:
  ...
  - build-array-where-you-can-find-the-maximum-exactly-k-comparisons
  - 生成数组
lcLink: https://leetcode.com/problems/build-array-where-you-can-find-the-maximum-exactly-k-comparisons/
lcTopics:
  - '[[dynamic-programming]]'
  - '[[prefix-sum]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[1534.minimum-number-of-frogs-croaking]] | next: [[1536.customers-who-bought-products-a-and-b-but-not-c]] >>
