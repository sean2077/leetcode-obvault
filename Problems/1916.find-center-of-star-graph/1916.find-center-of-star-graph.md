...
aliases:
  ...
  - find-center-of-star-graph
  - 找出星型图的中心节点
lcLink: https://leetcode.com/problems/find-center-of-star-graph/
lcTopics:
  - '[[graph]]'
lcDifficulty: Easy
lcAcRate: 86.7%
...
**Nav:** << previous: [[1915.check-if-one-string-swap-can-make-strings-equal]] | next: [[1917.maximum-average-pass-ratio]] >>
