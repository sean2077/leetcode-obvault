...
aliases:
  ...
  - partition-string-into-minimum-beautiful-substrings
  - 将字符串分割为最少的美丽子字符串
lcLink: https://leetcode.com/problems/partition-string-into-minimum-beautiful-substrings/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
similarQuestions:
  ...
  - '[[3403.minimum-substring-partition-of-equal-character-frequency|3403.分割字符频率相等的最少子字符串]]'
grade: ⭐⭐⭐⭐⭐
likes: 351
dislikes: 15
favorites: []
...
**Nav:** << previous: [[2882.ways-to-express-an-integer-as-sum-of-powers]] | next: [[2884.length-of-the-longest-valid-substring]] >>
