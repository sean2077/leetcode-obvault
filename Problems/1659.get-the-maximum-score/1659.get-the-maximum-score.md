...
aliases:
  ...
  - get-the-maximum-score
  - 最大得分
lcLink: https://leetcode.com/problems/get-the-maximum-score/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[two-pointers]]'
...
lcAcRate: 39.5%
similarQuestions:
  - '[[2353.maximum-score-of-a-node-sequence|2353.节点序列的最大得分]]'
grade: ⭐⭐⭐⭐⭐
likes: 983
dislikes: 51
favorites: []
...
**Nav:** << previous: [[1658.minimum-swaps-to-arrange-a-binary-grid]] | next: [[1660.thousand-separator]] >>
