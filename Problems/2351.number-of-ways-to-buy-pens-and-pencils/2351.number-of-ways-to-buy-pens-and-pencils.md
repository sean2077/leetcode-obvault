...
aliases:
  ...
  - number-of-ways-to-buy-pens-and-pencils
  - 买钢笔和铅笔的方案数
lcLink: https://leetcode.com/problems/number-of-ways-to-buy-pens-and-pencils/
lcTopics:
  - '[[math]]'
  - '[[enumeration]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2350.find-closest-number-to-zero]] | next: [[2352.design-an-atm-machine]] >>
