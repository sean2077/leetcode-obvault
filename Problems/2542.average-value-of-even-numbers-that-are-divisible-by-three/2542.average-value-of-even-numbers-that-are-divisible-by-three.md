...
aliases:
  ...
  - average-value-of-even-numbers-that-are-divisible-by-three
  - 可被三整除的偶数的平均值
lcLink: https://leetcode.com/problems/average-value-of-even-numbers-that-are-divisible-by-three/
lcTopics:
  - '[[array]]'
  - '[[math]]'
lcDifficulty: Easy
lcAcRate: 60.5%
similarQuestions:
  - '[[1071.binary-prefix-divisible-by-5|1071.可被 5 整除的二进制前缀]]'
grade: ⭐⭐⭐⭐⭐
likes: 333
dislikes: 36
favorites: []
...
**Nav:** << previous: [[2541.sum-of-number-and-its-reverse]] | next: [[2543.most-popular-video-creator]] >>
