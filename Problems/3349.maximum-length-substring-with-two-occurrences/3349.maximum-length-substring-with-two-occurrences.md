...
aliases:
  ...
  - maximum-length-substring-with-two-occurrences
  - 每个字符最多出现两次的最长子字符串
lcLink: https://leetcode.com/problems/maximum-length-substring-with-two-occurrences/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[sliding-window]]'
...
**Nav:** << previous: [[3348.minimum-cost-walk-in-weighted-graph]] | next: [[3350.distribute-elements-into-two-arrays-ii]] >>
