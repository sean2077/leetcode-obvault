...
aliases:
  ...
  - smallest-value-of-the-rearranged-number
  - 重排数字的最小值
lcLink: https://leetcode.com/problems/smallest-value-of-the-rearranged-number/
lcTopics:
  - '[[math]]'
  - '[[sorting]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2283.sort-even-and-odd-indices-independently]] | next: [[2285.design-bitset]] >>
