...
aliases:
  ...
  - minimum-number-of-flips-to-convert-binary-matrix-to-zero-matrix
  - 转化为全零矩阵的最少反转次数
lcLink: https://leetcode.com/problems/minimum-number-of-flips-to-convert-binary-matrix-to-zero-matrix/
lcTopics:
  - '[[bit-manipulation]]'
...
similarQuestions:
  ...
  - '[[2268.remove-all-ones-with-row-and-column-flips|2268.通过翻转行或列来去除所有的 1]]'
...
**Nav:** << previous: [[1408.find-the-smallest-divisor-given-a-threshold]] | next: [[1410.traffic-light-controlled-intersection]] >>
