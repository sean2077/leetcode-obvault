...
aliases:
  ...
  - 最少交换次数来组合所有的 1 II
lcLink: https://leetcode.com/problems/minimum-swaps-to-group-all-1s-together-ii/
lcTopics:
  - '[[array]]'
  - '[[sliding-window]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2254.check-if-every-row-and-column-contains-all-numbers]] | next: [[2256.count-words-obtained-after-adding-a-letter]] >>
