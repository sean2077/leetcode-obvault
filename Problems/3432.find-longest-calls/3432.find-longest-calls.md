...
aliases:
  ...
  - find-longest-calls
  - 查找最长的电话
lcLink: https://leetcode.com/problems/find-longest-calls/
lcTopics:
  - '[[database]]'
lcDifficulty: Medium
lcAcRate: 71.4%
...
**Nav:** << previous: [[3431.find-the-minimum-cost-array-permutation]] | next: [[3433.maximum-number-that-makes-result-of-bitwise-and-zero]] >>
