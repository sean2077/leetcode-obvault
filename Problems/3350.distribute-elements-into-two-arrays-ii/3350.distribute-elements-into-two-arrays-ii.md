...
aliases:
  ...
  - distribute-elements-into-two-arrays-ii
  - 将元素分配到两个数组中 II
lcLink: https://leetcode.com/problems/distribute-elements-into-two-arrays-ii/
lcTopics:
  - '[[binary-indexed-tree]]'
  - '[[segment-tree]]'
  - '[[array]]'
...
**Nav:** << previous: [[3349.maximum-length-substring-with-two-occurrences]] | next: [[3351.maximize-happiness-of-selected-children]] >>
