...
aliases:
  ...
  - shifting-letters
  - 字母移位
lcLink: https://leetcode.com/problems/shifting-letters/
lcTopics:
  - '[[array]]'
  - '[[string]]'
  - '[[prefix-sum]]'
...
lcAcRate: 44.8%
similarQuestions:
  - '[[1954.replace-all-digits-with-characters|1954.将所有数字用字符替换]]'
...
**Nav:** << previous: [[877.shortest-path-visiting-all-nodes]] | next: [[879.maximize-distance-to-closest-person]] >>
