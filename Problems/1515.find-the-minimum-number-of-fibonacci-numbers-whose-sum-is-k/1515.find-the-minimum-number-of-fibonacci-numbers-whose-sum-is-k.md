...
aliases:
  ...
  - find-the-minimum-number-of-fibonacci-numbers-whose-sum-is-k
  - 和为 K 的最少斐波那契数字数目
lcLink: https://leetcode.com/problems/find-the-minimum-number-of-fibonacci-numbers-whose-sum-is-k/
lcTopics:
  - '[[greedy]]'
  - '[[math]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1514.minimum-value-to-get-positive-step-by-step-sum]] | next: [[1516.the-k-th-lexicographical-string-of-all-happy-strings-of-length-n]] >>
