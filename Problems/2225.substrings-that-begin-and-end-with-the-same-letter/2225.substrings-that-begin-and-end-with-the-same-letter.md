...
lcAcRate: 74.3%
similarQuestions:
  - '[[1635.number-of-good-pairs|1635.好数对的数目]]'
  - '[[1890.sum-of-beauty-of-all-substrings|1890.所有子字符串美丽值之和]]'
  - '[[2036.count-pairs-in-two-arrays|2036.统计数对]]'
  - '[[2303.unique-substrings-with-equal-digit-frequency|2303.每个数字的频率都相同的独特子字符串的数量]]'
grade: ⭐⭐⭐⭐⭐
likes: 133
dislikes: 11
favorites: []
...
**Nav:** << previous: [[2224.drop-type-1-orders-for-customers-with-type-0-orders]] | next: [[2226.rings-and-rods]] >>
