...
aliases:
  ...
  - search-suggestions-system
  - 搜索推荐系统
lcLink: https://leetcode.com/problems/search-suggestions-system/
lcTopics:
  - '[[trie]]'
  - '[[array]]'
  - '[[string]]'
...
**Nav:** << previous: [[1396.count-servers-that-communicate]] | next: [[1398.number-of-ways-to-stay-in-the-same-place-after-some-steps]] >>
