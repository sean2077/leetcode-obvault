...
aliases:
  ...
  - shortest-impossible-sequence-of-rolls
  - 不可能得到的最短骰子序列
lcLink: https://leetcode.com/problems/shortest-impossible-sequence-of-rolls/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2434.design-a-number-container-system]] | next: [[2436.make-array-zero-by-subtracting-equal-amounts]] >>
