...
aliases:
  ...
  - optimize-water-distribution-in-a-village
  - 水资源分配优化
lcLink: https://leetcode.com/problems/optimize-water-distribution-in-a-village/
lcTopics:
  - '[[union-find]]'
  - '[[graph]]'
...
**Nav:** << previous: [[1143.find-smallest-common-element-in-all-rows]] | next: [[1145.number-of-submatrices-that-sum-to-target]] >>
