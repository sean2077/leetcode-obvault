...
aliases:
  ...
  - number-of-different-integers-in-a-string
  - 字符串中不同整数的数目
lcLink: https://leetcode.com/problems/number-of-different-integers-in-a-string/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1932.grand-slam-titles]] | next: [[1934.evaluate-the-bracket-pairs-of-a-string]] >>
