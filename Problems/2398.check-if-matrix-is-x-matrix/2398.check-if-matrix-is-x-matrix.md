...
aliases:
  ...
  - check-if-matrix-is-x-matrix
  - 判断矩阵是否是一个 X 矩阵
lcLink: https://leetcode.com/problems/check-if-matrix-is-x-matrix/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[2397.count-number-of-ways-to-place-houses]] | next: [[2399.minimum-flips-in-binary-tree-to-get-result]] >>
