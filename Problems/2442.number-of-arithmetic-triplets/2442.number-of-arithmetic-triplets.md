...
aliases:
  ...
  - number-of-arithmetic-triplets
  - 算术三元组的数目
lcLink: https://leetcode.com/problems/number-of-arithmetic-triplets/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[two-pointers]]'
...
similarQuestions:
  - '[[1.two-sum|1.两数之和]]'
  - '[[15.3sum|15.三数之和]]'
  - '[[2566.number-of-unequal-triplets-in-array|2566.数组中不等三元组的数目]]'
  - '[[3154.maximum-value-of-an-ordered-triplet-i|3154.有序三元组中的最大值 I]]'
...
**Nav:** << previous: [[2441.arrange-table-by-gender]] | next: [[2443.check-if-there-is-a-valid-partition-for-the-array]] >>
