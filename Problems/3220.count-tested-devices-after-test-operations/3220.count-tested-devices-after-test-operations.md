...
aliases:
  ...
  - count-tested-devices-after-test-operations
  - 统计已测试设备
lcLink: https://leetcode.com/problems/count-tested-devices-after-test-operations/
lcTopics:
  - '[[array]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3219.make-lexicographically-smallest-array-by-swapping-elements]] | next: [[3221.find-the-peaks]] >>
