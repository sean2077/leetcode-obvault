...
aliases:
  ...
  - flower-planting-with-no-adjacent
  - 不邻接植花
lcLink: https://leetcode.com/problems/flower-planting-with-no-adjacent/
lcTopics:
  - '[[depth-first-search]]'
...
**Nav:** << previous: [[1119.robot-bounded-in-circle]] | next: [[1121.partition-array-for-maximum-sum]] >>
