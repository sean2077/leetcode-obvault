...
aliases:
  ...
  - count-special-integers
  - 统计特殊整数
lcLink: https://leetcode.com/problems/count-special-integers/
lcTopics:
  - '[[math]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[2456.construct-smallest-number-from-di-string]] | next: [[2458.find-minimum-time-to-finish-all-jobs-ii]] >>
