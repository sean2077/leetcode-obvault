...
aliases:
  ...
  - longest-cycle-in-a-graph
  - 图中的最长环
lcLink: https://leetcode.com/problems/longest-cycle-in-a-graph/
lcTopics:
  - '[[depth-first-search]]'
  - '[[graph]]'
  - '[[topological-sort]]'
...
similarQuestions:
  ...
  - '[[2671.shortest-cycle-in-a-graph|2671.图中的最短环]]'
grade: ⭐⭐⭐⭐⭐
likes: 2323
dislikes: 46
favorites: []
...
**Nav:** << previous: [[2438.find-closest-node-to-given-two-nodes]] | next: [[2440.tasks-count-in-the-weekend]] >>
