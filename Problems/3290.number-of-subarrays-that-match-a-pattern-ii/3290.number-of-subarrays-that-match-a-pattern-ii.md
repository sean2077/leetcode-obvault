...
translatedTitle: 匹配模式数组的子数组数目 II
titleSlug: number-of-subarrays-that-match-a-pattern-ii
aliases:
  - Number of Subarrays That Match a Pattern II
  - number-of-subarrays-that-match-a-pattern-ii
  - 匹配模式数组的子数组数目 II
lcLink: https://leetcode.com/problems/number-of-subarrays-that-match-a-pattern-ii/
lcTopics:
  - '[[array]]'
  - '[[string-matching]]'
  - '[[hash-function]]'
...
lcAcRate: 32.5%
similarQuestions:
  - '[[2393.match-substring-after-replacement|2393.替换字符后匹配]]'
grade: ⭐⭐⭐⭐⭐
likes: 139
dislikes: 5
favorites: []
...
**Nav:** << previous: [[3289.earliest-second-to-mark-indices-ii]] | next: [[3291.find-if-array-can-be-sorted]] >>
...
[submissions](https://leetcode.com/problems/number-of-subarrays-that-match-a-pattern-ii/submissions/) | [solutions](https://leetcode.com/problems/number-of-subarrays-that-match-a-pattern-ii/solutions/)
...
[提交记录](https://leetcode.cn/problems/number-of-subarrays-that-match-a-pattern-ii/submissions/) | [题解](https://leetcode.cn/problems/number-of-subarrays-that-match-a-pattern-ii/solution/)
