...
aliases:
  ...
  - merge-operations-to-turn-array-into-a-palindrome
  - 使用合并操作将数组转换为回文序列
lcLink: https://leetcode.com/problems/merge-operations-to-turn-array-into-a-palindrome/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[two-pointers]]'
...
**Nav:** << previous: [[2564.most-profitable-path-in-a-tree]] | next: [[2566.number-of-unequal-triplets-in-array]] >>
