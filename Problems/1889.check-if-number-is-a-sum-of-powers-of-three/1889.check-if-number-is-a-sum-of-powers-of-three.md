...
aliases:
  ...
  - check-if-number-is-a-sum-of-powers-of-three
  - 判断一个数字是否可以表示成三的幂的和
lcLink: https://leetcode.com/problems/check-if-number-is-a-sum-of-powers-of-three/
lcTopics:
  - '[[math]]'
lcDifficulty: Medium
lcAcRate: 67.9%
...
**Nav:** << previous: [[1888.find-nearest-point-that-has-the-same-x-or-y-coordinate]] | next: [[1890.sum-of-beauty-of-all-substrings]] >>
