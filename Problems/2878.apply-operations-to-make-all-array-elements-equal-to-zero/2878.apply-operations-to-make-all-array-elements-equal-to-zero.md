...
aliases:
  ...
  - apply-operations-to-make-all-array-elements-equal-to-zero
  - 使数组中的所有元素都等于零
lcLink: https://leetcode.com/problems/apply-operations-to-make-all-array-elements-equal-to-zero/
lcTopics:
  - '[[array]]'
  - '[[prefix-sum]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2877.shortest-string-that-contains-three-strings]] | next: [[2879.minimum-changes-to-make-k-semi-palindromes]] >>
