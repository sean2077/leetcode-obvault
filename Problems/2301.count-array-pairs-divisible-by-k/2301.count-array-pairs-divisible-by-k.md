...
aliases:
  ...
  - count-array-pairs-divisible-by-k
  - 统计可以被 K 整除的下标对数目
lcLink: https://leetcode.com/problems/count-array-pairs-divisible-by-k/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[number-theory]]'
...
lcAcRate: 29.6%
similarQuestions:
  - '[[1383.number-of-single-divisor-triplets|1383.单因数三元组]]'
  - '[[1620.check-if-array-pairs-are-divisible-by-k|1620.检查数组对是否可以被 k 整除]]'
  - '[[3444.find-the-number-of-good-pairs-ii|3444.优质数对的总数 II]]'
  - '[[3446.find-the-number-of-good-pairs-i|3446.优质数对的总数 I]]'
grade: ⭐⭐⭐⭐⭐
likes: 841
dislikes: 35
favorites: []
...
**Nav:** << previous: [[2300.construct-string-with-repeat-limit]] | next: [[2302.order-two-columns-independently]] >>
