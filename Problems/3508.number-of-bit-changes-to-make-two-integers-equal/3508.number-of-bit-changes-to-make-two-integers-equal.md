...
aliases:
  ...
  - number-of-bit-changes-to-make-two-integers-equal
  - 使两个整数相等的位更改次数
lcLink: https://leetcode.com/problems/number-of-bit-changes-to-make-two-integers-equal/
lcTopics:
  - '[[bit-manipulation]]'
lcDifficulty: Easy
lcAcRate: 64.1%
...
**Nav:** << previous: [[3507.find-the-count-of-numbers-which-are-not-special]] | next: [[3511.find-the-winning-player-in-coin-game]] >>
