...
aliases:
  ...
  - count-the-number-of-powerful-integers
  - 统计强大整数的数目
lcLink: https://leetcode.com/problems/count-the-number-of-powerful-integers/
lcTopics:
  - '[[math]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 26.3%
similarQuestions:
  - '[[1010.powerful-integers|1010.强整数]]'
  - '[[1057.numbers-with-repeated-digits|1057.至少有 1 位重复的数字]]'
grade: ⭐⭐⭐⭐⭐
likes: 105
dislikes: 9
favorites: []
...
**Nav:** << previous: [[3242.count-elements-with-maximum-frequency]] | next: [[3244.minimize-length-of-array-using-operations]] >>
