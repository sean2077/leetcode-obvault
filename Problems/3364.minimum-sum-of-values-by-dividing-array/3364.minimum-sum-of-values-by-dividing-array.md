...
aliases:
  ...
  - minimum-sum-of-values-by-dividing-array
  - 划分数组得到最小的值之和
lcLink: https://leetcode.com/problems/minimum-sum-of-values-by-dividing-array/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[segment-tree]]'
  - '[[queue]]'
...
similarQuestions:
  ...
  - '[[3436.find-subarray-with-bitwise-or-closest-to-k|3436.找到按位或最接近 K 的子数组]]'
grade: ⭐⭐⭐⭐⭐
likes: 106
dislikes: 4
favorites: []
...
**Nav:** << previous: [[3363.most-frequent-ids]] | next: [[3365.find-all-unique-email-domains]] >>
