...
aliases:
  ...
  - design-a-file-sharing-system
  - 设计文件分享系统
lcLink: https://leetcode.com/problems/design-a-file-sharing-system/
lcTopics:
  - '[[design]]'
  - '[[hash-table]]'
  - '[[data-stream]]'
...
**Nav:** << previous: [[1639.friendly-movies-streamed-last-month]] | next: [[1641.countries-you-can-safely-invest-in]] >>
