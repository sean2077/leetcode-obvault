...
aliases:
  ...
  - maximum-strength-of-a-group
  - 一个小组的最大实力值
lcLink: https://leetcode.com/problems/maximum-strength-of-a-group/
lcTopics:
  - '[[greedy]]'
  - '[[bit-manipulation]]'
  - '[[array]]'
...
**Nav:** << previous: [[2753.minimum-number-of-operations-to-make-all-array-elements-equal-to-1]] | next: [[2755.extra-characters-in-a-string]] >>
