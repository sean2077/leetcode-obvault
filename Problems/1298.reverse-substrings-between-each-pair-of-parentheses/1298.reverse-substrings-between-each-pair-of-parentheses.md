...
aliases:
  ...
  - reverse-substrings-between-each-pair-of-parentheses
  - 反转每对括号间的子串
lcLink: https://leetcode.com/problems/reverse-substrings-between-each-pair-of-parentheses/
lcTopics:
  - '[[stack]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1297.maximum-number-of-balloons]] | next: [[1299.k-concatenation-maximum-sum]] >>
