...
aliases:
  ...
  - triples-with-bitwise-and-equal-to-zero
  - 按位与为零的三元组
lcLink: https://leetcode.com/problems/triples-with-bitwise-and-equal-to-zero/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[1023.time-based-key-value-store]] | next: [[1025.minimum-cost-for-tickets]] >>
