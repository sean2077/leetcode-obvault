...
aliases:
  ...
  - prime-pairs-with-target-sum
  - 和等于目标值的质数对
lcLink: https://leetcode.com/problems/prime-pairs-with-target-sum/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[enumeration]]'
...
**Nav:** << previous: [[2872.largest-element-in-an-array-after-merge-operations]] | next: [[2874.popularity-percentage]] >>
