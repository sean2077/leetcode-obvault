...
aliases:
  ...
  - minimum-operations-to-make-the-integer-zero
  - 得到整数零需要执行的最少操作数
lcLink: https://leetcode.com/problems/minimum-operations-to-make-the-integer-zero/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[brainteaser]]'
lcDifficulty: Medium
lcAcRate: 29.8%
similarQuestions:
  - '[[1033.broken-calculator|1033.坏了的计算器]]'
...
**Nav:** << previous: [[2836.neither-minimum-nor-maximum]] | next: [[2838.sum-of-matrix-after-queries]] >>
