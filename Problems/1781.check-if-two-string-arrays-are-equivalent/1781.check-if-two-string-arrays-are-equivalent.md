...
aliases:
  ...
  - check-if-two-string-arrays-are-equivalent
  - 检查两个字符串数组是否相等
lcLink: https://leetcode.com/problems/check-if-two-string-arrays-are-equivalent/
lcTopics:
  - '[[array]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1780.lowest-common-ancestor-of-a-binary-tree-ii]] | next: [[1782.smallest-string-with-a-given-numeric-value]] >>
