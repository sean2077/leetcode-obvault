...
aliases:
  ...
  - number-of-valid-clock-times
  - 有效时间的数目
lcLink: https://leetcode.com/problems/number-of-valid-clock-times/
lcTopics:
  - '[[string]]'
  - '[[enumeration]]'
lcDifficulty: Easy
lcAcRate: 46.8%
similarQuestions:
  - '[[986.largest-time-for-given-digits|986.给定数字能组成的最大时间]]'
  - '[[1858.latest-time-by-replacing-hidden-digits|1858.替换隐藏数字得到的最晚时间]]'
grade: ⭐
likes: 286
dislikes: 235
favorites: []
...
**Nav:** << previous: [[2527.count-subarrays-with-fixed-bounds]] | next: [[2529.range-product-queries-of-powers]] >>
