...
aliases:
  ...
  - binary-tree-cameras
  - 监控二叉树
lcLink: https://leetcode.com/problems/binary-tree-cameras/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 46.7%
similarQuestions:
  - '[[1021.distribute-coins-in-binary-tree|1021.在二叉树中分配硬币]]'
...
**Nav:** << previous: [[1007.numbers-with-same-consecutive-differences]] | next: [[1009.pancake-sorting]] >>
