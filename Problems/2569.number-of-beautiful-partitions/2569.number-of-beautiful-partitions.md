...
aliases:
  ...
  - number-of-beautiful-partitions
  - 完美分割的方案数
lcLink: https://leetcode.com/problems/number-of-beautiful-partitions/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[2568.minimum-fuel-cost-to-report-to-the-capital]] | next: [[2570.maximize-total-tastiness-of-purchased-fruits]] >>
