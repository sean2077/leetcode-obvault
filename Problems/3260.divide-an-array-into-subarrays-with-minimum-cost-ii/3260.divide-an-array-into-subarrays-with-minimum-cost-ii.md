...
aliases:
  ...
  - divide-an-array-into-subarrays-with-minimum-cost-ii
  - 将数组分成最小总代价的子数组 II
lcLink: https://leetcode.com/problems/divide-an-array-into-subarrays-with-minimum-cost-ii/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sliding-window]]'
...
**Nav:** << previous: [[3259.binary-tree-nodes]] | next: [[3261.minimize-or-of-remaining-elements-using-operations]] >>
