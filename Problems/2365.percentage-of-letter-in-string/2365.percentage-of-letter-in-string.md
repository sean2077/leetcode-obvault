...
aliases:
  ...
  - percentage-of-letter-in-string
  - 字母在字符串中的百分比
lcLink: https://leetcode.com/problems/percentage-of-letter-in-string/
lcTopics:
  - '[[string]]'
lcDifficulty: Easy
lcAcRate: 74.1%
...
**Nav:** << previous: [[2364.longest-path-with-different-adjacent-characters]] | next: [[2366.maximum-bags-with-full-capacity-of-rocks]] >>
