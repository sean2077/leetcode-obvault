...
aliases:
  ...
  - number-of-pairs-of-interchangeable-rectangles
  - 可互换矩形的组数
lcLink: https://leetcode.com/problems/number-of-pairs-of-interchangeable-rectangles/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[math]]'
...
**Nav:** << previous: [[2128.reverse-prefix-of-word]] | next: [[2130.maximum-product-of-the-length-of-two-palindromic-subsequences]] >>
