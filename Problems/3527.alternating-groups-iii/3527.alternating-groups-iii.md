...
aliases:
  ...
  - alternating-groups-iii
  - 交替组 III
lcLink: https://leetcode.com/problems/alternating-groups-iii/
lcTopics: []
lcDifficulty: Hard
lcAcRate: 5.5%
similarQuestions: []
...
**Nav:** << previous: [[3526.minimum-number-of-flips-to-make-binary-grid-palindromic-i]] | next: [[3529.maximum-array-hopping-score-ii]] >>
