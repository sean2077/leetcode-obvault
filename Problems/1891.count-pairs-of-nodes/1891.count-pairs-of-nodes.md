...
aliases:
  ...
  - count-pairs-of-nodes
  - 统计点对的数目
lcLink: https://leetcode.com/problems/count-pairs-of-nodes/
lcTopics:
  - '[[graph]]'
  - '[[array]]'
  - '[[two-pointers]]'
...
**Nav:** << previous: [[1890.sum-of-beauty-of-all-substrings]] | next: [[1892.find-total-time-spent-by-each-employee]] >>
