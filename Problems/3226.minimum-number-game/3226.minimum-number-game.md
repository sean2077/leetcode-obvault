...
aliases:
  ...
  - minimum-number-game
  - 最小数字游戏
lcLink: https://leetcode.com/problems/minimum-number-game/
lcTopics:
  - '[[array]]'
  - '[[sorting]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[3225.length-of-longest-subarray-with-at-most-k-frequency]] | next: [[3227.find-missing-and-repeated-values]] >>
