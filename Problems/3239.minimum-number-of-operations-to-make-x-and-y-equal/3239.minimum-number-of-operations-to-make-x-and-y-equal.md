...
aliases:
  ...
  - minimum-number-of-operations-to-make-x-and-y-equal
  - 使 X 和 Y 相等的最少操作次数
lcLink: https://leetcode.com/problems/minimum-number-of-operations-to-make-x-and-y-equal/
lcTopics:
...
**Nav:** << previous: [[3238.minimum-cost-to-convert-string-ii]] | next: [[3240.maximum-number-that-sum-of-the-prices-is-less-than-or-equal-to-k]] >>
