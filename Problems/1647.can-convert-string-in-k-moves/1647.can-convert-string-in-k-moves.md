...
aliases:
  ...
  - can-convert-string-in-k-moves
  - K 次操作转变字符串
lcLink: https://leetcode.com/problems/can-convert-string-in-k-moves/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1646.kth-missing-positive-number]] | next: [[1648.minimum-insertions-to-balance-a-parentheses-string]] >>
