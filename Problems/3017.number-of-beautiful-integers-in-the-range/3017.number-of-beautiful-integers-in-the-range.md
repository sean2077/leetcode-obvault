...
aliases:
  ...
  - number-of-beautiful-integers-in-the-range
  - 范围中美丽整数的数目
lcLink: https://leetcode.com/problems/number-of-beautiful-integers-in-the-range/
lcTopics:
  - '[[math]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[3016.count-nodes-that-are-great-enough]] | next: [[3018.make-string-a-subsequence-using-cyclic-increments]] >>
