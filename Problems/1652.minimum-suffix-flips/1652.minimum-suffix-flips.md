...
lcAcRate: 73.4%
similarQuestions:
  - '[[3477.minimum-operations-to-make-binary-array-elements-equal-to-one-ii|3477.使二进制数组全部等于
    1 的最少操作次数 II]]'
grade: ⭐⭐⭐⭐⭐
likes: 1024
dislikes: 43
...
**Nav:** << previous: [[1651.shuffle-string]] | next: [[1653.number-of-good-leaf-nodes-pairs]] >>
