...
translatedTitle: 找出满足差值条件的下标 I
titleSlug: find-indices-with-index-and-value-difference-i
aliases:
  - Find Indices With Index and Value Difference I
  - find-indices-with-index-and-value-difference-i
  - 找出满足差值条件的下标 I
lcLink: https://leetcode.com/problems/find-indices-with-index-and-value-difference-i/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
lcDifficulty: Easy
lcAcRate: 61.9%
similarQuestions:
  - '[[3000.minimum-absolute-difference-between-elements-with-constraint|3000.限制条件下元素之间的最小绝对差]]'
  - '[[3170.find-indices-with-index-and-value-difference-ii|3170.找出满足差值条件的下标 II]]'
grade: ⭐⭐⭐⭐
likes: 135
dislikes: 16
favorites: []
...
**Nav:** << previous: [[3164.last-visited-integers]] | next: [[3166.minimum-number-of-groups-to-create-a-valid-assignment]] >>
...
[submissions](https://leetcode.com/problems/find-indices-with-index-and-value-difference-i/submissions/) | [solutions](https://leetcode.com/problems/find-indices-with-index-and-value-difference-i/solutions/)
...
[提交记录](https://leetcode.cn/problems/find-indices-with-index-and-value-difference-i/submissions/) | [题解](https://leetcode.cn/problems/find-indices-with-index-and-value-difference-i/solution/)
