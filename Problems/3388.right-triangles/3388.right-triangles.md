...
aliases:
  ...
  - right-triangles
  - 直角三角形
lcLink: https://leetcode.com/problems/right-triangles/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[math]]'
...
**Nav:** << previous: [[3387.minimum-operations-to-make-median-of-array-equal-to-k]] | next: [[3389.minimum-time-to-visit-disappearing-nodes]] >>
