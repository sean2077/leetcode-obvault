...
aliases:
  ...
  - maximize-total-cost-of-alternating-subarrays
  - 最大化子数组的总成本
lcLink: https://leetcode.com/problems/maximize-total-cost-of-alternating-subarrays/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3463.alternating-groups-i]] | next: [[3465.employee-task-duration-and-concurrent-tasks]] >>
