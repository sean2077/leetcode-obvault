...
aliases:
  ...
  - paths-in-matrix-whose-sum-is-divisible-by-k
  - 矩阵中和能被 K 整除的路径
lcLink: https://leetcode.com/problems/paths-in-matrix-whose-sum-is-divisible-by-k/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
  - '[[matrix]]'
...
similarQuestions:
  ...
  - '[[1171.shortest-path-in-binary-matrix|1171.二进制矩阵中的最短路径]]'
...
**Nav:** << previous: [[2520.using-a-robot-to-print-the-lexicographically-smallest-string]] | next: [[2522.median-of-a-row-wise-sorted-matrix]] >>
