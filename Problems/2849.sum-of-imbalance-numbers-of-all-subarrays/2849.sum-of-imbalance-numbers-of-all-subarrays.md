...
aliases:
  ...
  - sum-of-imbalance-numbers-of-all-subarrays
  - 所有子数组中不平衡数字之和
lcLink: https://leetcode.com/problems/sum-of-imbalance-numbers-of-all-subarrays/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[ordered-set]]'
...
**Nav:** << previous: [[2848.special-permutations]] | next: [[2850.construct-the-longest-new-string]] >>
