...
aliases:
  ...
  - longest-arithmetic-subsequence-of-given-difference
  - 最长定差子序列
lcLink: https://leetcode.com/problems/longest-arithmetic-subsequence-of-given-difference/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 54.7%
similarQuestions:
  - '[[2548.destroy-sequential-targets|2548.摧毁一系列目标]]'
grade: ⭐⭐⭐⭐⭐
likes: 3211
dislikes: 89
favorites: []
...
**Nav:** << previous: [[1329.minimum-cost-to-move-chips-to-the-same-position]] | next: [[1331.path-with-maximum-gold]] >>
