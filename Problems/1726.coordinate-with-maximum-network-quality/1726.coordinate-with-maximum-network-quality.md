...
aliases:
  ...
  - coordinate-with-maximum-network-quality
  - 网络信号最好的坐标
lcLink: https://leetcode.com/problems/coordinate-with-maximum-network-quality/
lcTopics:
  - '[[array]]'
  - '[[enumeration]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1725.number-of-sets-of-k-non-overlapping-line-segments]] | next: [[1727.cat-and-mouse-ii]] >>
