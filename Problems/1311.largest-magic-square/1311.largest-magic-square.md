...
aliases:
  ...
  - largest-magic-square
  - 最大的幻方
lcLink: https://leetcode.com/problems/largest-magic-square/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[prefix-sum]]'
...
lcAcRate: 52.6%
similarQuestions:
  - '[[870.magic-squares-in-grid|870.矩阵中的幻方]]'
grade: ⭐
likes: 293
dislikes: 260
favorites: []
...
**Nav:** << previous: [[1310.watering-plants]] | next: [[1312.count-artifacts-that-can-be-extracted]] >>
