...
aliases:
  ...
  - longer-contiguous-segments-of-ones-than-zeros
  - 哪种连续子字符串更长
lcLink: https://leetcode.com/problems/longer-contiguous-segments-of-ones-than-zeros/
lcTopics:
  - '[[string]]'
lcDifficulty: Easy
lcAcRate: 61.2%
similarQuestions:
  ...
  - '[[1910.check-if-binary-string-has-at-most-one-segment-of-ones|1910.检查二进制字符串字段]]'
grade: ⭐⭐⭐⭐⭐
likes: 515
dislikes: 13
favorites: []
...
**Nav:** << previous: [[1998.suspicious-bank-accounts]] | next: [[2000.minimum-speed-to-arrive-on-time]] >>
