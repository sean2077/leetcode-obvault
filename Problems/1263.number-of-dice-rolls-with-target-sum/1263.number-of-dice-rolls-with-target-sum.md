...
lcAcRate: 61.0%
similarQuestions:
  - '[[1901.equal-sum-arrays-with-minimum-number-of-operations|1901.通过最少操作次数使数组的和相等]]'
  - '[[2155.find-missing-observations|2155.找出缺失的观测数据]]'
grade: ⭐⭐⭐⭐⭐
likes: 5053
dislikes: 170
favorites: []
...
**Nav:** << previous: [[1262.online-majority-element-in-subarray]] | next: [[1264.maximum-number-of-words-you-can-type]] >>
