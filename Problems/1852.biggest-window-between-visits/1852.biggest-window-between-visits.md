...
aliases:
  ...
  - biggest-window-between-visits
  - 访问日期之间最大的空档期
lcLink: https://leetcode.com/problems/biggest-window-between-visits/
lcTopics:
  - '[[database]]'
lcDifficulty: Medium
lcAcRate: 70.5%
similarQuestions:
  - '[[2370.users-with-two-purchases-within-seven-days|2370.7 天内两次购买的用户]]'
grade: ⭐⭐⭐⭐⭐
likes: 209
dislikes: 15
favorites: []
...
**Nav:** << previous: [[1851.maximum-number-of-events-that-can-be-attended-ii]] | next: [[1858.latest-time-by-replacing-hidden-digits]] >>
