...
aliases:
  ...
  - pour-water-between-buckets-to-make-water-levels-equal
  - 通过倒水操作让所有的水桶所含水量相等
lcLink: https://leetcode.com/problems/pour-water-between-buckets-to-make-water-levels-equal/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2272.maximum-good-people-based-on-statements]] | next: [[2274.keep-multiplying-found-values-by-two]] >>
