...
aliases:
  ...
  - maximum-employees-to-be-invited-to-a-meeting
  - 参加会议的最多员工数
lcLink: https://leetcode.com/problems/maximum-employees-to-be-invited-to-a-meeting/
lcTopics:
  - '[[depth-first-search]]'
  - '[[graph]]'
  - '[[topological-sort]]'
...
**Nav:** << previous: [[2245.destroying-asteroids]] | next: [[2247.number-of-unique-flavors-after-sharing-k-candies]] >>
