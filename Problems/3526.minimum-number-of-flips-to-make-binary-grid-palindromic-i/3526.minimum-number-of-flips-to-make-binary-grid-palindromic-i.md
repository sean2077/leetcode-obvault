...
aliases:
  ...
  - minimum-number-of-flips-to-make-binary-grid-palindromic-i
  - 最少翻转次数使二进制矩阵回文 I
lcLink: https://leetcode.com/problems/minimum-number-of-flips-to-make-binary-grid-palindromic-i/
lcTopics: []
lcDifficulty: Medium
lcAcRate: 77.2%
similarQuestions:
  - '[[1356.minimum-number-of-moves-to-make-palindrome|1356.得到回文串的最少操作次数]]'
grade: ⭐⭐⭐⭐
likes: 28
dislikes: 4
favorites: []
...
**Nav:** << previous: [[3524.minimum-number-of-flips-to-make-binary-grid-palindromic-ii]] | next: [[3527.alternating-groups-iii]] >>
