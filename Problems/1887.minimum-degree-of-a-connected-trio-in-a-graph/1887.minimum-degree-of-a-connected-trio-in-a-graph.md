...
lcAcRate: 42.5%
similarQuestions:
  - '[[2596.add-edges-to-make-degrees-of-all-nodes-even|2596.添加边使所有节点度数都为偶数]]'
grade: ⭐
likes: 321
dislikes: 285
favorites: []
...
**Nav:** << previous: [[1886.minimum-limit-of-balls-in-a-bag]] | next: [[1888.find-nearest-point-that-has-the-same-x-or-y-coordinate]] >>
