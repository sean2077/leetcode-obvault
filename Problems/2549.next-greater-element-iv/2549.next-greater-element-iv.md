...
aliases:
  ...
  - next-greater-element-iv
  - 下一个更大元素 IV
lcLink: https://leetcode.com/problems/next-greater-element-iv/
lcTopics:
  - '[[stack]]'
  - '[[array]]'
  - '[[binary-search]]'
...
similarQuestions:
  ...
  - '[[3001.apply-operations-to-maximize-score|3001.操作使得分最大]]'
grade: ⭐⭐⭐⭐⭐
likes: 659
dislikes: 10
favorites: []
...
**Nav:** << previous: [[2548.destroy-sequential-targets]] | next: [[2550.words-within-two-edits-of-dictionary]] >>
