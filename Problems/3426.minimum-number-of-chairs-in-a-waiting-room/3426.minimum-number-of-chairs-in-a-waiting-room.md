...
aliases:
  ...
  - minimum-number-of-chairs-in-a-waiting-room
  - 候诊室中的最少椅子数
lcLink: https://leetcode.com/problems/minimum-number-of-chairs-in-a-waiting-room/
lcTopics:
  - '[[string]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3425.maximum-number-of-potholes-that-can-be-fixed]] | next: [[3427.special-array-ii]] >>
