...
lcAcRate: 72.1%
similarQuestions:
  - '[[1756.minimum-deletions-to-make-string-balanced|1756.使字符串平衡的最少删除次数]]'
  - '[[1878.check-if-array-is-sorted-and-rotated|1878.检查数组是否经排序和轮转得到]]'
...
**Nav:** << previous: [[2242.subsequence-of-size-k-with-the-largest-even-sum]] | next: [[2244.number-of-laser-beams-in-a-bank]] >>
