...
aliases:
  ...
  - recover-a-tree-from-preorder-traversal
  - 从先序遍历还原二叉树
lcLink: https://leetcode.com/problems/recover-a-tree-from-preorder-traversal/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[string]]'
...
**Nav:** << previous: [[1092.maximum-difference-between-node-and-ancestor]] | next: [[1094.matrix-cells-in-distance-order]] >>
