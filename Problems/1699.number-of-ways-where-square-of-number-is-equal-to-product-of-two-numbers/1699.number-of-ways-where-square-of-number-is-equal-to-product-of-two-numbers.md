...
aliases:
  ...
  - number-of-ways-where-square-of-number-is-equal-to-product-of-two-numbers
  - 数的平方等于两数乘积的方法数
lcLink: https://leetcode.com/problems/number-of-ways-where-square-of-number-is-equal-to-product-of-two-numbers/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[math]]'
...
**Nav:** << previous: [[1698.replace-all-s-to-avoid-consecutive-repeating-characters]] | next: [[1700.minimum-time-to-make-rope-colorful]] >>
