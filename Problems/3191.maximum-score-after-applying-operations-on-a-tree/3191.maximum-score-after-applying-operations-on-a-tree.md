...
aliases:
  ...
  - maximum-score-after-applying-operations-on-a-tree
  - 在树上执行操作以后得到的最大分数
lcLink: https://leetcode.com/problems/maximum-score-after-applying-operations-on-a-tree/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[dynamic-programming]]'
...
similarQuestions:
  ...
  - '[[3307.find-the-maximum-sum-of-node-values|3307.最大节点价值之和]]'
grade: ⭐⭐⭐⭐
likes: 317
dislikes: 65
favorites: []
...
**Nav:** << previous: [[3190.minimum-operations-to-maximize-last-elements-in-arrays]] | next: [[3192.maximum-xor-product]] >>
