...
aliases:
  ...
  - moving-stones-until-consecutive
  - 移动石子直到连续
lcLink: https://leetcode.com/problems/moving-stones-until-consecutive/
lcTopics:
  - '[[brainteaser]]'
  - '[[math]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1102.check-if-a-number-is-majority-element-in-a-sorted-array]] | next: [[1104.coloring-a-border]] >>
