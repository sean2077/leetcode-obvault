...
aliases:
  ...
  - distinct-subsequences-ii
  - 不同的子序列 II
lcLink: https://leetcode.com/problems/distinct-subsequences-ii/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
lcAcRate: 43.2%
similarQuestions:
  - '[[2115.number-of-unique-good-subsequences|2115.不同的好子序列数目]]'
  - '[[3057.count-k-subsequences-of-a-string-with-maximum-beauty|3057.统计一个字符串的 k 子序列美丽值最大的数目]]'
grade: ⭐⭐⭐⭐⭐
likes: 1718
dislikes: 38
favorites: []
...
**Nav:** << previous: [[976.minimum-area-rectangle]] | next: [[978.valid-mountain-array]] >>
