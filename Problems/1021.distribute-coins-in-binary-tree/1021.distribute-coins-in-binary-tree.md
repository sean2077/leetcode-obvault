...
aliases:
  ...
  - distribute-coins-in-binary-tree
  - 在二叉树中分配硬币
lcLink: https://leetcode.com/problems/distribute-coins-in-binary-tree/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[binary-tree]]'
...
lcAcRate: 77.1%
similarQuestions:
  - '[[863.sum-of-distances-in-tree|863.树中距离之和]]'
...
**Nav:** << previous: [[1020.longest-turbulent-subarray]] | next: [[1022.unique-paths-iii]] >>
