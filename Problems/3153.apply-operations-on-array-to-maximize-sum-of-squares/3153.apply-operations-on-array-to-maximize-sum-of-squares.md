...
aliases:
  ...
  - apply-operations-on-array-to-maximize-sum-of-squares
  - 对数组执行操作使平方和最大
lcLink: https://leetcode.com/problems/apply-operations-on-array-to-maximize-sum-of-squares/
lcTopics:
  - '[[greedy]]'
  - '[[bit-manipulation]]'
  - '[[array]]'
...
**Nav:** << previous: [[3152.maximum-value-of-an-ordered-triplet-ii]] | next: [[3154.maximum-value-of-an-ordered-triplet-i]] >>
