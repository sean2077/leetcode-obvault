...
similarQuestions:
  ...
  - '[[1904.second-largest-digit-in-a-string|1904.字符串中第二大的数字]]'
  - '[[3046.minimum-operations-to-make-a-special-number|3046.生成特殊数字的最少操作]]'
grade: ⭐⭐⭐⭐⭐
likes: 826
dislikes: 53
favorites: []
...
**Nav:** << previous: [[2336.the-number-of-users-that-are-eligible-for-discount]] | next: [[2338.minimum-consecutive-cards-to-pick-up]] >>
