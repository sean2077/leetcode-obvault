...
aliases:
  ...
  - number-of-ways-to-split-a-string
  - 分割字符串的方案数
lcLink: https://leetcode.com/problems/number-of-ways-to-split-a-string/
lcTopics:
  - '[[math]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1677.matrix-diagonal-sum]] | next: [[1679.shortest-subarray-to-be-removed-to-make-array-sorted]] >>
