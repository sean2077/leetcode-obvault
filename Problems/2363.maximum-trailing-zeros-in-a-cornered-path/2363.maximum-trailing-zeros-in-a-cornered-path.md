...
aliases:
  ...
  - maximum-trailing-zeros-in-a-cornered-path
  - 转角路径的乘积中最多能有几个尾随零
lcLink: https://leetcode.com/problems/maximum-trailing-zeros-in-a-cornered-path/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[2362.minimum-rounds-to-complete-all-tasks]] | next: [[2364.longest-path-with-different-adjacent-characters]] >>
