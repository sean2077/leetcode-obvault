...
aliases:
  ...
  - evaluate-boolean-binary-tree
  - 计算布尔二叉树的值
lcLink: https://leetcode.com/problems/evaluate-boolean-binary-tree/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[binary-tree]]'
...
lcAcRate: 82.8%
similarQuestions:
  - '[[1750.check-if-two-expression-trees-are-equivalent|1750.检查两棵二叉表达式树是否等价]]'
  - '[[1768.design-an-expression-tree-with-evaluate-function|1768.设计带解析函数的表达式树]]'
...
**Nav:** << previous: [[2415.count-the-number-of-ideal-arrays]] | next: [[2417.the-latest-time-to-catch-a-bus]] >>
