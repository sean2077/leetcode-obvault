...
aliases:
  ...
  - number-of-nodes-in-the-sub-tree-with-the-same-label
  - 子树中标签相同的节点数
lcLink: https://leetcode.com/problems/number-of-nodes-in-the-sub-tree-with-the-same-label/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
...
**Nav:** << previous: [[1642.water-bottles]] | next: [[1644.maximum-number-of-non-overlapping-substrings]] >>
