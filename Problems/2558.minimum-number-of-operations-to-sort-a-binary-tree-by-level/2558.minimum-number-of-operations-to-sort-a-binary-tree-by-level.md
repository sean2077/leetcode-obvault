...
aliases:
  ...
  - minimum-number-of-operations-to-sort-a-binary-tree-by-level
  - 逐层排序二叉树所需的最少操作数目
lcLink: https://leetcode.com/problems/minimum-number-of-operations-to-sort-a-binary-tree-by-level/
lcTopics:
  - '[[tree]]'
...
**Nav:** << previous: [[2557.number-of-subarrays-with-lcm-equal-to-k]] | next: [[2559.maximum-number-of-non-overlapping-palindrome-substrings]] >>
