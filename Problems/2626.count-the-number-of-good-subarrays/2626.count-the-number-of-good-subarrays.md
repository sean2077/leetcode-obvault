...
aliases:
  ...
  - count-the-number-of-good-subarrays
  - 统计好子数组的数目
lcLink: https://leetcode.com/problems/count-the-number-of-good-subarrays/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sliding-window]]'
...
**Nav:** << previous: [[2625.increment-submatrices-by-one]] | next: [[2627.difference-between-maximum-and-minimum-price-sum]] >>
