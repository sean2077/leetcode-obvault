...
aliases:
  ...
  - minimum-moves-to-pick-k-ones
  - 拾起 K 个 1 需要的最少行动次数
lcLink: https://leetcode.com/problems/minimum-moves-to-pick-k-ones/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[3326.count-pairs-of-connectable-servers-in-a-weighted-tree-network]] | next: [[3328.apply-operations-to-make-sum-of-array-greater-than-or-equal-to-k]] >>
