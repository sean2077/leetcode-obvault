...
aliases:
  ...
  - minimum-cost-of-buying-candies-with-discount
  - 打折购买糖果的最小开销
lcLink: https://leetcode.com/problems/minimum-cost-of-buying-candies-with-discount/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
similarQuestions:
  ...
  - '[[1306.minimum-absolute-difference|1306.最小绝对差]]'
  - '[[3404.minimum-number-of-operations-to-satisfy-conditions|3404.使矩阵满足条件的最少操作次数]]'
  - '[[3415.check-if-grid-satisfies-conditions|3415.判断矩阵是否满足条件]]'
grade: ⭐⭐⭐⭐⭐
likes: 590
dislikes: 19
favorites: []
...
**Nav:** << previous: [[2247.number-of-unique-flavors-after-sharing-k-candies]] | next: [[2249.count-the-hidden-sequences]] >>
