...
aliases:
  ...
  - find-number-of-coins-to-place-in-tree-nodes
  - 树中每个节点放置的金币数目
lcLink: https://leetcode.com/problems/find-number-of-coins-to-place-in-tree-nodes/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[3217.number-of-possible-sets-of-closing-branches]] | next: [[3219.make-lexicographically-smallest-array-by-swapping-elements]] >>
