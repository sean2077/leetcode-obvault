...
aliases:
  ...
  - find-the-minimum-cost-array-permutation
  - 找出分数最低的排列
lcLink: https://leetcode.com/problems/find-the-minimum-cost-array-permutation/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 22.7%
similarQuestions:
  - '[[877.shortest-path-visiting-all-nodes|877.访问所有节点的最短路径]]'
...
**Nav:** << previous: [[3430.count-days-without-meetings]] | next: [[3432.find-longest-calls]] >>
