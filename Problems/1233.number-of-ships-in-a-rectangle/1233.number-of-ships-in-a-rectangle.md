...
aliases:
  ...
  - number-of-ships-in-a-rectangle
  - 矩形内船只的数目
lcLink: https://leetcode.com/problems/number-of-ships-in-a-rectangle/
lcTopics:
  - '[[array]]'
  - '[[divide-and-conquer]]'
  - '[[interactive]]'
...
**Nav:** << previous: [[1232.sum-of-mutated-array-closest-to-target]] | next: [[1234.number-of-paths-with-max-score]] >>
