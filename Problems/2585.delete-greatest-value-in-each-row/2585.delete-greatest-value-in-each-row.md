...
aliases:
  ...
  - delete-greatest-value-in-each-row
  - 删除每行中的最大值
lcLink: https://leetcode.com/problems/delete-greatest-value-in-each-row/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[sorting]]'
...
lcAcRate: 78.3%
similarQuestions:
  - '[[2428.equal-row-and-column-pairs|2428.相等行列对]]'
grade: ⭐⭐⭐⭐⭐
likes: 635
dislikes: 47
favorites: []
...
**Nav:** << previous: [[2584.number-of-nodes-with-value-one]] | next: [[2586.longest-square-streak-in-an-array]] >>
