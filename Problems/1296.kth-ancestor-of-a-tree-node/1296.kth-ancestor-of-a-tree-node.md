...
aliases:
  ...
  - kth-ancestor-of-a-tree-node
  - 树节点的第 K 个祖先
lcLink: https://leetcode.com/problems/kth-ancestor-of-a-tree-node/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
...
lcAcRate: 34.8%
similarQuestions:
  - '[[3079.minimum-edge-weight-equilibrium-queries-in-a-tree|3079.边权重均等查询]]'
grade: ⭐⭐⭐⭐⭐
likes: 1925
dislikes: 118
favorites: []
...
**Nav:** << previous: [[1295.minimum-garden-perimeter-to-collect-enough-apples]] | next: [[1297.maximum-number-of-balloons]] >>
