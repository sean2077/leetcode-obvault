...
aliases:
  ...
  - subarray-sums-divisible-by-k
  - 和可被 K 整除的子数组
lcLink: https://leetcode.com/problems/subarray-sums-divisible-by-k/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[prefix-sum]]'
...
similarQuestions:
  ...
  - '[[2713.find-the-divisibility-array-of-a-string|2713.找出字符串的可整除数组]]'
...
**Nav:** << previous: [[1014.k-closest-points-to-origin]] | next: [[1017.odd-even-jump]] >>
