...
aliases:
  ...
  - minimum-difference-between-largest-and-smallest-value-in-three-moves
  - 三次操作后最大值与最小值的最小差
lcLink: https://leetcode.com/problems/minimum-difference-between-largest-and-smallest-value-in-three-moves/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[1615.range-sum-of-sorted-subarray-sums]] | next: [[1617.stone-game-iv]] >>
