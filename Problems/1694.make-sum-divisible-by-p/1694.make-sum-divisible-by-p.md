...
aliases:
  ...
  - make-sum-divisible-by-p
  - 使数组和能被 P 整除
lcLink: https://leetcode.com/problems/make-sum-divisible-by-p/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[1693.sum-of-all-odd-length-subarrays]] | next: [[1695.maximum-sum-obtained-of-any-permutation]] >>
