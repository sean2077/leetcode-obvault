...
aliases:
  ...
  - splitting-a-string-into-descending-consecutive-values
  - 将字符串拆分为递减的连续值
lcLink: https://leetcode.com/problems/splitting-a-string-into-descending-consecutive-values/
lcTopics:
  - '[[string]]'
  - '[[backtracking]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1975.minimum-distance-to-the-target-element]] | next: [[1977.minimum-interval-to-include-each-query]] >>
