...
aliases:
  ...
  - set-intersection-size-at-least-two
  - 设置交集大小至少为2
lcLink: https://leetcode.com/problems/set-intersection-size-at-least-two/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[758.convert-binary-search-tree-to-sorted-doubly-linked-list]] | next: [[760.bold-words-in-string]] >>
