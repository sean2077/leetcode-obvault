...
aliases:
  ...
  - sum-of-scores-of-built-strings
  - 构造字符串的总得分和
lcLink: https://leetcode.com/problems/sum-of-scores-of-built-strings/
lcTopics:
  - '[[string]]'
  - '[[binary-search]]'
  - '[[string-matching]]'
...
**Nav:** << previous: [[2325.number-of-ways-to-select-buildings]] | next: [[2327.largest-number-after-digit-swaps-by-parity]] >>
