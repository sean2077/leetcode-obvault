...
aliases:
  ...
  - design-memory-allocator
  - 设计内存分配器
lcLink: https://leetcode.com/problems/design-memory-allocator/
lcTopics:
  - '[[design]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2586.longest-square-streak-in-an-array]] | next: [[2588.maximum-number-of-points-from-grid-queries]] >>
