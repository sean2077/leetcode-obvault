...
aliases:
  ...
  - form-largest-integer-with-digits-that-add-up-to-target
  - 数位成本和为目标值的最大数字
lcLink: https://leetcode.com/problems/form-largest-integer-with-digits-that-add-up-to-target/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[1544.count-good-nodes-in-binary-tree]] | next: [[1546.find-the-quiet-students-in-all-exams]] >>
