...
aliases:
  ...
  - minimum-absolute-difference-between-elements-with-constraint
  - 限制条件下元素之间的最小绝对差
lcLink: https://leetcode.com/problems/minimum-absolute-difference-between-elements-with-constraint/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[ordered-set]]'
...
**Nav:** << previous: [[2999.check-if-strings-can-be-made-equal-with-operations-i]] | next: [[3001.apply-operations-to-maximize-score]] >>
