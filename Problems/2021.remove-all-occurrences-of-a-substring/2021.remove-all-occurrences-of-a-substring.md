...
aliases:
  ...
  - remove-all-occurrences-of-a-substring
  - 删除一个字符串中所有出现的给定子字符串
lcLink: https://leetcode.com/problems/remove-all-occurrences-of-a-substring/
lcTopics:
  - '[[string]]'
lcDifficulty: Medium
lcAcRate: 77.7%
...
**Nav:** << previous: [[2020.remove-one-element-to-make-the-array-strictly-increasing]] | next: [[2022.maximum-alternating-subsequence-sum]] >>
