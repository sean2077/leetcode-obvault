...
aliases:
  ...
  - egg-drop-with-2-eggs-and-n-floors
  - 鸡蛋掉落-两枚鸡蛋
lcLink: https://leetcode.com/problems/egg-drop-with-2-eggs-and-n-floors/
lcTopics:
  - '[[math]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2030.group-employees-of-the-same-salary]] | next: [[2032.largest-odd-number-in-string]] >>
