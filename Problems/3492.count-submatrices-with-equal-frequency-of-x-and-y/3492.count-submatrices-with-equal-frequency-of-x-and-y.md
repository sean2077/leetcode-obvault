...
aliases:
  ...
  - count-submatrices-with-equal-frequency-of-x-and-y
  - 统计 X 和 Y 频数相等的子矩阵数量
lcLink: https://leetcode.com/problems/count-submatrices-with-equal-frequency-of-x-and-y/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[prefix-sum]]'
...
lcAcRate: 51.5%
similarQuestions:
  - '[[1344.maximum-equal-frequency|1344.最大相等频率]]'
  - '[[1628.count-submatrices-with-all-ones|1628.统计全 1 子矩形]]'
grade: ⭐⭐⭐⭐
likes: 126
dislikes: 24
favorites: []
...
**Nav:** << previous: [[3491.find-the-maximum-length-of-valid-subsequence-ii]] | next: [[3493.maximum-number-of-operations-to-move-ones-to-the-end]] >>
