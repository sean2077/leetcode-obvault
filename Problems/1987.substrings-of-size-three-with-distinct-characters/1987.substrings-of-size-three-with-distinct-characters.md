...
aliases:
  ...
  - substrings-of-size-three-with-distinct-characters
  - 长度为三且各字符不同的子字符串
lcLink: https://leetcode.com/problems/substrings-of-size-three-with-distinct-characters/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[counting]]'
...
**Nav:** << previous: [[1986.largest-color-value-in-a-directed-graph]] | next: [[1988.minimize-maximum-pair-sum-in-array]] >>
