...
aliases:
  ...
  - count-negative-numbers-in-a-sorted-matrix
  - 统计有序矩阵中的负数
lcLink: https://leetcode.com/problems/count-negative-numbers-in-a-sorted-matrix/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[matrix]]'
...
lcAcRate: 77.4%
similarQuestions:
  - '[[2614.maximum-count-of-positive-integer-and-negative-integer|2614.正整数和负整数的最大计数]]'
grade: ⭐⭐⭐⭐⭐
likes: 4967
dislikes: 132
favorites: []
...
**Nav:** << previous: [[1475.maximum-sum-bst-in-binary-tree]] | next: [[1477.product-of-the-last-k-numbers]] >>
