...
similarQuestions:
  ...
  - '[[1965.sum-of-digits-in-base-k|1965.K 进制表示下的各位数字总和]]'
grade: ⭐⭐⭐⭐⭐
likes: 252
dislikes: 11
favorites: []
...
**Nav:** << previous: [[2995.number-of-unique-categories]] | next: [[2999.check-if-strings-can-be-made-equal-with-operations-i]] >>
