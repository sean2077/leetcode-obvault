...
aliases:
  ...
  - count-number-of-texts
  - 统计打字方案数
lcLink: https://leetcode.com/problems/count-number-of-texts/
lcTopics:
  - '[[hash-table]]'
  - '[[math]]'
  - '[[string]]'
...
**Nav:** << previous: [[2347.count-nodes-equal-to-average-of-subtree]] | next: [[2349.check-if-there-is-a-valid-parentheses-string-path]] >>
