...
aliases:
  ...
  - minimum-time-to-visit-disappearing-nodes
  - 访问消失节点的最少时间
lcLink: https://leetcode.com/problems/minimum-time-to-visit-disappearing-nodes/
lcTopics:
  - '[[graph]]'
  - '[[array]]'
  - '[[shortest-path]]'
...
**Nav:** << previous: [[3388.right-triangles]] | next: [[3390.minimum-rectangles-to-cover-points]] >>
