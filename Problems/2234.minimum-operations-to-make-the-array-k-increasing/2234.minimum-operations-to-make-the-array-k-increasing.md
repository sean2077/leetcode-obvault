...
aliases:
  ...
  - minimum-operations-to-make-the-array-k-increasing
  - 使数组 K 递增的最少操作次数
lcLink: https://leetcode.com/problems/minimum-operations-to-make-the-array-k-increasing/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[2233.number-of-smooth-descent-periods-of-a-stock]] | next: [[2235.capitalize-the-title]] >>
