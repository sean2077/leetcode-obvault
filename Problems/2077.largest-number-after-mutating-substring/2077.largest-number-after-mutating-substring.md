...
aliases:
  ...
  - largest-number-after-mutating-substring
  - 子字符串突变后可能得到的最大整数
lcLink: https://leetcode.com/problems/largest-number-after-mutating-substring/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[string]]'
...
**Nav:** << previous: [[2076.sum-of-digits-of-string-after-convert]] | next: [[2078.maximum-compatibility-score-sum]] >>
