...
lcAcRate: 66.2%
similarQuestions:
  - '[[2580.circular-sentence|2580.回环句]]'
  - '[[2598.shortest-distance-to-target-string-in-a-circular-array|2598.到目标字符串的最短距离]]'
...
**Nav:** << previous: [[1753.path-with-minimum-effort]] | next: [[1756.minimum-deletions-to-make-string-balanced]] >>
