...
aliases:
  ...
  - before-and-after-puzzle
  - 前后拼接
lcLink: https://leetcode.com/problems/before-and-after-puzzle/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[1131.count-substrings-with-only-one-distinct-letter]] | next: [[1133.last-substring-in-lexicographical-order]] >>
