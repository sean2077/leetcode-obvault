...
aliases:
  ...
  - left-and-right-sum-differences
  - 左右元素和的差值
lcLink: https://leetcode.com/problems/left-and-right-sum-differences/
lcTopics:
  - '[[array]]'
  - '[[prefix-sum]]'
lcDifficulty: Easy
...
similarQuestions:
  ...
  - '[[2777.find-the-distinct-difference-array|2777.找出不同元素数目差数组]]'
  - '[[3422.find-the-n-th-value-after-k-seconds|3422.K 秒后第 N 个元素的值]]'
grade: ⭐⭐⭐⭐⭐
likes: 1045
dislikes: 98
favorites: []
...
**Nav:** << previous: [[2713.find-the-divisibility-array-of-a-string]] | next: [[2715.k-items-with-the-maximum-sum]] >>
