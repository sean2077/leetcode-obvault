...
aliases:
  ...
  - check-if-array-is-sorted-and-rotated
  - 检查数组是否经排序和轮转得到
lcLink: https://leetcode.com/problems/check-if-array-is-sorted-and-rotated/
lcTopics:
  - '[[array]]'
lcDifficulty: Easy
lcAcRate: 51.3%
...
**Nav:** << previous: [[1877.find-followers-count]] | next: [[1879.maximum-score-from-removing-stones]] >>
