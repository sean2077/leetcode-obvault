...
aliases:
  ...
  - maximum-score-from-grid-operations
  - 网格图操作后的最大分数
lcLink: https://leetcode.com/problems/maximum-score-from-grid-operations/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
  - '[[matrix]]'
...
lcAcRate: 24.5%
similarQuestions:
  - '[[3391.maximum-difference-score-in-a-grid|3391.矩阵中的最大得分]]'
grade: ⭐⭐⭐⭐
likes: 46
dislikes: 7
favorites: []
...
**Nav:** << previous: [[3469.maximum-height-of-a-triangle]] | next: [[3471.minimum-average-of-smallest-and-largest-elements]] >>
