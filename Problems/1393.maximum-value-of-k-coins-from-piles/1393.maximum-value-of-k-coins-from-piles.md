...
aliases:
  ...
  - maximum-value-of-k-coins-from-piles
  - 从栈中取出 K 个硬币的最大面值和
lcLink: https://leetcode.com/problems/maximum-value-of-k-coins-from-piles/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[1392.find-the-difference-of-two-arrays]] | next: [[1394.minimum-path-cost-in-a-grid]] >>
