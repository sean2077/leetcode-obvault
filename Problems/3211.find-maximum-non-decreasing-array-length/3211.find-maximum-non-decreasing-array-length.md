...
aliases:
  ...
  - find-maximum-non-decreasing-array-length
  - 找到最大非递减数组的长度
lcLink: https://leetcode.com/problems/find-maximum-non-decreasing-array-length/
lcTopics:
  - '[[stack]]'
  - '[[queue]]'
  - '[[array]]'
...
**Nav:** << previous: [[3210.count-beautiful-substrings-i]] | next: [[3212.count-the-number-of-good-partitions]] >>
