...
aliases:
  ...
  - check-if-n-and-its-double-exist
  - 检查整数及其两倍数是否存在
lcLink: https://leetcode.com/problems/check-if-n-and-its-double-exist/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[two-pointers]]'
...
**Nav:** << previous: [[1467.number-of-transactions-per-visit]] | next: [[1469.minimum-number-of-steps-to-make-two-strings-anagram]] >>
