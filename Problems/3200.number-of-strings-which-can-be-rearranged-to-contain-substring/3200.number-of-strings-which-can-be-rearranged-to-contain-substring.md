...
aliases:
  ...
  - number-of-strings-which-can-be-rearranged-to-contain-substring
  - 重新排列后包含指定子字符串的字符串数目
lcLink: https://leetcode.com/problems/number-of-strings-which-can-be-rearranged-to-contain-substring/
lcTopics:
  - '[[math]]'
  - '[[dynamic-programming]]'
  - '[[combinatorics]]'
...
lcAcRate: 56.3%
similarQuestions:
  - '[[1332.count-vowels-permutation|1332.统计元音字母序列的数目]]'
grade: ⭐⭐⭐
likes: 165
dislikes: 64
favorites: []
...
**Nav:** << previous: [[3199.distribute-candies-among-children-i]] | next: [[3201.distribute-candies-among-children-ii]] >>
