...
aliases:
  ...
  - maximum-deletions-on-a-string
  - 对字母串可执行的最大删除数
lcLink: https://leetcode.com/problems/maximum-deletions-on-a-string/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
  - '[[string-matching]]'
...
similarQuestions:
  ...
  - '[[2021.remove-all-occurrences-of-a-substring|2021.删除一个字符串中所有出现的给定子字符串]]'
grade: ⭐⭐⭐⭐
likes: 482
dislikes: 54
favorites: []
...
**Nav:** << previous: [[2509.minimize-xor]] | next: [[2511.partition-string-into-substrings-with-values-at-most-k]] >>
