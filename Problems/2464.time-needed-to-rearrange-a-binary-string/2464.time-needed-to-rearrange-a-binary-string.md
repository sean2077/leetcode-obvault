...
aliases:
  ...
  - time-needed-to-rearrange-a-binary-string
  - 二进制字符串重新安排顺序需要的时间
lcLink: https://leetcode.com/problems/time-needed-to-rearrange-a-binary-string/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[2463.minimum-recolors-to-get-k-consecutive-black-blocks]] | next: [[2465.shifting-letters-ii]] >>
