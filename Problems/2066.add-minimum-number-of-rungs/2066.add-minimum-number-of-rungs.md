...
aliases:
  ...
  - add-minimum-number-of-rungs
  - 新增的最少台阶数
lcLink: https://leetcode.com/problems/add-minimum-number-of-rungs/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2065.check-for-contradictions-in-equations]] | next: [[2067.maximum-number-of-points-with-cost]] >>
