...
similarQuestions:
  ...
  - '[[1781.check-if-two-string-arrays-are-equivalent|1781.检查两个字符串数组是否相等]]'
grade: ⭐⭐
likes: 310
dislikes: 153
favorites: []
...
**Nav:** << previous: [[2183.minimum-operations-to-convert-number]] | next: [[2185.accepted-candidates-from-the-interviews]] >>
