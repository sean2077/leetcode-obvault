...
aliases:
  ...
  - distribute-elements-into-two-arrays-i
  - 将元素分配到两个数组中 I
lcLink: https://leetcode.com/problems/distribute-elements-into-two-arrays-i/
lcTopics:
  - '[[array]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3346.lexicographically-smallest-string-after-operations-with-constraint]] | next: [[3348.minimum-cost-walk-in-weighted-graph]] >>
