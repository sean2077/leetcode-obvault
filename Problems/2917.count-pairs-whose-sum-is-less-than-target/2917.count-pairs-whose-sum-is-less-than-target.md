...
aliases:
  ...
  - count-pairs-whose-sum-is-less-than-target
  - 统计和小于目标的下标对数目
lcLink: https://leetcode.com/problems/count-pairs-whose-sum-is-less-than-target/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[2916.check-if-it-is-possible-to-split-array]] | next: [[2918.is-array-a-preorder-of-some-binary-tree]] >>
