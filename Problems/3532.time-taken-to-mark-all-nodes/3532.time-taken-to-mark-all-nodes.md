...
aliases:
  ...
  - time-taken-to-mark-all-nodes
  - 标记所有节点需要的时间
lcLink: https://leetcode.com/problems/time-taken-to-mark-all-nodes/
lcTopics: []
lcDifficulty: Hard
lcAcRate: 12.2%
similarQuestions:
  - '[[863.sum-of-distances-in-tree|863.树中距离之和]]'
  - '[[2564.most-profitable-path-in-a-tree|2564.树上最大得分和路径]]'
grade: ⭐⭐⭐⭐⭐
likes: 22
dislikes: 1
favorites: []
...
**Nav:** << previous: [[3530.odd-and-even-transactions]] | next: [[3538.alt-and-tab-simulation]] >>
