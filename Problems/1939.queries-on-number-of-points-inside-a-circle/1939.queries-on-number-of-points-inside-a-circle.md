...
aliases:
  ...
  - queries-on-number-of-points-inside-a-circle
  - 统计一个圆中点的数目
lcLink: https://leetcode.com/problems/queries-on-number-of-points-inside-a-circle/
lcTopics:
  - '[[geometry]]'
  - '[[array]]'
  - '[[math]]'
...
lcAcRate: 86.4%
similarQuestions:
  - '[[2332.count-lattice-points-inside-a-circle|2332.统计圆内格点数目]]'
  - '[[2333.count-number-of-rectangles-containing-each-point|2333.统计包含每个点的矩形数目]]'
  - '[[3478.check-if-the-rectangle-corner-is-reachable|3478.判断矩形的两个角落是否可达]]'
grade: ⭐⭐⭐⭐⭐
likes: 1141
dislikes: 83
favorites: []
...
**Nav:** << previous: [[1938.minimum-operations-to-make-the-array-increasing]] | next: [[1940.maximum-xor-for-each-query]] >>
