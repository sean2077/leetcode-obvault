...
aliases:
  ...
  - angle-between-hands-of-a-clock
  - 时钟指针的夹角
lcLink: https://leetcode.com/problems/angle-between-hands-of-a-clock/
lcTopics:
  - '[[math]]'
lcDifficulty: Medium
lcAcRate: 63.9%
...
**Nav:** << previous: [[1445.number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold]] | next: [[1447.jump-game-iv]] >>
