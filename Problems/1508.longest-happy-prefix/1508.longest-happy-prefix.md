...
lcAcRate: 46.3%
similarQuestions:
  - '[[2326.sum-of-scores-of-built-strings|2326.构造字符串的总得分和]]'
  - '[[2510.maximum-deletions-on-a-string|2510.对字母串可执行的最大删除数]]'
  - '[[3296.minimum-time-to-revert-word-to-initial-state-ii|3296.将单词恢复初始状态所需的最短时间
    II]]'
  - '[[3297.minimum-time-to-revert-word-to-initial-state-i|3297.将单词恢复初始状态所需的最短时间 I]]'
grade: ⭐⭐⭐⭐⭐
likes: 1355
dislikes: 38
favorites: []
...
**Nav:** << previous: [[1507.check-if-there-is-a-valid-path-in-a-grid]] | next: [[1509.replace-employee-id-with-the-unique-identifier]] >>
