...
aliases:
  ...
  - sum-of-distances-in-tree
  - 树中距离之和
lcLink: https://leetcode.com/problems/sum-of-distances-in-tree/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[graph]]'
...
similarQuestions:
  ...
  - '[[2175.count-nodes-with-the-highest-score|2175.统计最高分的节点数目]]'
  - '[[2717.collect-coins-in-a-tree|2717.收集树中金币]]'
  - '[[3191.maximum-score-after-applying-operations-on-a-tree|3191.在树上执行操作以后得到的最大分数]]'
  - '[[3326.count-pairs-of-connectable-servers-in-a-weighted-tree-network|3326.在带权树网络中统计可连接服务器对数目]]'
  - '[[3532.time-taken-to-mark-all-nodes|3532.标记所有节点需要的时间]]'
grade: ⭐⭐⭐⭐⭐
likes: 5577
dislikes: 136
favorites: []
...
**Nav:** << previous: [[862.find-and-replace-in-string]] | next: [[864.image-overlap]] >>
