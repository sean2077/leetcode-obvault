...
lcLink: https://leetcode.com/problems/minimum-operations-to-make-binary-array-elements-equal-to-one-ii/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 64.9%
similarQuestions:
  - '[[1652.minimum-suffix-flips|1652.最少的后缀翻转次数]]'
grade: ⭐⭐⭐⭐⭐
likes: 113
dislikes: 6
favorites: []
...
**Nav:** << previous: [[3476.find-minimum-operations-to-make-all-elements-divisible-by-three]] | next: [[3478.check-if-the-rectangle-corner-is-reachable]] >>
