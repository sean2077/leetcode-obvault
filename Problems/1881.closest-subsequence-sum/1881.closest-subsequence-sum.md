...
aliases:
  ...
  - closest-subsequence-sum
  - 最接近目标值的子序列和
lcLink: https://leetcode.com/problems/closest-subsequence-sum/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[two-pointers]]'
...
lcAcRate: 39.6%
similarQuestions:
  - '[[2108.minimize-the-difference-between-target-and-chosen-elements|2108.最小化目标值与所选元素的差]]'
...
**Nav:** << previous: [[1880.largest-merge-of-two-strings]] | next: [[1882.the-number-of-employees-which-report-to-each-employee]] >>
