...
aliases:
  ...
  - minimum-space-wasted-from-packaging
  - 装包裹的最小浪费空间
lcLink: https://leetcode.com/problems/minimum-space-wasted-from-packaging/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[2017.minimum-number-of-flips-to-make-the-binary-string-alternating]] | next: [[2019.product-of-two-run-length-encoded-arrays]] >>
