...
aliases:
  ...
  - k-radius-subarray-averages
  - 半径为 k 的子数组平均值
lcLink: https://leetcode.com/problems/k-radius-subarray-averages/
lcTopics:
  - '[[array]]'
  - '[[sliding-window]]'
lcDifficulty: Medium
...
similarQuestions:
  ...
  - '[[1445.number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold|1445.大小为
    K 且平均值大于等于阈值的子数组数目]]'
  - '[[3272.find-the-grid-of-region-average|3272.找出网格的区域平均强度]]'
grade: ⭐⭐⭐⭐⭐
likes: 1887
dislikes: 94
favorites: []
...
**Nav:** << previous: [[2210.find-target-indices-after-sorting-array]] | next: [[2212.removing-minimum-and-maximum-from-array]] >>
