...
aliases:
  ...
  - minimum-difference-between-highest-and-lowest-of-k-scores
  - 学生分数的最小差值
lcLink: https://leetcode.com/problems/minimum-difference-between-highest-and-lowest-of-k-scores/
lcTopics:
  - '[[array]]'
  - '[[sorting]]'
  - '[[sliding-window]]'
...
**Nav:** << previous: [[2111.binary-searchable-numbers-in-an-unsorted-array]] | next: [[2113.find-the-kth-largest-integer-in-the-array]] >>
