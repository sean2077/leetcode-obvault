...
aliases:
  ...
  - minimize-hamming-distance-after-swap-operations
  - 执行交换操作后的最小汉明距离
lcLink: https://leetcode.com/problems/minimize-hamming-distance-after-swap-operations/
lcTopics:
  - '[[depth-first-search]]'
  - '[[union-find]]'
  - '[[array]]'
...
**Nav:** << previous: [[1839.decode-xored-array]] | next: [[1842.number-of-calls-between-two-persons]] >>
