...
aliases:
  ...
  - special-array-with-x-elements-greater-than-or-equal-x
  - 特殊数组的特征值
lcLink: https://leetcode.com/problems/special-array-with-x-elements-greater-than-or-equal-x/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[1729.binary-search-tree-iterator-ii]] | next: [[1731.even-odd-tree]] >>
