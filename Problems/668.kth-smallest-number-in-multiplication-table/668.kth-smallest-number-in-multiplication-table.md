...
aliases:
  ...
  - kth-smallest-number-in-multiplication-table
  - 乘法表中第k小的数
lcLink: https://leetcode.com/problems/kth-smallest-number-in-multiplication-table/
lcTopics:
  - '[[math]]'
  - '[[binary-search]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[802.k-th-smallest-prime-fraction|802.第 K 个最小的质数分数]]'
  - '[[2666.minimum-time-to-eat-all-grains|2666.吃掉所有谷子的最短时间]]'
  - '[[3375.kth-smallest-amount-with-single-denomination-combination|3375.单面值组合的第
    K 小金额]]'
grade: ⭐⭐⭐⭐⭐
likes: 2151
dislikes: 58
