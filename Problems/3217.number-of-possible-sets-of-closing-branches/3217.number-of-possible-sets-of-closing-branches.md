...
aliases:
  ...
  - number-of-possible-sets-of-closing-branches
  - 关闭分部的可行集合数目
lcLink: https://leetcode.com/problems/number-of-possible-sets-of-closing-branches/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[graph]]'
  - '[[enumeration]]'
...
**Nav:** << previous: [[3216.distribute-candies-among-children-iii]] | next: [[3218.find-number-of-coins-to-place-in-tree-nodes]] >>
