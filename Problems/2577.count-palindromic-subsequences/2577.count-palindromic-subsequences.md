...
aliases:
  ...
  - count-palindromic-subsequences
  - 统计回文子序列数目
lcLink: https://leetcode.com/problems/count-palindromic-subsequences/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[2059.unique-length-3-palindromic-subsequences|2059.长度为 3 的不同回文子序列]]'
grade: ⭐⭐⭐⭐⭐
likes: 495
dislikes: 27
favorites: []
...
**Nav:** << previous: [[2576.minimum-penalty-for-a-shop]] | next: [[2579.minimum-split-into-subarrays-with-gcd-greater-than-one]] >>
