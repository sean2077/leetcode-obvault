...
aliases:
  ...
  - 买卖芯片的最佳时机
lcLink: https://leetcode.com/problems/gu-piao-de-zui-da-li-run-lcof/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[LCR 187.yuan-quan-zhong-zui-hou-sheng-xia-de-shu-zi-lcof]] | next: [[LCR 189.qiu-12n-lcof]] >>
