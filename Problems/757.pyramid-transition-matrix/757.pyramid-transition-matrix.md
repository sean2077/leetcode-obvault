...
aliases:
  ...
  - pyramid-transition-matrix
  - 金字塔转换矩阵
lcLink: https://leetcode.com/problems/pyramid-transition-matrix/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[depth-first-search]]'
...
**Nav:** << previous: [[756.pour-water]] | next: [[758.convert-binary-search-tree-to-sorted-doubly-linked-list]] >>
