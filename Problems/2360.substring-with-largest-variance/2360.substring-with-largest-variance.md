...
aliases:
  ...
  - substring-with-largest-variance
  - 最大波动的子字符串
lcLink: https://leetcode.com/problems/substring-with-largest-variance/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[2359.maximum-white-tiles-covered-by-a-carpet]] | next: [[2361.calculate-digit-sum-of-a-string]] >>
