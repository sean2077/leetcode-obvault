...
aliases:
  ...
  - numbers-with-repeated-digits
  - 至少有 1 位重复的数字
lcLink: https://leetcode.com/problems/numbers-with-repeated-digits/
lcTopics:
  - '[[math]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
lcAcRate: 42.4%
similarQuestions:
  - '[[3243.count-the-number-of-powerful-integers|3243.统计强大整数的数目]]'
grade: ⭐⭐⭐⭐
likes: 774
dislikes: 88
favorites: []
...
**Nav:** << previous: [[1056.capacity-to-ship-packages-within-d-days]] | next: [[1058.lexicographically-smallest-equivalent-string]] >>
