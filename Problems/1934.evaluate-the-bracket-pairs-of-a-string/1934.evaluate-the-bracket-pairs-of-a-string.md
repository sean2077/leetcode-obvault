...
aliases:
  ...
  - evaluate-the-bracket-pairs-of-a-string
  - 替换字符串中的括号内容
lcLink: https://leetcode.com/problems/evaluate-the-bracket-pairs-of-a-string/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[1933.number-of-different-integers-in-a-string]] | next: [[1935.minimum-number-of-operations-to-reinitialize-a-permutation]] >>
