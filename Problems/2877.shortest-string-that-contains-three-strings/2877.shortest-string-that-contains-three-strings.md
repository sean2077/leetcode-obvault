...
aliases:
  ...
  - shortest-string-that-contains-three-strings
  - 包含三个字符串的最短字符串
lcLink: https://leetcode.com/problems/shortest-string-that-contains-three-strings/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
  - '[[enumeration]]'
...
**Nav:** << previous: [[2876.number-of-employees-who-met-the-target]] | next: [[2878.apply-operations-to-make-all-array-elements-equal-to-zero]] >>
