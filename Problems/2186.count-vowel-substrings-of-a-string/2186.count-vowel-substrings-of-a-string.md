...
lcAcRate: 68.0%
similarQuestions:
  - '[[808.number-of-matching-subsequences|808.匹配子序列的单词数]]'
  - '[[1034.subarrays-with-k-different-integers|1034.K 个不同整数的子数组]]'
  - '[[1636.number-of-substrings-with-only-1s|1636.仅含 1 的子串数]]'
  - '[[1967.longest-substring-of-all-vowels-in-order|1967.所有元音按顺序排布的最长子字符串]]'
  - '[[2340.total-appeal-of-a-string|2340.字符串的总引力]]'
grade: ⭐⭐⭐
likes: 945
dislikes: 239
favorites: []
...
**Nav:** << previous: [[2185.accepted-candidates-from-the-interviews]] | next: [[2187.vowels-of-all-substrings]] >>
