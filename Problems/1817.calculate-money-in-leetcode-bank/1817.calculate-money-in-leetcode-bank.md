...
aliases:
  ...
  - calculate-money-in-leetcode-bank
  - 计算力扣银行的钱
lcLink: https://leetcode.com/problems/calculate-money-in-leetcode-bank/
lcTopics:
  - '[[math]]'
lcDifficulty: Easy
lcAcRate: 78.3%
...
**Nav:** << previous: [[1816.lowest-common-ancestor-of-a-binary-tree-iv]] | next: [[1818.maximum-score-from-removing-substrings]] >>
