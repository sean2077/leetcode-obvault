...
aliases:
  ...
  - find-critical-and-pseudo-critical-edges-in-minimum-spanning-tree
  - 找到最小生成树里的关键边和伪关键边
lcLink: https://leetcode.com/problems/find-critical-and-pseudo-critical-edges-in-minimum-spanning-tree/
lcTopics:
  - '[[union-find]]'
  - '[[graph]]'
...
**Nav:** << previous: [[1612.avoid-flood-in-the-city]] | next: [[1615.range-sum-of-sorted-subarray-sums]] >>
