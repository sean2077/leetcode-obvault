...
aliases:
  ...
  - minimum-fuel-cost-to-report-to-the-capital
  - 到达首都的最少油耗
lcLink: https://leetcode.com/problems/minimum-fuel-cost-to-report-to-the-capital/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
...
**Nav:** << previous: [[2567.closest-nodes-queries-in-a-binary-search-tree]] | next: [[2569.number-of-beautiful-partitions]] >>
