...
aliases:
  ...
  - number-of-people-that-can-be-seen-in-a-grid
  - 在一个网格中可以看到的人数
lcLink: https://leetcode.com/problems/number-of-people-that-can-be-seen-in-a-grid/
lcTopics:
  - '[[stack]]'
  - '[[array]]'
  - '[[matrix]]'
...
**Nav:** << previous: [[2423.minimum-deletions-to-make-array-divisible]] | next: [[2426.maximum-profit-from-trading-stocks]] >>
