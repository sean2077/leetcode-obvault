...
aliases:
  ...
  - minimum-cost-to-make-all-characters-equal
  - 使所有字符相等的最小成本
lcLink: https://leetcode.com/problems/minimum-cost-to-make-all-characters-equal/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 54.5%
similarQuestions:
  - '[[962.flip-string-to-monotone-increasing|962.将字符串翻转到单调递增]]'
grade: ⭐⭐⭐⭐⭐
likes: 527
dislikes: 25
favorites: []
...
**Nav:** << previous: [[2816.lexicographically-smallest-palindrome]] | next: [[2818.maximum-strictly-increasing-cells-in-a-matrix]] >>
