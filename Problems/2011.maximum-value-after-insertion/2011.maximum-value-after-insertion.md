...
aliases:
  ...
  - maximum-value-after-insertion
  - 插入后的最大值
lcLink: https://leetcode.com/problems/maximum-value-after-insertion/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2010.check-if-word-equals-summation-of-two-words]] | next: [[2012.process-tasks-using-servers]] >>
