...
aliases:
  ...
  - longest-non-decreasing-subarray-from-two-arrays
  - 构造最长非递减子数组
lcLink: https://leetcode.com/problems/longest-non-decreasing-subarray-from-two-arrays/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2868.continuous-subarrays]] | next: [[2870.longest-alternating-subarray]] >>
