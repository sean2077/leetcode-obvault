...
aliases:
  ...
  - airplane-seat-assignment-probability
  - 飞机座位分配概率
lcLink: https://leetcode.com/problems/airplane-seat-assignment-probability/
lcTopics:
  - '[[brainteaser]]'
  - '[[math]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1361.tiling-a-rectangle-with-the-fewest-squares]] | next: [[1363.greatest-english-letter-in-upper-and-lower-case]] >>
