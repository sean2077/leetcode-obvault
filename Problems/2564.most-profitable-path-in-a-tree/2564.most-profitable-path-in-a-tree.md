...
aliases:
  ...
  - most-profitable-path-in-a-tree
  - 树上最大得分和路径
lcLink: https://leetcode.com/problems/most-profitable-path-in-a-tree/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
...
lcAcRate: 49.4%
similarQuestions:
  - '[[945.snakes-and-ladders|945.蛇梯棋]]'
...
**Nav:** << previous: [[2563.split-message-based-on-limit]] | next: [[2565.merge-operations-to-turn-array-into-a-palindrome]] >>
