...
aliases:
  ...
  - change-minimum-characters-to-satisfy-one-of-three-conditions
  - 满足三条件之一需改变的最少字符数
lcLink: https://leetcode.com/problems/change-minimum-characters-to-satisfy-one-of-three-conditions/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[counting]]'
...
**Nav:** << previous: [[1858.latest-time-by-replacing-hidden-digits]] | next: [[1860.find-kth-largest-xor-coordinate-value]] >>
