...
aliases:
  ...
  - subsequence-with-the-minimum-score
  - 最少得分子序列
lcLink: https://leetcode.com/problems/subsequence-with-the-minimum-score/
lcTopics:
  - '[[two-pointers]]'
  - '[[string]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[2700.substring-xor-queries]] | next: [[2702.maximum-number-of-integers-to-choose-from-a-range-ii]] >>
