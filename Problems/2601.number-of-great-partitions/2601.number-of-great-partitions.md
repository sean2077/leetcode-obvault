...
aliases:
  ...
  - number-of-great-partitions
  - 好分区的数目
lcLink: https://leetcode.com/problems/number-of-great-partitions/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[2802.find-the-punishment-number-of-an-integer|2802.求一个整数的惩罚数]]'
grade: ⭐⭐⭐⭐⭐
likes: 434
dislikes: 9
favorites: []
...
**Nav:** << previous: [[2600.maximum-tastiness-of-candy-basket]] | next: [[2602.maximum-enemy-forts-that-can-be-captured]] >>
