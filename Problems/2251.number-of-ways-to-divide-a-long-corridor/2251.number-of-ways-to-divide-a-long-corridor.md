...
aliases:
  ...
  - number-of-ways-to-divide-a-long-corridor
  - 分隔长廊的方案数
lcLink: https://leetcode.com/problems/number-of-ways-to-divide-a-long-corridor/
lcTopics:
  - '[[math]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
similarQuestions:
  ...
  - '[[1669.minimum-cost-to-cut-a-stick|1669.切棍子的最小成本]]'
...
**Nav:** << previous: [[2250.k-highest-ranked-items-within-a-price-range]] | next: [[2252.the-airport-with-the-most-traffic]] >>
