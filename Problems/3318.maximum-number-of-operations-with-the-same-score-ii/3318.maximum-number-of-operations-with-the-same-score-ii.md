...
aliases:
  ...
  - maximum-number-of-operations-with-the-same-score-ii
  - 相同分数的最大操作数目 II
lcLink: https://leetcode.com/problems/maximum-number-of-operations-with-the-same-score-ii/
lcTopics:
  - '[[memoization]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[3317.maximum-palindromes-after-operations]] | next: [[3320.maximum-number-of-operations-with-the-same-score-i]] >>
