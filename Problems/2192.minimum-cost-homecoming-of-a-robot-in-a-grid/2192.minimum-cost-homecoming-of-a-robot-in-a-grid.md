...
aliases:
  ...
  - minimum-cost-homecoming-of-a-robot-in-a-grid
  - 网格图中机器人回家的最小代价
lcLink: https://leetcode.com/problems/minimum-cost-homecoming-of-a-robot-in-a-grid/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
lcDifficulty: Medium
...
similarQuestions:
  ...
  - '[[2653.check-if-there-is-a-path-with-equal-number-of-0s-and-1s|2653.检查是否有路径经过相同数量的
    0 和 1]]'
grade: ⭐⭐⭐⭐
likes: 673
dislikes: 90
...
**Nav:** << previous: [[2191.minimum-number-of-food-buckets-to-feed-the-hamsters]] | next: [[2193.count-fertile-pyramids-in-a-land]] >>
