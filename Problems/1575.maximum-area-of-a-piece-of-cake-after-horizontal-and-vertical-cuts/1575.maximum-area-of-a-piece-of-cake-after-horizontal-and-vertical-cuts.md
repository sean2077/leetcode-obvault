...
aliases:
  ...
  - maximum-area-of-a-piece-of-cake-after-horizontal-and-vertical-cuts
  - 切割后面积最大的蛋糕
lcLink: https://leetcode.com/problems/maximum-area-of-a-piece-of-cake-after-horizontal-and-vertical-cuts/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[1574.maximum-product-of-two-elements-in-an-array]] | next: [[1576.reorder-routes-to-make-all-paths-lead-to-the-city-zero]] >>
