...
aliases:
  ...
  - rearrange-spaces-between-words
  - 重新排列单词间的空格
lcLink: https://leetcode.com/problems/rearrange-spaces-between-words/
lcTopics:
  - '[[string]]'
lcDifficulty: Easy
lcAcRate: 43.3%
...
**Nav:** << previous: [[1713.dot-product-of-two-sparse-vectors]] | next: [[1715.split-a-string-into-the-max-number-of-unique-substrings]] >>
