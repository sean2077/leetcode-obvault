...
similarQuestions:
  ...
  - '[[957.minimum-add-to-make-parentheses-valid|957.使括号有效的最少添加]]'
  - '[[1371.minimum-remove-to-make-valid-parentheses|1371.移除无效的括号]]'
  - '[[1648.minimum-insertions-to-balance-a-parentheses-string|1648.平衡括号字符串的最少插入次数]]'
grade: ⭐⭐⭐⭐⭐
likes: 1800
dislikes: 76
favorites: []
...
**Nav:** << previous: [[2094.remove-stones-to-minimize-the-total]] | next: [[2096.find-the-longest-valid-obstacle-course-at-each-position]] >>
