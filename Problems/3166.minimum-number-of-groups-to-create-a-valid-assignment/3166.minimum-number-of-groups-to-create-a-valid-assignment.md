...
aliases:
  ...
  - minimum-number-of-groups-to-create-a-valid-assignment
  - 合法分组的最少组数
lcLink: https://leetcode.com/problems/minimum-number-of-groups-to-create-a-valid-assignment/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[3165.find-indices-with-index-and-value-difference-i]] | next: [[3170.find-indices-with-index-and-value-difference-ii]] >>
