...
aliases:
  ...
  - count-anagrams
  - 统计同位异构字符串数目
lcLink: https://leetcode.com/problems/count-anagrams/
lcTopics:
  - '[[hash-table]]'
  - '[[math]]'
  - '[[string]]'
...
**Nav:** << previous: [[2604.minimum-operations-to-make-array-equal-ii]] | next: [[2606.difference-between-ones-and-zeros-in-row-and-column]] >>
