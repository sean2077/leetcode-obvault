...
aliases:
  ...
  - minimum-increment-operations-to-make-array-beautiful
  - 使数组变美的最小增量运算数
lcLink: https://leetcode.com/problems/minimum-increment-operations-to-make-array-beautiful/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3177.minimizing-array-after-replacing-pairs-with-their-product]] | next: [[3179.maximum-points-after-collecting-coins-from-all-nodes]] >>
