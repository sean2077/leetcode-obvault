...
aliases:
  ...
  - check-whether-two-strings-are-almost-equivalent
  - 检查两个字符串是否几乎相等
lcLink: https://leetcode.com/problems/check-whether-two-strings-are-almost-equivalent/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[counting]]'
...
**Nav:** << previous: [[2176.parallel-courses-iii]] | next: [[2178.walking-robot-simulation-ii]] >>
