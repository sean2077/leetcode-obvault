...
aliases:
  ...
  - apply-operations-to-maximize-score
  - 操作使得分最大
lcLink: https://leetcode.com/problems/apply-operations-to-maximize-score/
lcTopics:
  - '[[stack]]'
  - '[[greedy]]'
  - '[[array]]'
...
**Nav:** << previous: [[3000.minimum-absolute-difference-between-elements-with-constraint]] | next: [[3002.flight-occupancy-and-waitlist-analysis]] >>
