...
aliases:
  ...
  - rearrange-products-table
  - 每个产品在不同商店的价格
lcLink: https://leetcode.com/problems/rearrange-products-table/
lcTopics:
  - '[[database]]'
lcDifficulty: Easy
lcAcRate: 85.3%
similarQuestions:
  ...
  - '[[2382.dynamic-unpivoting-of-a-table|2382.动态取消表的旋转]]'
grade: ⭐⭐⭐⭐⭐
likes: 855
dislikes: 55
favorites: []
...
**Nav:** << previous: [[1947.number-of-different-subsequences-gcds]] | next: [[1949.implement-trie-ii-prefix-tree]] >>
