...
aliases:
  ...
  - parse-lisp-expression
  - Lisp 语法解析
lcLink: https://leetcode.com/problems/parse-lisp-expression/
lcTopics:
  - '[[stack]]'
  - '[[recursion]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[735.asteroid-collision]] | next: [[737.sentence-similarity-ii]] >>
...
[submissions](https://leetcode.com/problems/parse-lisp-expression/submissions/) | [solutions](https://leetcode.com/problems/parse-lisp-expression/solutions/)
...
[提交记录](https://leetcode.cn/problems/parse-lisp-expression/submissions/) | [题解](https://leetcode.cn/problems/parse-lisp-expression/solution/)
