...
aliases:
  ...
  - robot-return-to-origin
  - 机器人能否返回原点
lcLink: https://leetcode.com/problems/robot-return-to-origin/
lcTopics:
  - '[[string]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
similarQuestions:
  ...
  - '[[2239.execution-of-all-suffix-instructions-staying-in-a-grid|2239.执行所有后缀指令]]'
  - '[[3019.furthest-point-from-origin|3019.距离原点最远的点]]'
grade: ⭐⭐⭐
likes: 2427
dislikes: 747
favorites: []
