...
aliases:
  ...
  - insufficient-nodes-in-root-to-leaf-paths
  - 根到叶路径上的不足节点
lcLink: https://leetcode.com/problems/insufficient-nodes-in-root-to-leaf-paths/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[binary-tree]]'
...
**Nav:** << previous: [[1156.occurrences-after-bigram]] | next: [[1159.smallest-subsequence-of-distinct-characters]] >>
