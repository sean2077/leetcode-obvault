...
aliases:
  ...
  - best-sightseeing-pair
  - 最佳观光组合
lcLink: https://leetcode.com/problems/best-sightseeing-pair/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1062.partition-array-into-three-parts-with-equal-sum]] | next: [[1064.smallest-integer-divisible-by-k]] >>
