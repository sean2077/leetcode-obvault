...
aliases:
  ...
  - longest-happy-string
  - 最长快乐字符串
lcLink: https://leetcode.com/problems/longest-happy-string/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
  - '[[heap-priority-queue]]'
...
**Nav:** << previous: [[1303.minimum-moves-to-reach-target-score]] | next: [[1305.number-of-visible-people-in-a-queue]] >>
