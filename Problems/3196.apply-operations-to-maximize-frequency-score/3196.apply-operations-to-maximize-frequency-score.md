...
aliases:
  ...
  - apply-operations-to-maximize-frequency-score
  - 执行操作使频率分数最大
lcLink: https://leetcode.com/problems/apply-operations-to-maximize-frequency-score/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[3195.separate-black-and-white-balls]] | next: [[3197.maximum-strong-pair-xor-ii]] >>
