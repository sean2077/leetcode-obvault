...
lcLink: https://leetcode.com/problems/check-if-a-string-is-a-valid-sequence-from-root-to-leaves-path-in-a-binary-tree/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
...
**Nav:** << previous: [[1431.all-ancestors-of-a-node-in-a-directed-acyclic-graph]] | next: [[1433.encrypt-and-decrypt-strings]] >>
