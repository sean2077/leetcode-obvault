...
aliases:
  ...
  - minimum-number-of-operations-to-satisfy-conditions
  - 使矩阵满足条件的最少操作次数
lcLink: https://leetcode.com/problems/minimum-number-of-operations-to-satisfy-conditions/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
  - '[[matrix]]'
...
**Nav:** << previous: [[3403.minimum-substring-partition-of-equal-character-frequency]] | next: [[3405.count-the-number-of-special-characters-ii]] >>
