...
aliases:
  ...
  - make-array-empty
  - 将数组清空
lcLink: https://leetcode.com/problems/make-array-empty/
lcTopics:
  - '[[greedy]]'
  - '[[binary-indexed-tree]]'
  - '[[segment-tree]]'
...
**Nav:** << previous: [[2764.maximum-number-of-fish-in-a-grid]] | next: [[2766.find-the-prefix-common-array-of-two-arrays]] >>
