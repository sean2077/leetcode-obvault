...
aliases:
  ...
  - maximum-subarray-min-product
  - 子数组最小乘积的最大值
lcLink: https://leetcode.com/problems/maximum-subarray-min-product/
lcTopics:
  - '[[stack]]'
  - '[[array]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[1984.maximum-distance-between-a-pair-of-values]] | next: [[1986.largest-color-value-in-a-directed-graph]] >>
