...
aliases:
  ...
  - minimum-number-of-food-buckets-to-feed-the-hamsters
  - 喂食仓鼠的最小食物桶数
lcLink: https://leetcode.com/problems/minimum-number-of-food-buckets-to-feed-the-hamsters/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 46.8%
similarQuestions:
  - '[[1979.maximum-number-of-people-that-can-be-caught-in-tag|1979.捉迷藏中可捕获的最大人数]]'
  - '[[2075.brightest-position-on-street|2075.街上最亮的位置]]'
grade: ⭐⭐⭐⭐⭐
likes: 536
dislikes: 30
favorites: []
...
**Nav:** << previous: [[2190.count-common-words-with-one-occurrence]] | next: [[2192.minimum-cost-homecoming-of-a-robot-in-a-grid]] >>
