...
aliases:
  ...
  - maximum-odd-binary-number
  - 最大二进制奇数
lcLink: https://leetcode.com/problems/maximum-odd-binary-number/
lcTopics:
  - '[[greedy]]'
  - '[[math]]'
  - '[[string]]'
...
**Nav:** << previous: [[3047.maximum-element-sum-of-a-complete-subset-of-indices]] | next: [[3056.determine-if-a-cell-is-reachable-at-a-given-time]] >>
