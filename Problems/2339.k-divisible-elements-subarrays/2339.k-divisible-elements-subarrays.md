...
aliases:
  ...
  - k-divisible-elements-subarrays
  - 含最多 K 个可整除元素的子数组
lcLink: https://leetcode.com/problems/k-divisible-elements-subarrays/
lcTopics:
  - '[[trie]]'
  - '[[array]]'
  - '[[hash-table]]'
...
similarQuestions:
  ...
  - '[[2419.subarray-with-elements-greater-than-varying-threshold|2419.元素值大于变化阈值的子数组]]'
grade: ⭐⭐⭐⭐
likes: 666
dislikes: 153
favorites: []
...
**Nav:** << previous: [[2338.minimum-consecutive-cards-to-pick-up]] | next: [[2340.total-appeal-of-a-string]] >>
