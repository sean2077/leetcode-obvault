...
aliases:
  ...
  - minimum-number-of-swaps-to-make-the-binary-string-alternating
  - 构成交替字符串需要的最小交换次数
lcLink: https://leetcode.com/problems/minimum-number-of-swaps-to-make-the-binary-string-alternating/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1993.sum-of-all-subset-xor-totals]] | next: [[1995.finding-pairs-with-a-certain-sum]] >>
