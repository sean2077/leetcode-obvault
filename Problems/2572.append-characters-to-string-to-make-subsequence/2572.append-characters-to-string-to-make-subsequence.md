...
aliases:
  ...
  - append-characters-to-string-to-make-subsequence
  - 追加字符以获得子序列
lcLink: https://leetcode.com/problems/append-characters-to-string-to-make-subsequence/
lcTopics:
  - '[[greedy]]'
  - '[[two-pointers]]'
  - '[[string]]'
...
similarQuestions:
  ...
  - '[[1832.minimum-operations-to-make-a-subsequence|1832.得到子序列的最少操作次数]]'
grade: ⭐⭐⭐⭐⭐
likes: 1095
dislikes: 86
favorites: []
...
**Nav:** << previous: [[2571.find-the-pivot-integer]] | next: [[2573.remove-nodes-from-linked-list]] >>
