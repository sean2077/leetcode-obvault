...
aliases:
  ...
  - find-the-student-that-will-replace-the-chalk
  - 找到需要补充粉笔的学生编号
lcLink: https://leetcode.com/problems/find-the-student-that-will-replace-the-chalk/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[2005.check-if-all-the-integers-in-a-range-are-covered]] | next: [[2007.maximum-cost-of-trip-with-k-highways]] >>
