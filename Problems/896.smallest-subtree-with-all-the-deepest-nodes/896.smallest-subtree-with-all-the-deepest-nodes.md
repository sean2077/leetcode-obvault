...
aliases:
  ...
  - smallest-subtree-with-all-the-deepest-nodes
  - 具有所有最深节点的最小子树
lcLink: https://leetcode.com/problems/smallest-subtree-with-all-the-deepest-nodes/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
...
**Nav:** << previous: [[895.shortest-path-to-get-all-keys]] | next: [[897.prime-palindrome]] >>
