...
aliases:
  ...
  - apply-operations-to-an-array
  - 对数组执行操作
lcLink: https://leetcode.com/problems/apply-operations-to-an-array/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[2550.words-within-two-edits-of-dictionary]] | next: [[2552.maximum-sum-of-distinct-subarrays-with-length-k]] >>
