...
aliases:
  ...
  - find-the-maximum-length-of-a-good-subsequence-ii
  - 求出最长好子序列 II
lcLink: https://leetcode.com/problems/find-the-maximum-length-of-a-good-subsequence-ii/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[3451.string-compression-iii]] | next: [[3453.generate-binary-strings-without-adjacent-zeros]] >>
