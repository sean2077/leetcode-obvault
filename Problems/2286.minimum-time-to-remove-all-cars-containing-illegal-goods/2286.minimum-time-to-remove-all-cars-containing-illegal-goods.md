...
aliases:
  ...
  - minimum-time-to-remove-all-cars-containing-illegal-goods
  - 移除所有载有违禁货物车厢所需的最少时间
lcLink: https://leetcode.com/problems/minimum-time-to-remove-all-cars-containing-illegal-goods/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[2285.design-bitset]] | next: [[2287.minimum-number-of-lines-to-cover-points]] >>
