...
aliases:
  ...
  - color-the-triangle-red
  - 把三角形染成红色
lcLink: https://leetcode.com/problems/color-the-triangle-red/
lcTopics:
  - '[[array]]'
  - '[[math]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[2539.minimum-number-of-operations-to-make-arrays-similar]] | next: [[2541.sum-of-number-and-its-reverse]] >>
