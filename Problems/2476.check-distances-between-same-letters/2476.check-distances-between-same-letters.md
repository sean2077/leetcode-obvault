...
aliases:
  ...
  - check-distances-between-same-letters
  - 检查相同字母间的距离
lcLink: https://leetcode.com/problems/check-distances-between-same-letters/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
similarQuestions:
  - '[[1.two-sum|1.两数之和]]'
  - '[[841.shortest-distance-to-a-character|841.字符的最短距离]]'
grade: ⭐⭐⭐⭐
likes: 483
dislikes: 57
favorites: []
...
**Nav:** << previous: [[2475.largest-palindromic-number]] | next: [[2477.number-of-ways-to-reach-a-position-after-exactly-k-steps]] >>
