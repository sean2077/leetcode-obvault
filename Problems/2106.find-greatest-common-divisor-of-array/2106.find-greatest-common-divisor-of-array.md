...
aliases:
  ...
  - find-greatest-common-divisor-of-array
  - 找出数组的最大公约数
lcLink: https://leetcode.com/problems/find-greatest-common-divisor-of-array/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[number-theory]]'
...
similarQuestions:
  ...
  - '[[1947.number-of-different-subsequences-gcds|1947.序列中不同最大公约数的数目]]'
  - '[[2083.three-divisors|2083.三除数]]'
  - '[[2491.smallest-even-multiple|2491.最小偶倍数]]'
  - '[[2546.number-of-subarrays-with-gcd-equal-to-k|2546.最大公因数等于 K 的子数组数目]]'
grade: ⭐⭐⭐⭐⭐
likes: 1120
dislikes: 48
favorites: []
...
**Nav:** << previous: [[2105.the-number-of-good-subsets]] | next: [[2107.find-unique-binary-string]] >>
