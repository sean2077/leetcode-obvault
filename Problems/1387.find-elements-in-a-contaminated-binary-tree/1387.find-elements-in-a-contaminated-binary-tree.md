...
aliases:
  ...
  - find-elements-in-a-contaminated-binary-tree
  - 在受污染的二叉树中查找元素
lcLink: https://leetcode.com/problems/find-elements-in-a-contaminated-binary-tree/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
...
**Nav:** << previous: [[1386.shift-2d-grid]] | next: [[1388.greatest-sum-divisible-by-three]] >>
