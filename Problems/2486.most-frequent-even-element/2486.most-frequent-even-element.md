...
aliases:
  ...
  - most-frequent-even-element
  - 出现最频繁的偶数元素
lcLink: https://leetcode.com/problems/most-frequent-even-element/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[counting]]'
...
**Nav:** << previous: [[2485.finding-the-number-of-visible-mountains]] | next: [[2487.optimal-partition-of-string]] >>
