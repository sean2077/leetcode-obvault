...
aliases:
  ...
  - minimum-levels-to-gain-more-points
  - 得到更多分数的最少关卡数目
lcLink: https://leetcode.com/problems/minimum-levels-to-gain-more-points/
lcTopics:
  - '[[array]]'
  - '[[prefix-sum]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3354.replace-question-marks-in-string-to-minimize-its-value]] | next: [[3356.shortest-uncommon-substring-in-an-array]] >>
