...
aliases:
  ...
  - check-if-a-word-occurs-as-a-prefix-of-any-word-in-a-sentence
  - 检查单词是否为句中其他单词的前缀
lcLink: https://leetcode.com/problems/check-if-a-word-occurs-as-a-prefix-of-any-word-in-a-sentence/
lcTopics:
  - '[[two-pointers]]'
  - '[[string]]'
  - '[[string-matching]]'
...
**Nav:** << previous: [[1565.evaluate-boolean-expression]] | next: [[1567.maximum-number-of-vowels-in-a-substring-of-given-length]] >>
