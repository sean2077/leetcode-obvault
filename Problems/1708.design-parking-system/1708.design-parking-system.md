...
aliases:
  ...
  - design-parking-system
  - 设计停车系统
lcLink: https://leetcode.com/problems/design-parking-system/
lcTopics:
  - '[[design]]'
  - '[[counting]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[1707.check-if-string-is-transformable-with-substring-sort-operations]] | next: [[1709.alert-using-same-key-card-three-or-more-times-in-a-one-hour-period]] >>
