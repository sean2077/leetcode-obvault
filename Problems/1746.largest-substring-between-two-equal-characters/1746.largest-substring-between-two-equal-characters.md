...
aliases:
  ...
  - largest-substring-between-two-equal-characters
  - 两个相同字符之间的最长子字符串
lcLink: https://leetcode.com/problems/largest-substring-between-two-equal-characters/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1745.find-nearest-right-node-in-binary-tree]] | next: [[1747.lexicographically-smallest-string-after-applying-operations]] >>
