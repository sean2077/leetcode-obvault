...
aliases:
  ...
  - find-the-number-of-good-pairs-i
  - 优质数对的总数 I
lcLink: https://leetcode.com/problems/find-the-number-of-good-pairs-i/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3445.lexicographically-minimum-string-after-removing-stars]] | next: [[3447.clear-digits]] >>
