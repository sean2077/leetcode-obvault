...
aliases:
  ...
  - text-justification
  - 文本左右对齐
lcLink: https://leetcode.com/problems/text-justification/
lcTopics:
  - '[[array]]'
  - '[[string]]'
  - '[[simulation]]'
...
lcAcRate: 44.5%
similarQuestions:
  - '[[1714.rearrange-spaces-between-words|1714.重新排列单词间的空格]]'
  - '[[2260.divide-a-string-into-groups-of-size-k|2260.将字符串拆分为若干长度为 k 的组]]'
