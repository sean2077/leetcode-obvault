...
aliases:
  ...
  - check-if-the-rectangle-corner-is-reachable
  - 判断矩形的两个角落是否可达
lcLink: https://leetcode.com/problems/check-if-the-rectangle-corner-is-reachable/
lcTopics:
  - '[[depth-first-search]]'
...
lcAcRate: 30.2%
similarQuestions:
  - '[[1939.queries-on-number-of-points-inside-a-circle|1939.统计一个圆中点的数目]]'
  - '[[2635.check-if-point-is-reachable|2635.判断一个点是否可以到达]]'
grade: ⭐⭐⭐⭐
likes: 81
dislikes: 20
favorites: []
...
**Nav:** << previous: [[3477.minimum-operations-to-make-binary-array-elements-equal-to-one-ii]] | next: [[3479.count-the-number-of-substrings-with-dominant-ones]] >>
