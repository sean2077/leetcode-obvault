...
aliases:
  ...
  - elements-in-array-after-removing-and-replacing-elements
  - 查询删除和添加元素后的数组
lcLink: https://leetcode.com/problems/elements-in-array-after-removing-and-replacing-elements/
lcTopics:
  - '[[array]]'
lcDifficulty: Medium
lcAcRate: 73.7%
...
**Nav:** << previous: [[2257.earliest-possible-day-of-full-bloom]] | next: [[2259.minimum-operations-to-remove-adjacent-ones-in-matrix]] >>
