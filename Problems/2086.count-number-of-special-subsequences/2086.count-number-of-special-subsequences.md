...
aliases:
  ...
  - count-number-of-special-subsequences
  - 统计特殊子序列的数目
lcLink: https://leetcode.com/problems/count-number-of-special-subsequences/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[2085.array-with-elements-not-equal-to-average-of-neighbors]] | next: [[2087.confirmation-rate]] >>
