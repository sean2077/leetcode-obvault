...
aliases:
  ...
  - check-if-there-is-a-valid-partition-for-the-array
  - 检查数组是否存在有效划分
lcLink: https://leetcode.com/problems/check-if-there-is-a-valid-partition-for-the-array/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
lcAcRate: 51.8%
similarQuestions:
  - '[[3212.count-the-number-of-good-partitions|3212.统计好分割方案的数目]]'
grade: ⭐⭐⭐⭐⭐
likes: 1991
dislikes: 196
favorites: []
...
**Nav:** << previous: [[2442.number-of-arithmetic-triplets]] | next: [[2444.longest-ideal-subsequence]] >>
