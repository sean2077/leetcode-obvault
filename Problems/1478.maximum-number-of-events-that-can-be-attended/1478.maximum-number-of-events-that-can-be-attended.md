...
aliases:
  ...
  - maximum-number-of-events-that-can-be-attended
  - 最多可以参加的会议数目
lcLink: https://leetcode.com/problems/maximum-number-of-events-that-can-be-attended/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[1477.product-of-the-last-k-numbers]] | next: [[1479.construct-target-array-with-multiple-sums]] >>
