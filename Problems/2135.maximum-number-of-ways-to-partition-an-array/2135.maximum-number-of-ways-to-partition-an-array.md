...
aliases:
  ...
  - maximum-number-of-ways-to-partition-an-array
  - 分割数组的最多方案数
lcLink: https://leetcode.com/problems/maximum-number-of-ways-to-partition-an-array/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[counting]]'
...
**Nav:** << previous: [[2134.maximize-the-confusion-of-an-exam]] | next: [[2136.find-cutoff-score-for-each-school]] >>
