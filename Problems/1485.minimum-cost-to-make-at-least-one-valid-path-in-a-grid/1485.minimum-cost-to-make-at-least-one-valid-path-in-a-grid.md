...
aliases:
  ...
  - minimum-cost-to-make-at-least-one-valid-path-in-a-grid
  - 使网格图至少有一条有效路径的最小代价
lcLink: https://leetcode.com/problems/minimum-cost-to-make-at-least-one-valid-path-in-a-grid/
lcTopics:
...
**Nav:** << previous: [[1484.linked-list-in-binary-tree]] | next: [[1486.find-the-distance-value-between-two-arrays]] >>
