...
aliases:
  ...
  - minimum-number-of-coins-for-fruits
  - 购买水果需要的最少金币数
lcLink: https://leetcode.com/problems/minimum-number-of-coins-for-fruits/
lcTopics:
  - '[[queue]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[3208.count-beautiful-substrings-ii]] | next: [[3210.count-beautiful-substrings-i]] >>
