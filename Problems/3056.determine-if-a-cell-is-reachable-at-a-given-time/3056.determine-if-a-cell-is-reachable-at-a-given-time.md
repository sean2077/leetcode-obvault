...
aliases:
  ...
  - determine-if-a-cell-is-reachable-at-a-given-time
  - 判断能否在给定时间到达单元格
lcLink: https://leetcode.com/problems/determine-if-a-cell-is-reachable-at-a-given-time/
lcTopics:
  - '[[math]]'
lcDifficulty: Medium
lcAcRate: 35.7%
...
**Nav:** << previous: [[3055.maximum-odd-binary-number]] | next: [[3057.count-k-subsequences-of-a-string-with-maximum-beauty]] >>
