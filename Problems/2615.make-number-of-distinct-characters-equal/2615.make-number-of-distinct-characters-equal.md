...
similarQuestions:
  ...
  - '[[889.buddy-strings|889.亲密字符串]]'
  - '[[1369.minimum-swaps-to-make-strings-equal|1369.交换字符使得字符串相同]]'
  - '[[1915.check-if-one-string-swap-can-make-strings-equal|1915.仅执行一次字符串交换能否使两个字符串相等]]'
...
**Nav:** << previous: [[2614.maximum-count-of-positive-integer-and-negative-integer]] | next: [[2616.maximal-score-after-applying-k-operations]] >>
