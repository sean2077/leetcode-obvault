...
aliases:
  ...
  - minimum-time-to-eat-all-grains
  - 吃掉所有谷子的最短时间
lcLink: https://leetcode.com/problems/minimum-time-to-eat-all-grains/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[2665.minimum-time-to-repair-cars]] | next: [[2667.maximum-frequency-score-of-a-subarray]] >>
