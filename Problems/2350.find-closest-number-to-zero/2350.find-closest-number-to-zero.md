...
aliases:
  ...
  - find-closest-number-to-zero
  - 找到最接近 0 的数字
lcLink: https://leetcode.com/problems/find-closest-number-to-zero/
lcTopics:
  - '[[array]]'
lcDifficulty: Easy
lcAcRate: 45.3%
...
**Nav:** << previous: [[2349.check-if-there-is-a-valid-parentheses-string-path]] | next: [[2351.number-of-ways-to-buy-pens-and-pencils]] >>
