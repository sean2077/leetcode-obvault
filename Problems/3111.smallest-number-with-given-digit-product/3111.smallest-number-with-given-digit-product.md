...
aliases:
  ...
  - smallest-number-with-given-digit-product
  - 给定数字乘积的最小数字
lcLink: https://leetcode.com/problems/smallest-number-with-given-digit-product/
lcTopics:
  - '[[greedy]]'
  - '[[math]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3107.maximum-spending-after-buying-items]] | next: [[3112.count-valid-paths-in-a-tree]] >>
