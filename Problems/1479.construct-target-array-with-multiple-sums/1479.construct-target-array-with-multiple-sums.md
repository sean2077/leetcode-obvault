...
aliases:
  ...
  - construct-target-array-with-multiple-sums
  - 多次求和构造目标数组
lcLink: https://leetcode.com/problems/construct-target-array-with-multiple-sums/
lcTopics:
  - '[[array]]'
  - '[[heap-priority-queue]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[1478.maximum-number-of-events-that-can-be-attended]] | next: [[1480.movie-rating]] >>
