...
aliases:
  ...
  - count-the-number-of-substrings-with-dominant-ones
  - 统计 1 显著的字符串的数量
lcLink: https://leetcode.com/problems/count-the-number-of-substrings-with-dominant-ones/
lcTopics:
  - '[[string]]'
  - '[[enumeration]]'
  - '[[sliding-window]]'
...
**Nav:** << previous: [[3478.check-if-the-rectangle-corner-is-reachable]] | next: [[3481.second-day-verification]] >>
