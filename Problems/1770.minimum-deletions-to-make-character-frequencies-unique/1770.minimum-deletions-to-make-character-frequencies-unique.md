...
lcAcRate: 61.2%
similarQuestions:
  - '[[1355.minimum-deletions-to-make-array-beautiful|1355.美化数组的最少删除数]]'
  - '[[2212.removing-minimum-and-maximum-from-array|2212.从数组中移除最大值和最小值]]'
  - '[[2532.remove-letter-to-equalize-frequency|2532.删除字符使频率相同]]'
  - '[[3360.minimum-deletions-to-make-string-k-special|3360.成为 K 特殊字符串需要删除的最少字符数]]'
grade: ⭐⭐⭐⭐⭐
likes: 4931
dislikes: 73
favorites: []
...
**Nav:** << previous: [[1769.get-maximum-in-generated-array]] | next: [[1771.sell-diminishing-valued-colored-balls]] >>
