...
aliases:
  ...
  - count-special-quadruplets
  - 统计特殊四元组
lcLink: https://leetcode.com/problems/count-special-quadruplets/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[enumeration]]'
...
**Nav:** << previous: [[2121.find-if-path-exists-in-graph]] | next: [[2123.the-number-of-weak-characters-in-the-game]] >>
