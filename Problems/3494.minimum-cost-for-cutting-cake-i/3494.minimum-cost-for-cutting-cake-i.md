...
aliases:
  ...
  - minimum-cost-for-cutting-cake-i
  - 切蛋糕的最小总开销 I
lcLink: https://leetcode.com/problems/minimum-cost-for-cutting-cake-i/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[3493.maximum-number-of-operations-to-move-ones-to-the-end]] | next: [[3498.minimum-array-changes-to-make-differences-equal]] >>
