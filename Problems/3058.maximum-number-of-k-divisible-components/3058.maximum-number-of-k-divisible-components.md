...
aliases:
  ...
  - maximum-number-of-k-divisible-components
  - 可以被 K 整除连通块的最大数目
lcLink: https://leetcode.com/problems/maximum-number-of-k-divisible-components/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[3057.count-k-subsequences-of-a-string-with-maximum-beauty]] | next: [[3062.create-a-dataframe-from-list]] >>
