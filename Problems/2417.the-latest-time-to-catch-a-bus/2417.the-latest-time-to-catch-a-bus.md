...
aliases:
  ...
  - the-latest-time-to-catch-a-bus
  - 坐上公交的最晚时间
lcLink: https://leetcode.com/problems/the-latest-time-to-catch-a-bus/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[binary-search]]'
...
similarQuestions:
  ...
  - '[[2617.time-taken-to-cross-the-door|2617.通过门的时间]]'
...
**Nav:** << previous: [[2416.evaluate-boolean-binary-tree]] | next: [[2418.minimum-sum-of-squared-difference]] >>
