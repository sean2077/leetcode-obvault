...
aliases:
  ...
  - destination-city
  - 旅行终点站
lcLink: https://leetcode.com/problems/destination-city/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[1546.find-the-quiet-students-in-all-exams]] | next: [[1548.check-if-all-1s-are-at-least-length-k-places-away]] >>
