...
aliases:
  ...
  - running-sum-of-1d-array
  - 一维数组的动态和
lcLink: https://leetcode.com/problems/running-sum-of-1d-array/
lcTopics:
  - '[[array]]'
  - '[[prefix-sum]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1587.parallel-courses-ii]] | next: [[1604.least-number-of-unique-integers-after-k-removals]] >>
