...
aliases:
  ...
  - maximum-xor-for-each-query
  - 每个查询的最大异或值
lcLink: https://leetcode.com/problems/maximum-xor-for-each-query/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[1939.queries-on-number-of-points-inside-a-circle]] | next: [[1941.minimum-number-of-operations-to-make-string-sorted]] >>
