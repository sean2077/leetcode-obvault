...
aliases:
  ...
  - check-if-there-is-a-valid-parentheses-string-path
  - 检查是否有合法括号字符串路径
lcLink: https://leetcode.com/problems/check-if-there-is-a-valid-parentheses-string-path/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
  - '[[matrix]]'
...
lcAcRate: 38.9%
similarQuestions:
  - '[[1507.check-if-there-is-a-valid-path-in-a-grid|1507.检查网格中是否存在有效路径]]'
...
**Nav:** << previous: [[2348.count-number-of-texts]] | next: [[2350.find-closest-number-to-zero]] >>
