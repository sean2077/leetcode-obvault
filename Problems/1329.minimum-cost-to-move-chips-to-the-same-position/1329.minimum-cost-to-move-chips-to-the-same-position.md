...
aliases:
  ...
  - minimum-cost-to-move-chips-to-the-same-position
  - 玩筹码
lcLink: https://leetcode.com/problems/minimum-cost-to-move-chips-to-the-same-position/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[math]]'
...
lcAcRate: 71.8%
similarQuestions:
  - '[[1895.minimum-number-of-operations-to-move-all-balls-to-each-box|1895.移动所有球到每个盒子所需的最小操作数]]'
...
**Nav:** << previous: [[1328.monthly-transactions-ii]] | next: [[1330.longest-arithmetic-subsequence-of-given-difference]] >>
