...
aliases:
  ...
  - longest-subarray-with-maximum-bitwise-and
  - 按位与最大的最长子数组
lcLink: https://leetcode.com/problems/longest-subarray-with-maximum-bitwise-and/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[brainteaser]]'
  - '[[array]]'
...
lcAcRate: 49.6%
similarQuestions:
  - '[[1933.number-of-different-integers-in-a-string|1933.字符串中不同整数的数目]]'
  - '[[2149.remove-colored-pieces-if-both-neighbors-are-the-same-color|2149.如果相邻两个颜色均相同则删除当前颜色]]'
...
**Nav:** << previous: [[2502.sort-the-people]] | next: [[2504.find-all-good-indices]] >>
