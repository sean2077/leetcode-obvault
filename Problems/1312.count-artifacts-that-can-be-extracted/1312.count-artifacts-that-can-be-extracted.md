...
aliases:
  ...
  - count-artifacts-that-can-be-extracted
  - 统计可以提取的工件
lcLink: https://leetcode.com/problems/count-artifacts-that-can-be-extracted/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[1311.largest-magic-square]] | next: [[1313.count-ways-to-build-rooms-in-an-ant-colony]] >>
