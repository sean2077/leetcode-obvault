...
aliases:
  ...
  - minimum-moves-to-make-array-complementary
  - 使数组互补的最少操作次数
lcLink: https://leetcode.com/problems/minimum-moves-to-make-array-complementary/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[1792.find-the-most-competitive-subsequence]] | next: [[1794.minimize-deviation-in-array]] >>
