...
aliases:
  ...
  - partition-array-such-that-maximum-difference-is-k
  - 划分数组使最大差为 K
lcLink: https://leetcode.com/problems/partition-array-such-that-maximum-difference-is-k/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
similarQuestions:
  ...
  - '[[2891.maximum-beauty-of-an-array-after-applying-operation|2891.数组的最大美丽值]]'
grade: ⭐⭐⭐⭐⭐
likes: 766
dislikes: 29
favorites: []
...
**Nav:** << previous: [[2386.min-max-game]] | next: [[2388.replace-elements-in-an-array]] >>
