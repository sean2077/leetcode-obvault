...
aliases:
  ...
  - distant-barcodes
  - 距离相等的条形码
lcLink: https://leetcode.com/problems/distant-barcodes/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[1139.previous-permutation-with-one-swap]] | next: [[1141.how-many-apples-can-you-put-into-the-basket]] >>
