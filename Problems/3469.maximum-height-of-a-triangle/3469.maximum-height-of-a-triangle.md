...
aliases:
  ...
  - maximum-height-of-a-triangle
  - 三角形的最大高度
lcLink: https://leetcode.com/problems/maximum-height-of-a-triangle/
lcTopics:
  - '[[array]]'
  - '[[enumeration]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3468.find-the-encrypted-string]] | next: [[3470.maximum-score-from-grid-operations]] >>
