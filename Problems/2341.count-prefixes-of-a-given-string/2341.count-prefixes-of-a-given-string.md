...
lcAcRate: 72.6%
similarQuestions:
  - '[[1566.check-if-a-word-occurs-as-a-prefix-of-any-word-in-a-sentence|1566.检查单词是否为句中其他单词的前缀]]'
  - '[[2093.check-if-string-is-a-prefix-of-array|2093.检查字符串是否为数组前缀]]'
  - '[[2292.counting-words-with-a-given-prefix|2292.统计包含给定前缀的字符串]]'
grade: ⭐⭐⭐⭐⭐
likes: 539
dislikes: 20
favorites: []
...
**Nav:** << previous: [[2340.total-appeal-of-a-string]] | next: [[2342.minimum-average-difference]] >>
