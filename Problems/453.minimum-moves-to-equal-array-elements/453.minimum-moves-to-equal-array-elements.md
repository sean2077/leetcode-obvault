...
aliases:
  ...
  - minimum-moves-to-equal-array-elements
  - 最小操作次数使数组元素相等
lcLink: https://leetcode.com/problems/minimum-moves-to-equal-array-elements/
lcTopics:
  - '[[array]]'
  - '[[math]]'
lcDifficulty: Medium
...
similarQuestions:
  ...
  - '[[2273.pour-water-between-buckets-to-make-water-levels-equal|2273.通过倒水操作让所有的水桶所含水量相等]]'
  - '[[2581.divide-players-into-teams-of-equal-skill|2581.划分技能点相等的团队]]'
  - '[[3476.find-minimum-operations-to-make-all-elements-divisible-by-three|3476.使所有元素都可以被
    3 整除的最少操作数]]'
grade: ⭐
likes: 2574
dislikes: 1893
