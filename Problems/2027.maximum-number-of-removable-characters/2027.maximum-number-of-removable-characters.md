...
aliases:
  ...
  - maximum-number-of-removable-characters
  - 可移除字符的最大数目
lcLink: https://leetcode.com/problems/maximum-number-of-removable-characters/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[string]]'
...
**Nav:** << previous: [[2026.merge-triplets-to-form-target-triplet]] | next: [[2028.the-earliest-and-latest-rounds-where-players-compete]] >>
