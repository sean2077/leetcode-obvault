...
aliases:
  ...
  - delete-duplicate-folders-in-system
  - 删除系统中的重复文件夹
lcLink: https://leetcode.com/problems/delete-duplicate-folders-in-system/
lcTopics:
  - '[[trie]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2078.maximum-compatibility-score-sum]] | next: [[2080.check-if-move-is-legal]] >>
