...
aliases:
  ...
  - move-sub-tree-of-n-ary-tree
  - 移动 N 叉树的子树
lcLink: https://leetcode.com/problems/move-sub-tree-of-n-ary-tree/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
lcDifficulty: Hard
lcAcRate: 62.1%
similarQuestions:
  - '[[1650.find-root-of-n-ary-tree|1650.找到 N 叉树的根节点]]'
grade: ⭐
likes: 33
dislikes: 62
favorites: []
...
**Nav:** << previous: [[1654.customer-order-frequency]] | next: [[1656.count-good-triplets]] >>
