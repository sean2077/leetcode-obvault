...
aliases:
  ...
  - matrix-diagonal-sum
  - 矩阵对角线元素的和
lcLink: https://leetcode.com/problems/matrix-diagonal-sum/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
lcDifficulty: Easy
...
similarQuestions:
  ...
  - '[[2398.check-if-matrix-is-x-matrix|2398.判断矩阵是否是一个 X 矩阵]]'
grade: ⭐⭐⭐⭐⭐
likes: 3481
dislikes: 55
favorites: []
...
**Nav:** << previous: [[1676.minimum-number-of-days-to-eat-n-oranges]] | next: [[1678.number-of-ways-to-split-a-string]] >>
