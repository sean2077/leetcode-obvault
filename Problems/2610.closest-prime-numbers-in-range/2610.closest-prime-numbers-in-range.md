...
aliases:
  ...
  - closest-prime-numbers-in-range
  - 范围内最接近的两个质数
lcLink: https://leetcode.com/problems/closest-prime-numbers-in-range/
lcTopics:
  - '[[math]]'
  - '[[number-theory]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2609.distinct-prime-factors-of-product-of-array]] | next: [[2612.minimum-cost-to-buy-apples]] >>
