...
aliases:
  ...
  - number-of-visible-people-in-a-queue
  - 队列中可以看到的人数
lcLink: https://leetcode.com/problems/number-of-visible-people-in-a-queue/
lcTopics:
  - '[[stack]]'
  - '[[array]]'
  - '[[monotonic-stack]]'
...
similarQuestions:
  ...
  - '[[2227.sum-of-subarray-ranges|2227.子数组范围和]]'
  - '[[2368.sum-of-total-strength-of-wizards|2368.巫师的总力量和]]'
  - '[[2425.number-of-people-that-can-be-seen-in-a-grid|2425.在一个网格中可以看到的人数]]'
...
**Nav:** << previous: [[1304.longest-happy-string]] | next: [[1306.minimum-absolute-difference]] >>
