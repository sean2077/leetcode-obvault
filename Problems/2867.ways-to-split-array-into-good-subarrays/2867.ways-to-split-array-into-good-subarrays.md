...
aliases:
  ...
  - ways-to-split-array-into-good-subarrays
  - 将数组划分成若干好子数组的方式
lcLink: https://leetcode.com/problems/ways-to-split-array-into-good-subarrays/
lcTopics:
  - '[[array]]'
  - '[[math]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2866.longest-even-odd-subarray-with-threshold]] | next: [[2868.continuous-subarrays]] >>
