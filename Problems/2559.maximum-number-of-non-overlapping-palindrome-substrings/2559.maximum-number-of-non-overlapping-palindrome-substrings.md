...
aliases:
  ...
  - maximum-number-of-non-overlapping-palindrome-substrings
  - 不重叠回文子字符串的最大数目
lcLink: https://leetcode.com/problems/maximum-number-of-non-overlapping-palindrome-substrings/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[1403.palindrome-partitioning-iii|1403.分割回文串 III]]'
  - '[[1644.maximum-number-of-non-overlapping-substrings|1644.最多的不重叠子字符串]]'
...
**Nav:** << previous: [[2558.minimum-number-of-operations-to-sort-a-binary-tree-by-level]] | next: [[2560.closest-fair-integer]] >>
