...
aliases:
  ...
  - maximum-number-of-occurrences-of-a-substring
  - 子串的最大出现次数
lcLink: https://leetcode.com/problems/maximum-number-of-occurrences-of-a-substring/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[sliding-window]]'
...
**Nav:** << previous: [[1422.divide-array-in-sets-of-k-consecutive-numbers]] | next: [[1424.maximum-candies-you-can-get-from-boxes]] >>
