...
aliases:
  ...
  - number-of-unique-flavors-after-sharing-k-candies
  - 分享 K 个糖果后独特口味的数量
lcLink: https://leetcode.com/problems/number-of-unique-flavors-after-sharing-k-candies/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sliding-window]]'
...
**Nav:** << previous: [[2246.maximum-employees-to-be-invited-to-a-meeting]] | next: [[2248.minimum-cost-of-buying-candies-with-discount]] >>
