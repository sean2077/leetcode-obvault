...
aliases:
  ...
  - check-permutation-lcci
  - 判定是否互为字符重排
lcLink: https://leetcode.com/problems/check-permutation-lcci/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[面试题 01.01.is-unique-lcci]] | next: [[面试题 01.03.string-to-url-lcci]] >>
...
[submissions](https://leetcode.com/problems/check-permutation-lcci/submissions/) | [solutions](https://leetcode.com/problems/check-permutation-lcci/solutions/)
