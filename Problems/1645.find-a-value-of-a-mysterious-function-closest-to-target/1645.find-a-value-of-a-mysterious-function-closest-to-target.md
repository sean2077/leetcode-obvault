...
aliases:
  ...
  - find-a-value-of-a-mysterious-function-closest-to-target
  - 找到最接近目标值的函数值
lcLink: https://leetcode.com/problems/find-a-value-of-a-mysterious-function-closest-to-target/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[segment-tree]]'
  - '[[array]]'
...
**Nav:** << previous: [[1644.maximum-number-of-non-overlapping-substrings]] | next: [[1646.kth-missing-positive-number]] >>
