...
aliases:
  ...
  - maximum-length-of-a-concatenated-string-with-unique-characters
  - 串联字符串的最大长度
lcLink: https://leetcode.com/problems/maximum-length-of-a-concatenated-string-with-unique-characters/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[string]]'
...
**Nav:** << previous: [[1359.circular-permutation-in-binary-representation]] | next: [[1361.tiling-a-rectangle-with-the-fewest-squares]] >>
