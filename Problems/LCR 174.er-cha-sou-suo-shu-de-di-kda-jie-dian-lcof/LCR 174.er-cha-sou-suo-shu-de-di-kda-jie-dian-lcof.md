...
aliases:
  ...
  - 寻找二叉搜索树中的目标节点
lcLink: https://leetcode.com/problems/er-cha-sou-suo-shu-de-di-kda-jie-dian-lcof/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[binary-search-tree]]'
...
**Nav:** << previous: [[LCR 173.que-shi-de-shu-zi-lcof]] | next: [[LCR 175.er-cha-shu-de-shen-du-lcof]] >>
