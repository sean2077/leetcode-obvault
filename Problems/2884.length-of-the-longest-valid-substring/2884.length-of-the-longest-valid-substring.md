...
aliases:
  ...
  - length-of-the-longest-valid-substring
  - 最长合法子字符串的长度
lcLink: https://leetcode.com/problems/length-of-the-longest-valid-substring/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[2883.partition-string-into-minimum-beautiful-substrings]] | next: [[2885.count-occurrences-in-text]] >>
