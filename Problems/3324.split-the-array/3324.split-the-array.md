...
aliases:
  ...
  - split-the-array
  - 分割数组
lcLink: https://leetcode.com/problems/split-the-array/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[counting]]'
...
**Nav:** << previous: [[3323.maximum-number-of-removal-queries-that-can-be-processed-i]] | next: [[3325.find-the-largest-area-of-square-inside-two-rectangles]] >>
