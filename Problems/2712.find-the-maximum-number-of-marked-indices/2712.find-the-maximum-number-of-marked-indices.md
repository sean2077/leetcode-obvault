...
aliases:
  ...
  - find-the-maximum-number-of-marked-indices
  - 求出最多标记下标
lcLink: https://leetcode.com/problems/find-the-maximum-number-of-marked-indices/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[two-pointers]]'
...
lcAcRate: 38.7%
similarQuestions:
  - '[[3081.minimum-array-length-after-pair-removals|3081.删除数对后的最小数组长度]]'
grade: ⭐⭐⭐⭐⭐
likes: 555
dislikes: 27
favorites: []
...
**Nav:** << previous: [[2711.minimum-time-to-visit-a-cell-in-a-grid]] | next: [[2713.find-the-divisibility-array-of-a-string]] >>
