...
aliases:
  ...
  - minimum-insertions-to-balance-a-parentheses-string
  - 平衡括号字符串的最少插入次数
lcLink: https://leetcode.com/problems/minimum-insertions-to-balance-a-parentheses-string/
lcTopics:
  - '[[stack]]'
  - '[[greedy]]'
  - '[[string]]'
...
**Nav:** << previous: [[1647.can-convert-string-in-k-moves]] | next: [[1649.maximum-number-of-non-overlapping-subarrays-with-sum-equals-target]] >>
