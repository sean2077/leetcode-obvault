...
aliases:
  ...
  - determine-if-string-halves-are-alike
  - 判断字符串的两半是否相似
lcLink: https://leetcode.com/problems/determine-if-string-halves-are-alike/
lcTopics:
  - '[[string]]'
  - '[[counting]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1822.longest-palindromic-subsequence-ii]] | next: [[1824.maximum-number-of-eaten-apples]] >>
