...
aliases:
  ...
  - shift-2d-grid
  - 二维网格迁移
lcLink: https://leetcode.com/problems/shift-2d-grid/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[1385.number-of-ways-to-build-house-of-cards]] | next: [[1387.find-elements-in-a-contaminated-binary-tree]] >>
