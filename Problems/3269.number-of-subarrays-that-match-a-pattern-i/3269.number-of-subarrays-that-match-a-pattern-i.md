...
aliases:
  ...
  - number-of-subarrays-that-match-a-pattern-i
  - 匹配模式数组的子数组数目 I
lcLink: https://leetcode.com/problems/number-of-subarrays-that-match-a-pattern-i/
lcTopics:
  - '[[array]]'
  - '[[string-matching]]'
  - '[[hash-function]]'
...
**Nav:** << previous: [[3268.minimum-number-of-coins-for-fruits-ii]] | next: [[3270.minimum-moves-to-capture-the-queen]] >>
