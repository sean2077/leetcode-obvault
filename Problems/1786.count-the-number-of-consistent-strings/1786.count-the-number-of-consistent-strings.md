...
aliases:
  ...
  - count-the-number-of-consistent-strings
  - 统计一致字符串的数目
lcLink: https://leetcode.com/problems/count-the-number-of-consistent-strings/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[1785.hopper-company-queries-ii]] | next: [[1787.sum-of-absolute-differences-in-a-sorted-array]] >>
