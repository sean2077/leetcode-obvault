...
aliases:
  ...
  - next-greater-numerically-balanced-number
  - 下一个更大的数值平衡数
lcLink: https://leetcode.com/problems/next-greater-numerically-balanced-number/
lcTopics:
  - '[[math]]'
  - '[[backtracking]]'
  - '[[enumeration]]'
...
lcAcRate: 48.6%
similarQuestions:
  - '[[2675.find-the-width-of-columns-of-a-grid|2675.查询网格图中每一列的宽度]]'
grade: ⭐
likes: 197
dislikes: 279
favorites: []
...
**Nav:** << previous: [[2173.number-of-valid-words-in-a-sentence]] | next: [[2175.count-nodes-with-the-highest-score]] >>
