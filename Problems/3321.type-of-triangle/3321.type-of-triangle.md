...
aliases:
  ...
  - type-of-triangle
  - 三角形类型
lcLink: https://leetcode.com/problems/type-of-triangle/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[3320.maximum-number-of-operations-with-the-same-score-i]] | next: [[3323.maximum-number-of-removal-queries-that-can-be-processed-i]] >>
