...
aliases:
  ...
  - count-pairs-with-xor-in-a-range
  - 统计异或值在范围内的数对有多少
lcLink: https://leetcode.com/problems/count-pairs-with-xor-in-a-range/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[trie]]'
  - '[[array]]'
...
**Nav:** << previous: [[1906.maximize-score-after-n-operations]] | next: [[1908.recyclable-and-low-fat-products]] >>
