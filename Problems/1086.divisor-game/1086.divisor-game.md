...
aliases:
  ...
  - divisor-game
  - 除数博弈
lcLink: https://leetcode.com/problems/divisor-game/
lcTopics:
  - '[[brainteaser]]'
  - '[[math]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1085.the-earliest-moment-when-everyone-become-friends]] | next: [[1087.longest-arithmetic-subsequence]] >>
