...
aliases:
  ...
  - count-sorted-vowel-strings
  - 统计字典序元音字符串的数目
lcLink: https://leetcode.com/problems/count-sorted-vowel-strings/
lcTopics:
  - '[[math]]'
  - '[[dynamic-programming]]'
  - '[[combinatorics]]'
...
**Nav:** << previous: [[1760.check-array-formation-through-concatenation]] | next: [[1762.furthest-building-you-can-reach]] >>
