...
similarQuestions:
  ...
  - '[[3239.minimum-number-of-operations-to-make-x-and-y-equal|3239.使 X 和 Y 相等的最少操作次数]]'
grade: ⭐⭐⭐⭐
likes: 499
dislikes: 69
favorites: []
...
**Nav:** << previous: [[3091.count-of-sub-multisets-with-bounded-sum]] | next: [[3093.sum-of-values-at-indices-with-k-set-bits]] >>
