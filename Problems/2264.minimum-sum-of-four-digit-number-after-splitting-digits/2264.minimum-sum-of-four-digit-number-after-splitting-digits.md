...
aliases:
  ...
  - minimum-sum-of-four-digit-number-after-splitting-digits
  - 拆分数位后四位数字的最小和
lcLink: https://leetcode.com/problems/minimum-sum-of-four-digit-number-after-splitting-digits/
lcTopics:
  - '[[greedy]]'
  - '[[math]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[2263.maximum-running-time-of-n-computers]] | next: [[2265.partition-array-according-to-given-pivot]] >>
