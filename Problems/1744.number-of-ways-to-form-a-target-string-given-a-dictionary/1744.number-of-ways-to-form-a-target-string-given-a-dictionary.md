...
aliases:
  ...
  - number-of-ways-to-form-a-target-string-given-a-dictionary
  - 通过给定词典构造目标字符串的方案数
lcLink: https://leetcode.com/problems/number-of-ways-to-form-a-target-string-given-a-dictionary/
lcTopics:
  - '[[array]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1743.count-substrings-that-differ-by-one-character]] | next: [[1745.find-nearest-right-node-in-binary-tree]] >>
