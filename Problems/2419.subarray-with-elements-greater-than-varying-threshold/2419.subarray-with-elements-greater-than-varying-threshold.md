...
aliases:
  ...
  - subarray-with-elements-greater-than-varying-threshold
  - 元素值大于变化阈值的子数组
lcLink: https://leetcode.com/problems/subarray-with-elements-greater-than-varying-threshold/
lcTopics:
  - '[[stack]]'
  - '[[union-find]]'
  - '[[array]]'
...
lcAcRate: 43.0%
similarQuestions:
  - '[[1985.maximum-subarray-min-product|1985.子数组最小乘积的最大值]]'
  - '[[2157.smallest-k-length-subsequence-with-occurrences-of-a-letter|2157.含特定字母的最小子序列]]'
...
**Nav:** << previous: [[2418.minimum-sum-of-squared-difference]] | next: [[2420.closest-node-to-path-in-tree]] >>
