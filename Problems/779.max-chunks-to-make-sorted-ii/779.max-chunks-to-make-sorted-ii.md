...
aliases:
  ...
  - max-chunks-to-make-sorted-ii
  - 最多能完成排序的块 II
lcLink: https://leetcode.com/problems/max-chunks-to-make-sorted-ii/
lcTopics:
  - '[[stack]]'
  - '[[greedy]]'
  - '[[array]]'
...
lcAcRate: 53.4%
similarQuestions:
  - '[[780.max-chunks-to-make-sorted|780.最多能完成排序的块]]'
grade: ⭐⭐⭐⭐⭐
likes: 1834
dislikes: 55
favorites: []
...
**Nav:** << previous: [[778.reorganize-string]] | next: [[780.max-chunks-to-make-sorted]] >>
