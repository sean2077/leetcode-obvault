...
aliases:
  ...
  - maximize-greatness-of-an-array
  - 最大化数组的伟大值
lcLink: https://leetcode.com/problems/maximize-greatness-of-an-array/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[two-pointers]]'
...
**Nav:** << previous: [[2663.distribute-money-to-maximum-children]] | next: [[2665.minimum-time-to-repair-cars]] >>
