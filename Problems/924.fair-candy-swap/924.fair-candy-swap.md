...
aliases:
  ...
  - fair-candy-swap
  - 公平的糖果交换
lcLink: https://leetcode.com/problems/fair-candy-swap/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[923.super-egg-drop]] | next: [[925.construct-binary-tree-from-preorder-and-postorder-traversal]] >>
