...
aliases:
  ...
  - maximum-number-of-words-you-can-type
  - 可以输入的最大单词数
lcLink: https://leetcode.com/problems/maximum-number-of-words-you-can-type/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1263.number-of-dice-rolls-with-target-sum]] | next: [[1267.remove-zero-sum-consecutive-nodes-from-linked-list]] >>
