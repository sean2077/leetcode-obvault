...
aliases:
  ...
  - vowels-of-all-substrings
  - 所有子字符串中的元音
lcLink: https://leetcode.com/problems/vowels-of-all-substrings/
lcTopics:
  - '[[math]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[2186.count-vowel-substrings-of-a-string]] | next: [[2188.minimized-maximum-of-products-distributed-to-any-store]] >>
