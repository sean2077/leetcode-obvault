...
aliases:
  ...
  - ways-to-express-an-integer-as-sum-of-powers
  - 将一个数字表示成幂的和的方案数
lcLink: https://leetcode.com/problems/ways-to-express-an-integer-as-sum-of-powers/
lcTopics:
  - '[[dynamic-programming]]'
lcDifficulty: Medium
lcAcRate: 33.8%
...
**Nav:** << previous: [[2881.split-strings-by-separator]] | next: [[2883.partition-string-into-minimum-beautiful-substrings]] >>
