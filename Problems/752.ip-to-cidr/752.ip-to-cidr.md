...
aliases:
  ...
  - ip-to-cidr
  - IP 到 CIDR
lcLink: https://leetcode.com/problems/ip-to-cidr/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[751.number-of-corner-rectangles]] | next: [[753.open-the-lock]] >>
...
[submissions](https://leetcode.com/problems/ip-to-cidr/submissions/) | [solutions](https://leetcode.com/problems/ip-to-cidr/solutions/)
...
[提交记录](https://leetcode.cn/problems/ip-to-cidr/submissions/) | [题解](https://leetcode.cn/problems/ip-to-cidr/solution/)
