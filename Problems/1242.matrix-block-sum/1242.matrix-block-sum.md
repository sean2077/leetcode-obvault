...
aliases:
  ...
  - matrix-block-sum
  - 矩阵区域和
lcLink: https://leetcode.com/problems/matrix-block-sum/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[prefix-sum]]'
...
similarQuestions:
  ...
  - '[[2508.maximum-sum-of-an-hourglass|2508.沙漏的最大总和]]'
...
**Nav:** << previous: [[1241.decompress-run-length-encoded-list]] | next: [[1243.sum-of-nodes-with-even-valued-grandparent]] >>
