...
aliases:
  ...
  - sum-of-values-at-indices-with-k-set-bits
  - 计算 K 置位下标对应元素的和
lcLink: https://leetcode.com/problems/sum-of-values-at-indices-with-k-set-bits/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
lcDifficulty: Easy
...
similarQuestions:
  ...
  - '[[3183.find-the-k-or-of-an-array|3183.找出数组中的 K-or 值]]'
grade: ⭐⭐⭐⭐
likes: 261
dislikes: 41
favorites: []
...
**Nav:** << previous: [[3092.minimum-moves-to-spread-stones-over-grid]] | next: [[3094.minimum-number-of-operations-to-make-array-empty]] >>
