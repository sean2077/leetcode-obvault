...
aliases:
  ...
  - largest-merge-of-two-strings
  - 构造字典序最大的合并字符串
lcLink: https://leetcode.com/problems/largest-merge-of-two-strings/
lcTopics:
  - '[[greedy]]'
  - '[[two-pointers]]'
  - '[[string]]'
...
similarQuestions:
  ...
  - '[[2854.decremental-string-concatenation|2854.字符串连接删减字母]]'
grade: ⭐⭐⭐⭐
likes: 545
dislikes: 77
favorites: []
...
**Nav:** << previous: [[1879.maximum-score-from-removing-stones]] | next: [[1881.closest-subsequence-sum]] >>
