...
aliases:
  ...
  - difference-between-maximum-and-minimum-price-sum
  - 最大价值和与最小价值和的差值
lcLink: https://leetcode.com/problems/difference-between-maximum-and-minimum-price-sum/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[array]]'
...
**Nav:** << previous: [[2626.count-the-number-of-good-subarrays]] | next: [[2628.minimize-the-maximum-of-two-arrays]] >>
