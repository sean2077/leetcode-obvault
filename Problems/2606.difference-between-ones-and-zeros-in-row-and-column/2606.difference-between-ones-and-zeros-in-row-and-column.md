...
aliases:
  ...
  - difference-between-ones-and-zeros-in-row-and-column
  - 行和列中一和零的差值
lcLink: https://leetcode.com/problems/difference-between-ones-and-zeros-in-row-and-column/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[simulation]]'
...
similarQuestions:
  ...
  - '[[1704.special-positions-in-a-binary-matrix|1704.二进制矩阵中的特殊位置]]'
...
**Nav:** << previous: [[2605.count-anagrams]] | next: [[2607.minimum-subarrays-in-a-valid-split]] >>
