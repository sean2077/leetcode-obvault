...
aliases:
  ...
  - minimum-absolute-difference-queries
  - 查询差绝对值的最小值
lcLink: https://leetcode.com/problems/minimum-absolute-difference-queries/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2033.the-number-of-full-rounds-you-have-played]] | next: [[2035.count-sub-islands]] >>
