...
aliases:
  ...
  - count-pairs-that-form-a-complete-day-i
  - 构成整天的下标对数目 I
lcLink: https://leetcode.com/problems/count-pairs-that-form-a-complete-day-i/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[counting]]'
...
**Nav:** << previous: [[3420.find-occurrences-of-an-element-in-an-array]] | next: [[3422.find-the-n-th-value-after-k-seconds]] >>
