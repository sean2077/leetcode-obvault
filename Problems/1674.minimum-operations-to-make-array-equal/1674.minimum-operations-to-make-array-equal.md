...
aliases:
  ...
  - minimum-operations-to-make-array-equal
  - 使数组中所有元素相等的最小操作数
lcLink: https://leetcode.com/problems/minimum-operations-to-make-array-equal/
lcTopics:
  - '[[math]]'
lcDifficulty: Medium
lcAcRate: 82.4%
...
**Nav:** << previous: [[1672.find-the-index-of-the-large-integer]] | next: [[1675.magnetic-force-between-two-balls]] >>
