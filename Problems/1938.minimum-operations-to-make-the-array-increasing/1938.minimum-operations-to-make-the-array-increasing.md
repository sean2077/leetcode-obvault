...
lcAcRate: 80.0%
similarQuestions:
  - '[[1419.make-array-non-decreasing-or-non-increasing|1419.数组变为有序的最小操作次数]]'
  - '[[2329.maximum-product-after-k-increments|2329.K 次增加后的最大乘积]]'
  - '[[2450.minimum-replacements-to-sort-the-array|2450.将数组排序的最少替换次数]]'
grade: ⭐⭐⭐⭐⭐
likes: 1231
dislikes: 63
favorites: []
...
**Nav:** << previous: [[1937.maximize-the-beauty-of-the-garden]] | next: [[1939.queries-on-number-of-points-inside-a-circle]] >>
