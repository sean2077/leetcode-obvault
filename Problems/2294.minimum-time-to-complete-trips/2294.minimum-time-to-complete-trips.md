...
aliases:
  ...
  - minimum-time-to-complete-trips
  - 完成旅途的最少时间
lcLink: https://leetcode.com/problems/minimum-time-to-complete-trips/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
lcDifficulty: Medium
...
similarQuestions:
  ...
  - '[[2263.maximum-running-time-of-n-computers|2263.同时运行 N 台电脑的最长时间]]'
...
**Nav:** << previous: [[2293.minimum-number-of-steps-to-make-two-strings-anagram-ii]] | next: [[2295.minimum-time-to-finish-the-race]] >>
