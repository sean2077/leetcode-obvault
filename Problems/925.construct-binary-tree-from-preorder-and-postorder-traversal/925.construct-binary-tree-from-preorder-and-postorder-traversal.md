...
aliases:
  ...
  - construct-binary-tree-from-preorder-and-postorder-traversal
  - 根据前序和后序遍历构造二叉树
lcLink: https://leetcode.com/problems/construct-binary-tree-from-preorder-and-postorder-traversal/
lcTopics:
  - '[[tree]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[924.fair-candy-swap]] | next: [[926.find-and-replace-pattern]] >>
