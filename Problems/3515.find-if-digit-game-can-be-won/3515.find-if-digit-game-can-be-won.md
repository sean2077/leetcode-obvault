...
aliases:
  ...
  - find-if-digit-game-can-be-won
  - 判断是否可以赢得数字游戏
lcLink: https://leetcode.com/problems/find-if-digit-game-can-be-won/
lcTopics:
  - '[[array]]'
  - '[[math]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3514.shortest-distance-after-road-addition-queries-ii]] | next: [[3516.design-neighbor-sum-service]] >>
