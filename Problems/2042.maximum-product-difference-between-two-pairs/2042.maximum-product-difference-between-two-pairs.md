...
aliases:
  ...
  - maximum-product-difference-between-two-pairs
  - 两个数对之间的最大乘积差
lcLink: https://leetcode.com/problems/maximum-product-difference-between-two-pairs/
lcTopics:
  - '[[array]]'
  - '[[sorting]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[2041.the-latest-login-in-2020]] | next: [[2043.cyclically-rotating-a-grid]] >>
