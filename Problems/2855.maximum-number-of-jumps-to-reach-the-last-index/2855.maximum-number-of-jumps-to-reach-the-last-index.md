...
aliases:
  ...
  - maximum-number-of-jumps-to-reach-the-last-index
  - 达到末尾下标所需的最大跳跃次数
lcLink: https://leetcode.com/problems/maximum-number-of-jumps-to-reach-the-last-index/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
similarQuestions:
  ...
  - '[[1757.minimum-jumps-to-reach-home|1757.到家的最少跳跃次数]]'
...
**Nav:** << previous: [[2854.decremental-string-concatenation]] | next: [[2856.count-complete-subarrays-in-an-array]] >>
