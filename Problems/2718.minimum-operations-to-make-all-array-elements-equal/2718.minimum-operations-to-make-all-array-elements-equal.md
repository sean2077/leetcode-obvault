...
aliases:
  ...
  - minimum-operations-to-make-all-array-elements-equal
  - 使数组元素全部相等的最少操作次数
lcLink: https://leetcode.com/problems/minimum-operations-to-make-all-array-elements-equal/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[prefix-sum]]'
...
similarQuestions:
  ...
  - '[[2721.sum-of-distances|2721.等值距离和]]'
grade: ⭐⭐⭐⭐⭐
likes: 705
dislikes: 22
favorites: []
...
**Nav:** << previous: [[2717.collect-coins-in-a-tree]] | next: [[2719.beautiful-pairs]] >>
