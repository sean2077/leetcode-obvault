...
aliases:
  ...
  - avoid-flood-in-the-city
  - 避免洪水泛滥
lcLink: https://leetcode.com/problems/avoid-flood-in-the-city/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[1611.making-file-names-unique]] | next: [[1613.find-critical-and-pseudo-critical-edges-in-minimum-spanning-tree]] >>
