...
aliases:
  ...
  - find-the-k-sum-of-an-array
  - 找出数组的第 K 大和
lcLink: https://leetcode.com/problems/find-the-k-sum-of-an-array/
lcTopics:
  - '[[array]]'
  - '[[sorting]]'
  - '[[heap-priority-queue]]'
...
**Nav:** << previous: [[2461.amount-of-time-for-binary-tree-to-be-infected]] | next: [[2463.minimum-recolors-to-get-k-consecutive-black-blocks]] >>
