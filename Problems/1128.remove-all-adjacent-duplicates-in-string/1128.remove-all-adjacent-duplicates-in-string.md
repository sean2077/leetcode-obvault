...
aliases:
  ...
  - remove-all-adjacent-duplicates-in-string
  - 删除字符串中的所有相邻重复项
lcLink: https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string/
lcTopics:
  - '[[stack]]'
  - '[[string]]'
lcDifficulty: Easy
...
similarQuestions:
  ...
  - '[[2470.removing-stars-from-a-string|2470.从字符串中移除星号]]'
...
**Nav:** << previous: [[1127.last-stone-weight]] | next: [[1129.longest-string-chain]] >>
