...
aliases:
  ...
  - maximize-the-profit-as-the-salesman
  - 销售利润最大化
lcLink: https://leetcode.com/problems/maximize-the-profit-as-the-salesman/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[2978.check-if-strings-can-be-made-equal-with-operations-ii]] | next: [[2995.number-of-unique-categories]] >>
