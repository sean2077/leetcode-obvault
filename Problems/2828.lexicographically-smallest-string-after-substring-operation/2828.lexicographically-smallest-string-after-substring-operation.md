...
similarQuestions:
  ...
  - '[[1747.lexicographically-smallest-string-after-applying-operations|1747.执行操作后字典序最小的字符串]]'
  - '[[3346.lexicographically-smallest-string-after-operations-with-constraint|3346.满足距离约束且字典序最小的字符串]]'
  - '[[3354.replace-question-marks-in-string-to-minimize-its-value|3354.替换字符串中的问号使分数最小]]'
grade: ⭐
likes: 239
dislikes: 184
favorites: []
...
**Nav:** << previous: [[2827.greatest-common-divisor-traversal]] | next: [[2829.find-latest-salaries]] >>
