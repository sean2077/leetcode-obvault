...
aliases:
  ...
  - find-and-replace-pattern
  - 查找和替换模式
lcLink: https://leetcode.com/problems/find-and-replace-pattern/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[925.construct-binary-tree-from-preorder-and-postorder-traversal]] | next: [[927.sum-of-subsequence-widths]] >>
