...
aliases:
  ...
  - separate-the-digits-in-an-array
  - 分割数组中数字的数位
lcLink: https://leetcode.com/problems/separate-the-digits-in-an-array/
lcTopics:
  - '[[array]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[2638.number-of-subarrays-having-even-product]] | next: [[2640.maximum-number-of-integers-to-choose-from-a-range-i]] >>
