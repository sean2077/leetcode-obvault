...
aliases:
  ...
  - minimum-number-of-operations-to-make-array-empty
  - 使数组为空的最少操作次数
lcLink: https://leetcode.com/problems/minimum-number-of-operations-to-make-array-empty/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[3093.sum-of-values-at-indices-with-k-set-bits]] | next: [[3095.maximum-number-of-alloys]] >>
