...
aliases:
  ...
  - taking-maximum-energy-from-the-mystic-dungeon
  - 从魔法师身上吸取的最大能量
lcLink: https://leetcode.com/problems/taking-maximum-energy-from-the-mystic-dungeon/
lcTopics:
  - '[[array]]'
  - '[[prefix-sum]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3382.find-the-number-of-subarrays-where-boundary-elements-are-maximum]] | next: [[3384.minimum-number-of-operations-to-make-word-k-periodic]] >>
