...
aliases:
  ...
  - w6cpku
  - 把二叉搜索树转换为累加树
lcLink: https://leetcode.com/problems/w6cpku/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[binary-search-tree]]'
...
**Nav:** << previous: [[LCR 053.P5rCT8]] | next: [[LCR 055.kTOapQ]] >>
...
[submissions](https://leetcode.com/problems/w6cpku/submissions/) | [solutions](https://leetcode.com/problems/w6cpku/solutions/)
