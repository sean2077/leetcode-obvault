...
aliases:
  ...
  - the-employee-that-worked-on-the-longest-task
  - 处理用时最长的那个任务的员工
lcLink: https://leetcode.com/problems/the-employee-that-worked-on-the-longest-task/
lcTopics:
  - '[[array]]'
lcDifficulty: Easy
lcAcRate: 50.2%
...
**Nav:** << previous: [[2517.choose-edges-to-maximize-score-in-a-tree]] | next: [[2519.find-the-original-array-of-prefix-xor]] >>
