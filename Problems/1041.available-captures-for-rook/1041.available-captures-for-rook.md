...
aliases:
  ...
  - available-captures-for-rook
  - 可以被一步捕获的棋子数
lcLink: https://leetcode.com/problems/available-captures-for-rook/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[simulation]]'
...
similarQuestions:
  ...
  - '[[3270.minimum-moves-to-capture-the-queen|3270.捕获黑皇后需要的最少移动次数]]'
grade: ⭐
likes: 707
dislikes: 636
favorites: []
...
**Nav:** << previous: [[1040.maximum-binary-tree-ii]] | next: [[1042.minimum-cost-to-merge-stones]] >>
