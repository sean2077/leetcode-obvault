...
aliases:
  ...
  - minimum-time-to-repair-cars
  - 修车的最少时间
lcLink: https://leetcode.com/problems/minimum-time-to-repair-cars/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2664.maximize-greatness-of-an-array]] | next: [[2666.minimum-time-to-eat-all-grains]] >>
