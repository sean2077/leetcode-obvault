...
aliases:
  ...
  - make-array-non-decreasing-or-non-increasing
  - 数组变为有序的最小操作次数
lcLink: https://leetcode.com/problems/make-array-non-decreasing-or-non-increasing/
lcTopics:
  - '[[greedy]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[1290.make-array-strictly-increasing|1290.使数组严格递增]]'
...
**Nav:** << previous: [[1418.fair-distribution-of-cookies]] | next: [[1420.find-the-start-and-end-number-of-continuous-ranges]] >>
