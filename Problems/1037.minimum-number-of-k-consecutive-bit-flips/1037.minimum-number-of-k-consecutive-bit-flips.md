...
aliases:
  ...
  - minimum-number-of-k-consecutive-bit-flips
  - K 连续位的最小翻转次数
lcLink: https://leetcode.com/problems/minimum-number-of-k-consecutive-bit-flips/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[queue]]'
  - '[[array]]'
...
similarQuestions:
  ...
  - '[[2286.minimum-time-to-remove-all-cars-containing-illegal-goods|2286.移除所有载有违禁货物车厢所需的最少时间]]'
  - '[[2593.number-of-distinct-binary-strings-after-applying-operations|2593.应用操作后不同二进制字符串的数量]]'
  - '[[3475.minimum-operations-to-make-binary-array-elements-equal-to-one-i|3475.使二进制数组全部等于
    1 的最少操作次数 I]]'
grade: ⭐⭐⭐⭐⭐
likes: 1868
dislikes: 88
...
**Nav:** << previous: [[1036.rotting-oranges]] | next: [[1038.number-of-squareful-arrays]] >>
