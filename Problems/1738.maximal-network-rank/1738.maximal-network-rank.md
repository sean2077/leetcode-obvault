...
aliases:
  ...
  - maximal-network-rank
  - 最大网络秩
lcLink: https://leetcode.com/problems/maximal-network-rank/
lcTopics:
  - '[[graph]]'
lcDifficulty: Medium
lcAcRate: 65.1%
...
**Nav:** << previous: [[1737.maximum-nesting-depth-of-the-parentheses]] | next: [[1739.split-two-strings-to-make-palindrome]] >>
