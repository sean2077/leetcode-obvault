...
aliases:
  ...
  - remove-sub-folders-from-the-filesystem
  - 删除子文件夹
lcLink: https://leetcode.com/problems/remove-sub-folders-from-the-filesystem/
lcTopics:
  - '[[depth-first-search]]'
  - '[[trie]]'
  - '[[array]]'
...
**Nav:** << previous: [[1349.check-if-it-is-a-straight-line]] | next: [[1351.replace-the-substring-for-balanced-string]] >>
