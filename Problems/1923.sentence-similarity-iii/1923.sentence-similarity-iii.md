...
aliases:
  ...
  - sentence-similarity-iii
  - 句子相似性 III
lcLink: https://leetcode.com/problems/sentence-similarity-iii/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[string]]'
...
**Nav:** << previous: [[1920.determine-color-of-a-chessboard-square]] | next: [[1924.maximum-number-of-groups-getting-fresh-donuts]] >>
