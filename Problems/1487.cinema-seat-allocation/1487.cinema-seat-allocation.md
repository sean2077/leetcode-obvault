...
aliases:
  ...
  - cinema-seat-allocation
  - 安排电影院座位
lcLink: https://leetcode.com/problems/cinema-seat-allocation/
lcTopics:
  - '[[greedy]]'
  - '[[bit-manipulation]]'
  - '[[array]]'
...
**Nav:** << previous: [[1486.find-the-distance-value-between-two-arrays]] | next: [[1488.sort-integers-by-the-power-value]] >>
