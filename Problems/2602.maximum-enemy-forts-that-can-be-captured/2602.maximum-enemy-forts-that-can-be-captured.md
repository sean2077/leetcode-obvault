...
aliases:
  ...
  - maximum-enemy-forts-that-can-be-captured
  - 最多可以摧毁的敌人城堡数目
lcLink: https://leetcode.com/problems/maximum-enemy-forts-that-can-be-captured/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[2601.number-of-great-partitions]] | next: [[2603.reward-top-k-students]] >>
