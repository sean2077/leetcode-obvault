...
aliases:
  ...
  - count-collisions-of-monkeys-on-a-polygon
  - 猴子碰撞的方法数
lcLink: https://leetcode.com/problems/count-collisions-of-monkeys-on-a-polygon/
lcTopics:
  - '[[recursion]]'
  - '[[math]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2679.count-distinct-numbers-on-board]] | next: [[2681.put-marbles-in-bags]] >>
