...
aliases:
  ...
  - solving-questions-with-brainpower
  - 解决智力问题
lcLink: https://leetcode.com/problems/solving-questions-with-brainpower/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2261.all-divisions-with-the-highest-score-of-a-binary-array]] | next: [[2263.maximum-running-time-of-n-computers]] >>
