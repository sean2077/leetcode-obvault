...
aliases:
  ...
  - maximum-difference-score-in-a-grid
  - 矩阵中的最大得分
lcLink: https://leetcode.com/problems/maximum-difference-score-in-a-grid/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
  - '[[matrix]]'
...
lcAcRate: 47.8%
similarQuestions:
  - '[[3470.maximum-score-from-grid-operations|3470.网格图操作后的最大分数]]'
grade: ⭐⭐⭐⭐⭐
likes: 218
dislikes: 19
favorites: []
...
**Nav:** << previous: [[3390.minimum-rectangles-to-cover-points]] | next: [[3392.find-trending-hashtags]] >>
