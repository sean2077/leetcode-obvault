...
aliases:
  ...
  - maximum-number-of-groups-getting-fresh-donuts
  - 得到新鲜甜甜圈的最多组数
lcLink: https://leetcode.com/problems/maximum-number-of-groups-getting-fresh-donuts/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[memoization]]'
  - '[[array]]'
...
**Nav:** << previous: [[1923.sentence-similarity-iii]] | next: [[1925.count-nice-pairs-in-an-array]] >>
