...
aliases:
  ...
  - find-the-first-player-to-win-k-games-in-a-row
  - 找到连续赢 K 场比赛的第一位玩家
lcLink: https://leetcode.com/problems/find-the-first-player-to-win-k-games-in-a-row/
lcTopics:
  - '[[array]]'
  - '[[simulation]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3412.permutation-difference-between-two-strings]] | next: [[3414.find-number-of-ways-to-reach-the-k-th-stair]] >>
