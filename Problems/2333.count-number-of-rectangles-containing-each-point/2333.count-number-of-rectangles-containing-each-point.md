...
aliases:
  ...
  - count-number-of-rectangles-containing-each-point
  - 统计包含每个点的矩形数目
lcLink: https://leetcode.com/problems/count-number-of-rectangles-containing-each-point/
lcTopics:
  - '[[binary-indexed-tree]]'
  - '[[array]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[2332.count-lattice-points-inside-a-circle]] | next: [[2334.number-of-flowers-in-full-bloom]] >>
