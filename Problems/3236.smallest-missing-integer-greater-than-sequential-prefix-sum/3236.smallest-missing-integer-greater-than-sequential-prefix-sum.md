...
aliases:
  ...
  - smallest-missing-integer-greater-than-sequential-prefix-sum
  - 大于等于顺序前缀和的最小缺失整数
lcLink: https://leetcode.com/problems/smallest-missing-integer-greater-than-sequential-prefix-sum/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[3235.minimum-cost-to-convert-string-i]] | next: [[3237.number-of-divisible-substrings]] >>
