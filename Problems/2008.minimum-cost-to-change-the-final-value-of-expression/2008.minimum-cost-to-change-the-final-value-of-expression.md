...
aliases:
  ...
  - minimum-cost-to-change-the-final-value-of-expression
  - 反转表达式值的最少操作次数
lcLink: https://leetcode.com/problems/minimum-cost-to-change-the-final-value-of-expression/
lcTopics:
  - '[[stack]]'
  - '[[math]]'
  - '[[string]]'
...
**Nav:** << previous: [[2007.maximum-cost-of-trip-with-k-highways]] | next: [[2009.longest-word-with-all-prefixes]] >>
