...
aliases:
  ...
  - minimum-subsequence-in-non-increasing-order
  - 非递增顺序的最小子序列
lcLink: https://leetcode.com/problems/minimum-subsequence-in-non-increasing-order/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[1518.total-sales-amount-by-year]] | next: [[1520.number-of-steps-to-reduce-a-number-in-binary-representation-to-one]] >>
