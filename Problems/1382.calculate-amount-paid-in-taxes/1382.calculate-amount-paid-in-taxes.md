...
aliases:
  ...
  - calculate-amount-paid-in-taxes
  - 计算应缴税款总额
lcLink: https://leetcode.com/problems/calculate-amount-paid-in-taxes/
lcTopics:
  - '[[array]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1381.maximum-score-words-formed-by-letters]] | next: [[1383.number-of-single-divisor-triplets]] >>
