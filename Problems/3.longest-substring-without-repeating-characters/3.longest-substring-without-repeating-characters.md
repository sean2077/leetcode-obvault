...
similarQuestions:
  ...
  - "[[1034.subarrays-with-k-different-integers|1034.K 个不同整数的子数组]]"
  - "[[1813.maximum-erasure-value|1813.删除子数组的最大得分]]"
  - "[[2209.number-of-equal-count-substrings|2209.等计数子串的数量]]"
  - "[[2338.minimum-consecutive-cards-to-pick-up|2338.必须拿起的最小连续卡牌数]]"
  - "[[2478.longest-nice-subarray|2478.最长优雅子数组]]"
  - "[[2487.optimal-partition-of-string|2487.子字符串的最优划分]]"
  - "[[2856.count-complete-subarrays-in-an-array|2856.统计完全子数组的数目]]"
  - "[[3266.find-longest-special-substring-that-occurs-thrice-ii|3266.找出出现至少三次的最长特殊子字符串 II]]"
  - "[[3267.find-longest-special-substring-that-occurs-thrice-i|3267.找出出现至少三次的最长特殊子字符串 I]]"
grade: ⭐⭐⭐⭐⭐
likes: 39841
dislikes: 1906
favorites: []
