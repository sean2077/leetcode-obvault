...
aliases:
  ...
  - check-if-a-string-is-an-acronym-of-words
  - 判别首字母缩略词
lcLink: https://leetcode.com/problems/check-if-a-string-is-an-acronym-of-words/
lcTopics:
  - '[[array]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[2955.account-balance-after-rounded-purchase]] | next: [[2978.check-if-strings-can-be-made-equal-with-operations-ii]] >>
