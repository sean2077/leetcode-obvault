...
aliases:
  ...
  - 二叉树染色
lcLink: https://leetcode.com/problems/er-cha-shu-ran-se-UGC/
lcTopics:
  - '[[tree]]'
  - '[[dynamic-programming]]'
  - '[[binary-tree]]'
...
**Nav:** << previous: [[LCP 33.o8SXZn]] | next: [[LCP 35.DFPeFJ]] >>
...
[submissions](https://leetcode.com/problems/er-cha-shu-ran-se-UGC/submissions/) | [solutions](https://leetcode.com/problems/er-cha-shu-ran-se-UGC/solutions/)
...
(define/contract (max-value root k)
...
-spec max_value(Root :: #tree_node{} | null, K :: integer()) -> integer().
max_value(Root, K) ->
  .
```
...
defmodule Solution do
  @spec max_value(root :: TreeNode.t | nil, k :: integer) :: integer
  def max_value(root, k) do
