...
aliases:
  ...
  - maximum-number-of-points-from-grid-queries
  - 矩阵查询可获得的最大分数
lcLink: https://leetcode.com/problems/maximum-number-of-points-from-grid-queries/
lcTopics:
...
**Nav:** << previous: [[2587.design-memory-allocator]] | next: [[2589.maximum-value-of-a-string-in-an-array]] >>
