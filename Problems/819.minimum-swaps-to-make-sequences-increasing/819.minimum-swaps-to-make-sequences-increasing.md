...
aliases:
  ...
  - minimum-swaps-to-make-sequences-increasing
  - 使序列递增的最小交换次数
lcLink: https://leetcode.com/problems/minimum-swaps-to-make-sequences-increasing/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[3190.minimum-operations-to-maximize-last-elements-in-arrays|3190.最大化数组末位元素的最少操作次数]]'
grade: ⭐⭐⭐⭐⭐
likes: 2811
dislikes: 138
favorites: []
...
**Nav:** << previous: [[818.similar-rgb-color]] | next: [[820.find-eventual-safe-states]] >>
