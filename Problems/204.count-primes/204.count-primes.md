...
similarQuestions:
  ...
  - '[[2507.number-of-common-factors|2507.公因子的数目]]'
  - '[[2873.prime-pairs-with-target-sum|2873.和等于目标值的质数对]]'
  - '[[3507.find-the-count-of-numbers-which-are-not-special|3507.统计不是特殊数字的数字数量]]'
grade: ⭐⭐⭐⭐
likes: 7965
dislikes: 1454
favorites: []
