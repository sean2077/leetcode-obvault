...
aliases:
  ...
  - find-the-number-of-good-pairs-ii
  - 优质数对的总数 II
lcLink: https://leetcode.com/problems/find-the-number-of-good-pairs-ii/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3443.maximum-total-reward-using-operations-ii]] | next: [[3445.lexicographically-minimum-string-after-removing-stars]] >>
