...
aliases:
  ...
  - leetcodify-similar-friends
  - 兴趣相同的朋友
lcLink: https://leetcode.com/problems/leetcodify-similar-friends/
lcTopics:
  - '[[database]]'
lcDifficulty: Hard
lcAcRate: 41.6%
...
**Nav:** << previous: [[2063.leetcodify-friends-recommendations]] | next: [[2065.check-for-contradictions-in-equations]] >>
