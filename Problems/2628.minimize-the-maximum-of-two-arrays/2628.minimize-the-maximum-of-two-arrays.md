...
aliases:
  ...
  - minimize-the-maximum-of-two-arrays
  - 最小化两个数组中的最大值
lcLink: https://leetcode.com/problems/minimize-the-maximum-of-two-arrays/
lcTopics:
  - '[[math]]'
  - '[[binary-search]]'
  - '[[number-theory]]'
...
**Nav:** << previous: [[2627.difference-between-maximum-and-minimum-price-sum]] | next: [[2629.number-of-substrings-with-fixed-ratio]] >>
