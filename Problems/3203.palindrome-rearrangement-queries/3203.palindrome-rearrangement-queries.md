...
aliases:
  ...
  - palindrome-rearrangement-queries
  - 回文串重新排列查询
lcLink: https://leetcode.com/problems/palindrome-rearrangement-queries/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[prefix-sum]]'
...
lcAcRate: 25.9%
similarQuestions:
  - '[[1251.longest-chunked-palindrome-decomposition|1251.段式回文]]'
grade: ⭐⭐⭐
likes: 85
dislikes: 25
favorites: []
...
**Nav:** << previous: [[3202.high-access-employees]] | next: [[3204.maximum-profitable-triplets-with-increasing-prices-ii]] >>
