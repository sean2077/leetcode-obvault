...
aliases:
  ...
  - solve-the-equation
  - 求解方程
lcLink: https://leetcode.com/problems/solve-the-equation/
lcTopics:
  - '[[math]]'
  - '[[string]]'
  - '[[simulation]]'
...
similarQuestions:
  ...
  - '[[2328.minimize-result-by-adding-parentheses-to-expression|2328.向表达式添加括号后的最小结果]]'
grade: ⭐
likes: 495
dislikes: 834
favorites: []
...
**Nav:** << previous: [[639.decode-ways-ii]] | next: [[642.design-search-autocomplete-system]] >>
