...
aliases:
  ...
  - calculate-parking-fees-and-duration
  - 计算停车费与时长
lcLink: https://leetcode.com/problems/calculate-parking-fees-and-duration/
lcTopics:
  - '[[database]]'
lcDifficulty: Medium
lcAcRate: 61.7%
...
**Nav:** << previous: [[3472.bitwise-or-of-adjacent-elements]] | next: [[3474.better-compression-of-string]] >>
