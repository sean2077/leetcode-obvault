...
aliases:
  ...
  - ways-to-make-a-fair-array
  - 生成平衡数组的方案数
lcLink: https://leetcode.com/problems/ways-to-make-a-fair-array/
lcTopics:
  - '[[array]]'
  - '[[prefix-sum]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1782.smallest-string-with-a-given-numeric-value]] | next: [[1784.minimum-initial-energy-to-finish-tasks]] >>
