...
aliases:
  ...
  - maximum-difference-between-node-and-ancestor
  - 节点与其祖先之间的最大差值
lcLink: https://leetcode.com/problems/maximum-difference-between-node-and-ancestor/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[binary-tree]]'
...
**Nav:** << previous: [[1091.maximum-average-subtree]] | next: [[1093.recover-a-tree-from-preorder-traversal]] >>
