...
aliases:
  ...
  - count-paths-that-can-form-a-palindrome-in-a-tree
  - 树中可以形成回文的路径数
lcLink: https://leetcode.com/problems/count-paths-that-can-form-a-palindrome-in-a-tree/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[tree]]'
  - '[[depth-first-search]]'
...
lcAcRate: 48.1%
similarQuestions:
  - '[[3112.count-valid-paths-in-a-tree|3112.统计树中的合法路径数目]]'
grade: ⭐⭐⭐⭐⭐
likes: 379
dislikes: 12
favorites: []
...
**Nav:** << previous: [[2904.sorting-three-groups]] | next: [[2907.array-prototype-foreach]] >>
