...
aliases:
  ...
  - minimum-increment-to-make-array-unique
  - 使数组唯一的最小增量
lcLink: https://leetcode.com/problems/minimum-increment-to-make-array-unique/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[counting]]'
...
**Nav:** << previous: [[981.delete-columns-to-make-sorted]] | next: [[983.validate-stack-sequences]] >>
