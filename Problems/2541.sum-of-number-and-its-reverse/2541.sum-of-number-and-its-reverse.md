...
aliases:
  ...
  - sum-of-number-and-its-reverse
  - 反转之后的数字和
lcLink: https://leetcode.com/problems/sum-of-number-and-its-reverse/
lcTopics:
  - '[[math]]'
  - '[[enumeration]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2540.color-the-triangle-red]] | next: [[2542.average-value-of-even-numbers-that-are-divisible-by-three]] >>
