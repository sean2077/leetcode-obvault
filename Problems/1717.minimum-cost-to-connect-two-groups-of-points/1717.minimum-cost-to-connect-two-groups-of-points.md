...
aliases:
  ...
  - minimum-cost-to-connect-two-groups-of-points
  - 连通两组点的最小成本
lcLink: https://leetcode.com/problems/minimum-cost-to-connect-two-groups-of-points/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1716.maximum-non-negative-product-in-a-matrix]] | next: [[1718.warehouse-manager]] >>
