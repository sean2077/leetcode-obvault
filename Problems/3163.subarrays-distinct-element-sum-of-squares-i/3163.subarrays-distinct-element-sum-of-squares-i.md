...
aliases:
  ...
  - subarrays-distinct-element-sum-of-squares-i
  - 子数组不同元素数目的平方和 I
lcLink: https://leetcode.com/problems/subarrays-distinct-element-sum-of-squares-i/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3160.calculate-orders-within-each-interval]] | next: [[3164.last-visited-integers]] >>
