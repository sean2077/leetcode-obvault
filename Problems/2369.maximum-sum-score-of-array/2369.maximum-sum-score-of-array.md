...
aliases:
  ...
  - maximum-sum-score-of-array
  - 数组的最大总分
lcLink: https://leetcode.com/problems/maximum-sum-score-of-array/
lcTopics:
  - '[[array]]'
  - '[[prefix-sum]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2368.sum-of-total-strength-of-wizards]] | next: [[2370.users-with-two-purchases-within-seven-days]] >>
