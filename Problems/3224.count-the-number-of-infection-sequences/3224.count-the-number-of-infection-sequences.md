...
aliases:
  ...
  - count-the-number-of-infection-sequences
  - 统计感冒序列的数目
lcLink: https://leetcode.com/problems/count-the-number-of-infection-sequences/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[combinatorics]]'
...
**Nav:** << previous: [[3223.count-complete-substrings]] | next: [[3225.length-of-longest-subarray-with-at-most-k-frequency]] >>
