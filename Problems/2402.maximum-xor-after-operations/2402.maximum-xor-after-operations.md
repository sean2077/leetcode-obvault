...
similarQuestions:
  ...
  - '[[3192.maximum-xor-product|3192.最大异或乘积]]'
  - '[[3261.minimize-or-of-remaining-elements-using-operations|3261.给定操作次数内使剩余元素的或值最小]]'
grade: ⭐⭐⭐
likes: 611
dislikes: 167
favorites: []
...
**Nav:** << previous: [[2401.count-asterisks]] | next: [[2403.count-unreachable-pairs-of-nodes-in-an-undirected-graph]] >>
