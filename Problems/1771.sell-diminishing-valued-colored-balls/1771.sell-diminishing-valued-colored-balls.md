...
aliases:
  ...
  - sell-diminishing-valued-colored-balls
  - 销售价值减少的颜色球
lcLink: https://leetcode.com/problems/sell-diminishing-valued-colored-balls/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[math]]'
...
**Nav:** << previous: [[1770.minimum-deletions-to-make-character-frequencies-unique]] | next: [[1772.create-sorted-array-through-instructions]] >>
