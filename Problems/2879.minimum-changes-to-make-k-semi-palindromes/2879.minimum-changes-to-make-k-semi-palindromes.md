...
aliases:
  ...
  - minimum-changes-to-make-k-semi-palindromes
  - 得到 K 个半回文串的最少修改次数
lcLink: https://leetcode.com/problems/minimum-changes-to-make-k-semi-palindromes/
lcTopics:
  - '[[two-pointers]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[2878.apply-operations-to-make-all-array-elements-equal-to-zero]] | next: [[2880.find-the-closest-marked-node]] >>
