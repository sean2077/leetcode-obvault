...
aliases:
  ...
  - find-the-prefix-common-array-of-two-arrays
  - 找到两个数组的前缀公共数组
lcLink: https://leetcode.com/problems/find-the-prefix-common-array-of-two-arrays/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2765.make-array-empty]] | next: [[2767.maximum-sum-with-exactly-k-elements]] >>
