...
aliases:
  ...
  - length-of-longest-subarray-with-at-most-k-frequency
  - 最多 K 个重复元素的最长子数组
lcLink: https://leetcode.com/problems/length-of-longest-subarray-with-at-most-k-frequency/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sliding-window]]'
...
**Nav:** << previous: [[3224.count-the-number-of-infection-sequences]] | next: [[3226.minimum-number-game]] >>
