...
aliases:
  ...
  - rank-transform-of-an-array
  - 数组序号转换
lcLink: https://leetcode.com/problems/rank-transform-of-an-array/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sorting]]'
...
lcAcRate: 62.5%
similarQuestions:
  - '[[1257.rank-transform-of-a-matrix|1257.矩阵转换后的秩]]'
  - '[[2210.find-target-indices-after-sorting-array|2210.找出数组排序后的目标下标]]'
grade: ⭐⭐⭐⭐⭐
likes: 1695
dislikes: 89
favorites: []
...
**Nav:** << previous: [[1255.reverse-subarray-to-maximize-array-value]] | next: [[1257.rank-transform-of-a-matrix]] >>
