...
aliases:
  ...
  - find-palindrome-with-fixed-length
  - 找到指定长度的回文数
lcLink: https://leetcode.com/problems/find-palindrome-with-fixed-length/
lcTopics:
  - '[[array]]'
  - '[[math]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1374.leftmost-column-with-at-least-a-one]] | next: [[1376.selling-pieces-of-wood]] >>
