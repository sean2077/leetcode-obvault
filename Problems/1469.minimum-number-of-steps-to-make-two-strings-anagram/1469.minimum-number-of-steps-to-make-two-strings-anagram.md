...
aliases:
  ...
  - minimum-number-of-steps-to-make-two-strings-anagram
  - 制造字母异位词的最小步骤数
lcLink: https://leetcode.com/problems/minimum-number-of-steps-to-make-two-strings-anagram/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[counting]]'
...
similarQuestions:
  ...
  - '[[2293.minimum-number-of-steps-to-make-two-strings-anagram-ii|2293.制造字母异位词的最小步骤数
    II]]'
grade: ⭐⭐⭐⭐⭐
likes: 2714
dislikes: 118
...
**Nav:** << previous: [[1468.check-if-n-and-its-double-exist]] | next: [[1470.tweet-counts-per-frequency]] >>
