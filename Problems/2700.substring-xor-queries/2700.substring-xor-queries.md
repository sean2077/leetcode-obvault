...
aliases:
  ...
  - substring-xor-queries
  - 子字符串异或查询
lcLink: https://leetcode.com/problems/substring-xor-queries/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[hash-table]]'
...
lcAcRate: 33.6%
similarQuestions:
  - '[[1524.string-matching-in-an-array|1524.数组中的字符串匹配]]'
grade: ⭐⭐⭐⭐
likes: 368
dislikes: 82
favorites: []
...
**Nav:** << previous: [[2699.count-the-number-of-fair-pairs]] | next: [[2701.subsequence-with-the-minimum-score]] >>
