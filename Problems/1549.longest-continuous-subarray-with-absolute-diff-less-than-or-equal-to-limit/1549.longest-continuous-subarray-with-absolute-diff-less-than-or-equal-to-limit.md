...
lcAcRate: 56.6%
similarQuestions:
  - '[[2387.partition-array-such-that-maximum-difference-is-k|2387.划分数组使最大差为 K]]'
...
**Nav:** << previous: [[1548.check-if-all-1s-are-at-least-length-k-places-away]] | next: [[1550.find-the-kth-smallest-sum-of-a-matrix-with-sorted-rows]] >>
