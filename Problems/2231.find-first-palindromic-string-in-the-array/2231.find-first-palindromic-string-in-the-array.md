...
aliases:
  ...
  - find-first-palindromic-string-in-the-array
  - 找出数组中的第一个回文字符串
lcLink: https://leetcode.com/problems/find-first-palindromic-string-in-the-array/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[string]]'
...
**Nav:** << previous: [[2230.minimum-cost-to-reach-city-with-discounts]] | next: [[2232.adding-spaces-to-a-string]] >>
