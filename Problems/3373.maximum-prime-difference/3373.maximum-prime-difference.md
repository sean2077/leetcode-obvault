...
aliases:
  ...
  - maximum-prime-difference
  - 质数的最大距离
lcLink: https://leetcode.com/problems/maximum-prime-difference/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[number-theory]]'
...
**Nav:** << previous: [[3372.longest-strictly-increasing-or-strictly-decreasing-subarray]] | next: [[3374.count-alternating-subarrays]] >>
