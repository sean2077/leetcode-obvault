...
aliases:
  ...
  - minimum-number-of-frogs-croaking
  - 数青蛙
lcLink: https://leetcode.com/problems/minimum-number-of-frogs-croaking/
lcTopics:
  - '[[string]]'
  - '[[counting]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1533.display-table-of-food-orders-in-a-restaurant]] | next: [[1535.build-array-where-you-can-find-the-maximum-exactly-k-comparisons]] >>
