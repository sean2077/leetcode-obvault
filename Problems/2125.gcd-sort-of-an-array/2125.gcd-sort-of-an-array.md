...
aliases:
  ...
  - gcd-sort-of-an-array
  - 数组的最大公因数排序
lcLink: https://leetcode.com/problems/gcd-sort-of-an-array/
lcTopics:
  - '[[union-find]]'
  - '[[array]]'
  - '[[math]]'
...
**Nav:** << previous: [[2124.first-day-where-you-have-been-in-all-the-rooms]] | next: [[2126.count-nodes-equal-to-sum-of-descendants]] >>
