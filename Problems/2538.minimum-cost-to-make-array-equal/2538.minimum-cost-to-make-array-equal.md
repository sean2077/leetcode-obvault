...
aliases:
  ...
  - minimum-cost-to-make-array-equal
  - 使数组相等的最小开销
lcLink: https://leetcode.com/problems/minimum-cost-to-make-array-equal/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[binary-search]]'
...
similarQuestions:
  ...
  - '[[2718.minimum-operations-to-make-all-array-elements-equal|2718.使数组元素全部相等的最少操作次数]]'
  - '[[3229.minimum-cost-to-make-array-equalindromic|3229.使数组成为等数数组的最小代价]]'
grade: ⭐⭐⭐⭐⭐
likes: 2383
dislikes: 35
favorites: []
...
**Nav:** << previous: [[2537.minimum-time-to-kill-all-monsters]] | next: [[2539.minimum-number-of-operations-to-make-arrays-similar]] >>
