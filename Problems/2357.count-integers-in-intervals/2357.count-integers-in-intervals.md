...
aliases:
  ...
  - count-integers-in-intervals
  - 统计区间中的整数数目
lcLink: https://leetcode.com/problems/count-integers-in-intervals/
lcTopics:
  - '[[design]]'
  - '[[segment-tree]]'
  - '[[ordered-set]]'
...
**Nav:** << previous: [[2356.largest-combination-with-bitwise-and-greater-than-zero]] | next: [[2358.number-of-ways-to-split-array]] >>
