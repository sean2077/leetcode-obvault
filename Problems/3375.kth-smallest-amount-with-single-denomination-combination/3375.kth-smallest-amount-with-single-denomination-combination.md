...
aliases:
  ...
  - kth-smallest-amount-with-single-denomination-combination
  - 单面值组合的第 K 小金额
lcLink: https://leetcode.com/problems/kth-smallest-amount-with-single-denomination-combination/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[math]]'
...
**Nav:** << previous: [[3374.count-alternating-subarrays]] | next: [[3376.longest-common-suffix-queries]] >>
