...
aliases:
  ...
  - binary-search-tree-iterator-ii
  - 二叉搜索树迭代器 II
lcLink: https://leetcode.com/problems/binary-search-tree-iterator-ii/
lcTopics:
  - '[[stack]]'
  - '[[tree]]'
  - '[[design]]'
...
**Nav:** << previous: [[1728.fancy-sequence]] | next: [[1730.special-array-with-x-elements-greater-than-or-equal-x]] >>
