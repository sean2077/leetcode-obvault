...
aliases:
  ...
  - find-the-substring-with-maximum-cost
  - 找到最大开销的子字符串
lcLink: https://leetcode.com/problems/find-the-substring-with-maximum-cost/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[2668.form-smallest-number-from-two-digit-arrays]] | next: [[2670.make-k-subarray-sums-equal]] >>
