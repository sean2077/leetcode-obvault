...
aliases:
  ...
  - two-furthest-houses-with-different-colors
  - 两栋颜色不同且距离最远的房子
lcLink: https://leetcode.com/problems/two-furthest-houses-with-different-colors/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
lcDifficulty: Easy
lcAcRate: 66.1%
similarQuestions:
  - '[[1231.replace-elements-with-greatest-element-on-right-side|1231.将每个元素替换为右侧最大元素]]'
  - '[[1984.maximum-distance-between-a-pair-of-values|1984.下标对中的最大距离]]'
  - '[[2144.maximum-difference-between-increasing-elements|2144.增量元素之间的最大差值]]'
grade: ⭐⭐⭐⭐⭐
likes: 896
dislikes: 27
favorites: []
...
**Nav:** << previous: [[2198.process-restricted-friend-requests]] | next: [[2200.stamping-the-grid]] >>
