...
similarQuestions:
  ...
  - '[[1888.find-nearest-point-that-has-the-same-x-or-y-coordinate|1888.找到最近的有相同 X
    或 Y 坐标的点]]'
  - '[[3390.minimum-rectangles-to-cover-points|3390.覆盖所有点的最少矩形数目]]'
grade: ⭐⭐⭐⭐⭐
likes: 8405
dislikes: 310
favorites: []
...
**Nav:** << previous: [[1013.fibonacci-number]] | next: [[1016.subarray-sums-divisible-by-k]] >>
