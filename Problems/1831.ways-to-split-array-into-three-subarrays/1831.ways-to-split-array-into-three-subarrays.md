...
aliases:
  ...
  - ways-to-split-array-into-three-subarrays
  - 将数组分成三个子数组的方案数
lcLink: https://leetcode.com/problems/ways-to-split-array-into-three-subarrays/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[1830.count-good-meals]] | next: [[1832.minimum-operations-to-make-a-subsequence]] >>
