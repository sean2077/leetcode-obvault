...
aliases:
  ...
  - clone-binary-tree-with-random-pointer
  - 克隆含随机指针的二叉树
lcLink: https://leetcode.com/problems/clone-binary-tree-with-random-pointer/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
...
**Nav:** << previous: [[1623.sales-by-day-of-the-week]] | next: [[1625.group-sold-products-by-the-date]] >>
