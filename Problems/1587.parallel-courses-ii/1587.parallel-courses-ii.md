...
aliases:
  ...
  - parallel-courses-ii
  - 并行课程 II
lcLink: https://leetcode.com/problems/parallel-courses-ii/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[graph]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1586.longest-subarray-of-1s-after-deleting-one-element]] | next: [[1603.running-sum-of-1d-array]] >>
