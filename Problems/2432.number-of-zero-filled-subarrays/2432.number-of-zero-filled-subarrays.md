...
aliases:
  ...
  - number-of-zero-filled-subarrays
  - 全 0 子数组的数目
lcLink: https://leetcode.com/problems/number-of-zero-filled-subarrays/
lcTopics:
  - '[[array]]'
  - '[[math]]'
lcDifficulty: Medium
...
similarQuestions:
  ...
  - '[[2620.find-consecutive-integers-from-a-data-stream|2620.找到数据流中的连续整数]]'
grade: ⭐⭐⭐⭐⭐
likes: 2257
dislikes: 83
favorites: []
...
**Nav:** << previous: [[2431.products-with-three-or-more-orders-in-two-consecutive-years]] | next: [[2433.best-poker-hand]] >>
