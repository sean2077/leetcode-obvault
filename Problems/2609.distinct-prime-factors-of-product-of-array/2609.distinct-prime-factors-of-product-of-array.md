...
aliases:
  ...
  - distinct-prime-factors-of-product-of-array
  - 数组乘积中的不同质因数数目
lcLink: https://leetcode.com/problems/distinct-prime-factors-of-product-of-array/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[math]]'
...
similarQuestions:
  ...
  - '[[1276.closest-divisors|1276.最接近的因数]]'
  - '[[2595.smallest-value-after-replacing-with-sum-of-prime-factors|2595.使用质因数之和替换后可以取到的最小值]]'
  - '[[2709.count-the-number-of-square-free-subsets|2709.无平方子集计数]]'
grade: ⭐⭐⭐⭐⭐
likes: 463
dislikes: 10
favorites: []
...
**Nav:** << previous: [[2608.count-the-digits-that-divide-a-number]] | next: [[2610.closest-prime-numbers-in-range]] >>
