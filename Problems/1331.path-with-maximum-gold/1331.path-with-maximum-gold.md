...
aliases:
  ...
  - path-with-maximum-gold
  - 黄金矿工
lcLink: https://leetcode.com/problems/path-with-maximum-gold/
lcTopics:
  - '[[array]]'
  - '[[backtracking]]'
  - '[[matrix]]'
...
**Nav:** << previous: [[1330.longest-arithmetic-subsequence-of-given-difference]] | next: [[1332.count-vowels-permutation]] >>
