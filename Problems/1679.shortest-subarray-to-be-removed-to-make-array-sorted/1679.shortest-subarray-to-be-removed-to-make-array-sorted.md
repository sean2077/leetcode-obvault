...
aliases:
  ...
  - shortest-subarray-to-be-removed-to-make-array-sorted
  - 删除最短的子数组使剩余数组有序
lcLink: https://leetcode.com/problems/shortest-subarray-to-be-removed-to-make-array-sorted/
lcTopics:
  - '[[stack]]'
  - '[[array]]'
  - '[[two-pointers]]'
...
lcAcRate: 38.0%
similarQuestions:
  - '[[3248.count-the-number-of-incremovable-subarrays-ii|3248.统计移除递增子数组的数目 II]]'
  - '[[3252.count-the-number-of-incremovable-subarrays-i|3252.统计移除递增子数组的数目 I]]'
grade: ⭐⭐⭐⭐⭐
likes: 1617
dislikes: 61
favorites: []
...
**Nav:** << previous: [[1678.number-of-ways-to-split-a-string]] | next: [[1680.count-all-possible-routes]] >>
