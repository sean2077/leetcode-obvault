...
aliases:
  ...
  - painting-a-grid-with-three-different-colors
  - 用三种不同颜色为网格涂色
lcLink: https://leetcode.com/problems/painting-a-grid-with-three-different-colors/
lcTopics:
  - '[[dynamic-programming]]'
lcDifficulty: Hard
lcAcRate: 57.7%
similarQuestions:
  - '[[1527.number-of-ways-to-paint-n-3-grid|1527.给 N x 3 网格图涂色的方案数]]'
grade: ⭐⭐⭐⭐⭐
likes: 479
dislikes: 20
favorites: []
...
**Nav:** << previous: [[2060.merge-bsts-to-create-single-bst]] | next: [[2062.game-of-nim]] >>
