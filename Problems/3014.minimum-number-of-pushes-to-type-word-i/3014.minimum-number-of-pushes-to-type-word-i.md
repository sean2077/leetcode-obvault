...
aliases:
  ...
  - minimum-number-of-pushes-to-type-word-i
  - 输入单词需要的最少按键次数 I
lcLink: https://leetcode.com/problems/minimum-number-of-pushes-to-type-word-i/
lcTopics:
  - '[[greedy]]'
  - '[[math]]'
  - '[[string]]'
...
**Nav:** << previous: [[3013.divide-an-array-into-subarrays-with-minimum-cost-ii]] | next: [[3015.count-the-number-of-houses-at-a-certain-distance-i]] >>
