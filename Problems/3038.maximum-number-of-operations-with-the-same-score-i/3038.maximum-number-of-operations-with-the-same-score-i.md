...
aliases:
  ...
  - maximum-number-of-operations-with-the-same-score-i
  - 相同分数的最大操作数目 I
lcLink: https://leetcode.com/problems/maximum-number-of-operations-with-the-same-score-i/
lcTopics:
  - '[[array]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3037.find-pattern-in-infinite-stream-ii]] | next: [[3039.apply-operations-to-make-string-empty]] >>
