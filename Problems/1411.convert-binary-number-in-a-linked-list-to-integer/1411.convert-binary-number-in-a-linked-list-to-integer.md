...
aliases:
  ...
  - convert-binary-number-in-a-linked-list-to-integer
  - 二进制链表转整数
lcLink: https://leetcode.com/problems/convert-binary-number-in-a-linked-list-to-integer/
lcTopics:
  - '[[linked-list]]'
  - '[[math]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1410.traffic-light-controlled-intersection]] | next: [[1413.maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold]] >>
