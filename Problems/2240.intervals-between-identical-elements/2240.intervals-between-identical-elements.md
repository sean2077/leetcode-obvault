...
aliases:
  ...
  - intervals-between-identical-elements
  - 相同元素的间隔之和
lcLink: https://leetcode.com/problems/intervals-between-identical-elements/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[2239.execution-of-all-suffix-instructions-staying-in-a-grid]] | next: [[2241.recover-the-original-array]] >>
