...
aliases:
  ...
  - all-divisions-with-the-highest-score-of-a-binary-array
  - 分组得分最高的所有下标
lcLink: https://leetcode.com/problems/all-divisions-with-the-highest-score-of-a-binary-array/
lcTopics:
  - '[[array]]'
lcDifficulty: Medium
lcAcRate: 64.3%
similarQuestions:
  ...
  - '[[510.count-subarrays-with-more-ones-than-zeros|510.1 比 0 多的子数组个数]]'
...
**Nav:** << previous: [[2260.divide-a-string-into-groups-of-size-k]] | next: [[2262.solving-questions-with-brainpower]] >>
