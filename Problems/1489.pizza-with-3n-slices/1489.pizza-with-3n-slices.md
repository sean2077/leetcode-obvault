...
aliases:
  ...
  - pizza-with-3n-slices
  - 3n 块披萨
lcLink: https://leetcode.com/problems/pizza-with-3n-slices/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1488.sort-integers-by-the-power-value]] | next: [[1490.generate-a-string-with-characters-that-have-odd-counts]] >>
