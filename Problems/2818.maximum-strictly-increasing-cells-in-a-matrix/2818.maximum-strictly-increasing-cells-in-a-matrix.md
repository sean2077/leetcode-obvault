...
aliases:
  ...
  - maximum-strictly-increasing-cells-in-a-matrix
  - 矩阵中严格递增的单元格数
lcLink: https://leetcode.com/problems/maximum-strictly-increasing-cells-in-a-matrix/
lcTopics:
  - '[[memoization]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2817.minimum-cost-to-make-all-characters-equal]] | next: [[2819.remove-trailing-zeros-from-a-string]] >>
