...
aliases:
  ...
  - find-the-maximum-achievable-number
  - 找出最大的可达成数字
lcLink: https://leetcode.com/problems/find-the-maximum-achievable-number/
lcTopics:
  - '[[math]]'
lcDifficulty: Easy
lcAcRate: 90.5%
...
**Nav:** << previous: [[2811.determine-the-minimum-sum-of-a-k-avoiding-array]] | next: [[2813.to-be-or-not-to-be]] >>
