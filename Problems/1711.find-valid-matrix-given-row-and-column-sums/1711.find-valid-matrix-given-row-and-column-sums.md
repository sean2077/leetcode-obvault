...
aliases:
  ...
  - find-valid-matrix-given-row-and-column-sums
  - 给定行和列的和求可行矩阵
lcLink: https://leetcode.com/problems/find-valid-matrix-given-row-and-column-sums/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[matrix]]'
...
lcAcRate: 83.1%
similarQuestions:
  - '[[1379.reconstruct-a-2-row-binary-matrix|1379.重构 2 行二进制矩阵]]'
grade: ⭐⭐⭐⭐⭐
likes: 2114
dislikes: 88
favorites: []
...
**Nav:** << previous: [[1710.find-servers-that-handled-most-number-of-requests]] | next: [[1712.unique-orders-and-customers-per-month]] >>
