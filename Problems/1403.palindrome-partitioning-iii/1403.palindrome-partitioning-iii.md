...
aliases:
  ...
  - palindrome-partitioning-iii
  - 分割回文串 III
lcLink: https://leetcode.com/problems/palindrome-partitioning-iii/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
similarQuestions:
  ...
  - '[[2879.minimum-changes-to-make-k-semi-palindromes|2879.得到 K 个半回文串的最少修改次数]]'
grade: ⭐⭐⭐⭐⭐
likes: 1147
dislikes: 19
favorites: []
...
**Nav:** << previous: [[1402.count-square-submatrices-with-all-ones]] | next: [[1404.print-immutable-linked-list-in-reverse]] >>
