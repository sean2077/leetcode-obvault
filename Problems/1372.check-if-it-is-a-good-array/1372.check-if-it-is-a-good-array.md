...
aliases:
  ...
  - check-if-it-is-a-good-array
  - 检查「好数组」
lcLink: https://leetcode.com/problems/check-if-it-is-a-good-array/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[number-theory]]'
...
**Nav:** << previous: [[1371.minimum-remove-to-make-valid-parentheses]] | next: [[1374.leftmost-column-with-at-least-a-one]] >>
