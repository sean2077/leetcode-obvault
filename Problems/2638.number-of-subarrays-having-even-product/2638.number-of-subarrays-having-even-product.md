...
aliases:
  ...
  - number-of-subarrays-having-even-product
  - 乘积为偶数的子数组数
lcLink: https://leetcode.com/problems/number-of-subarrays-having-even-product/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[2637.merge-overlapping-events-in-the-same-hall]] | next: [[2639.separate-the-digits-in-an-array]] >>
