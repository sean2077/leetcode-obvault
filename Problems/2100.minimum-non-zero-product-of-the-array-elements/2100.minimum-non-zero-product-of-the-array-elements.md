...
aliases:
  ...
  - minimum-non-zero-product-of-the-array-elements
  - 数组元素的最小非零乘积
lcLink: https://leetcode.com/problems/minimum-non-zero-product-of-the-array-elements/
lcTopics:
  - '[[greedy]]'
  - '[[recursion]]'
  - '[[math]]'
...
**Nav:** << previous: [[2099.number-of-strings-that-appear-as-substrings-in-word]] | next: [[2101.last-day-where-you-can-still-cross]] >>
