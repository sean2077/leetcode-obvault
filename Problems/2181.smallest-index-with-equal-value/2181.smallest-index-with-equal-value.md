...
aliases:
  ...
  - smallest-index-with-equal-value
  - 值相等的最小索引
lcLink: https://leetcode.com/problems/smallest-index-with-equal-value/
lcTopics:
  - '[[array]]'
lcDifficulty: Easy
lcAcRate: 73.0%
...
**Nav:** << previous: [[2180.maximum-number-of-tasks-you-can-assign]] | next: [[2182.find-the-minimum-and-maximum-number-of-nodes-between-critical-points]] >>
