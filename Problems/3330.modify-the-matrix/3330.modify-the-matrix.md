...
aliases:
  ...
  - modify-the-matrix
  - 修改矩阵
lcLink: https://leetcode.com/problems/modify-the-matrix/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3329.find-the-length-of-the-longest-common-prefix]] | next: [[3331.minimum-operations-to-exceed-threshold-value-i]] >>
