...
aliases:
  ...
  - verifying-an-alien-dictionary
  - 验证外星语词典
lcLink: https://leetcode.com/problems/verifying-an-alien-dictionary/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[989.largest-component-size-by-common-factor]] | next: [[991.array-of-doubled-pairs]] >>
