...
aliases:
  ...
  - find-beautiful-indices-in-the-given-array-i
  - 找出数组中的美丽下标 I
lcLink: https://leetcode.com/problems/find-beautiful-indices-in-the-given-array-i/
lcTopics:
  - '[[two-pointers]]'
  - '[[string]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[3244.minimize-length-of-array-using-operations]] | next: [[3246.check-if-bitwise-or-has-trailing-zeros]] >>
