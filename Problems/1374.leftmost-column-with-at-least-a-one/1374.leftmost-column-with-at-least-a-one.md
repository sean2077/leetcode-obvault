...
aliases:
  ...
  - leftmost-column-with-at-least-a-one
  - 至少有一个 1 的最左端列
lcLink: https://leetcode.com/problems/leftmost-column-with-at-least-a-one/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[interactive]]'
...
**Nav:** << previous: [[1372.check-if-it-is-a-good-array]] | next: [[1375.find-palindrome-with-fixed-length]] >>
