...
aliases:
  ...
  - counting-words-with-a-given-prefix
  - 统计包含给定前缀的字符串
lcLink: https://leetcode.com/problems/counting-words-with-a-given-prefix/
lcTopics:
  - '[[array]]'
  - '[[string]]'
  - '[[string-matching]]'
...
**Nav:** << previous: [[2291.maximum-and-sum-of-array]] | next: [[2293.minimum-number-of-steps-to-make-two-strings-anagram-ii]] >>
