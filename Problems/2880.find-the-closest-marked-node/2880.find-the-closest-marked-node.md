...
aliases:
  ...
  - find-the-closest-marked-node
  - 找到最近的标记节点
lcLink: https://leetcode.com/problems/find-the-closest-marked-node/
lcTopics:
  - '[[graph]]'
  - '[[array]]'
  - '[[shortest-path]]'
...
**Nav:** << previous: [[2879.minimum-changes-to-make-k-semi-palindromes]] | next: [[2881.split-strings-by-separator]] >>
