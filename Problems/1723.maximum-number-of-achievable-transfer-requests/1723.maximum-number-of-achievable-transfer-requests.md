...
aliases:
  ...
  - maximum-number-of-achievable-transfer-requests
  - 最多可达成的换楼请求数目
lcLink: https://leetcode.com/problems/maximum-number-of-achievable-transfer-requests/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[backtracking]]'
...
**Nav:** << previous: [[1722.throne-inheritance]] | next: [[1724.customer-who-visited-but-did-not-make-any-transactions]] >>
