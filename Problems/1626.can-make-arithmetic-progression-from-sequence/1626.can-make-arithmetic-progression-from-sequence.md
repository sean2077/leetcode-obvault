...
aliases:
  ...
  - can-make-arithmetic-progression-from-sequence
  - 判断能否形成等差数列
lcLink: https://leetcode.com/problems/can-make-arithmetic-progression-from-sequence/
lcTopics:
  - '[[array]]'
  - '[[sorting]]'
lcDifficulty: Easy
lcAcRate: 69.6%
similarQuestions:
  - '[[1752.arithmetic-subarrays|1752.等差子数组]]'
grade: ⭐⭐⭐⭐⭐
likes: 2167
dislikes: 112
favorites: []
...
**Nav:** << previous: [[1625.group-sold-products-by-the-date]] | next: [[1627.last-moment-before-all-ants-fall-out-of-a-plank]] >>
