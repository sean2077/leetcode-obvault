...
aliases:
  ...
  - rearrange-array-to-maximize-prefix-score
  - 重排数组以得到最大前缀分数
lcLink: https://leetcode.com/problems/rearrange-array-to-maximize-prefix-score/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[prefix-sum]]'
...
lcAcRate: 41.1%
similarQuestions:
  - '[[1095.two-city-scheduling|1095.两地调度]]'
grade: ⭐⭐⭐⭐
likes: 288
dislikes: 48
favorites: []
...
**Nav:** << previous: [[2654.count-the-number-of-vowel-strings-in-range]] | next: [[2656.count-the-number-of-beautiful-subarrays]] >>
