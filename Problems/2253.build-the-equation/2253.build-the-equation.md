...
aliases:
  ...
  - build-the-equation
  - 建立方程
lcLink: https://leetcode.com/problems/build-the-equation/
lcTopics:
  - '[[database]]'
lcDifficulty: Hard
lcAcRate: 55.6%
...
**Nav:** << previous: [[2252.the-airport-with-the-most-traffic]] | next: [[2254.check-if-every-row-and-column-contains-all-numbers]] >>
