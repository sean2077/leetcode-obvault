...
aliases:
  ...
  - find-three-consecutive-integers-that-sum-to-a-given-number
  - 找到和为给定整数的三个连续整数
lcLink: https://leetcode.com/problems/find-three-consecutive-integers-that-sum-to-a-given-number/
lcTopics:
  - '[[math]]'
  - '[[simulation]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2277.count-equal-and-divisible-pairs-in-an-array]] | next: [[2279.maximum-split-of-positive-even-integers]] >>
