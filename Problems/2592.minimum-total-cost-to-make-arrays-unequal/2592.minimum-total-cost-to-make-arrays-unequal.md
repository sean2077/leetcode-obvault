...
aliases:
  ...
  - minimum-total-cost-to-make-arrays-unequal
  - 让数组不相等的最小总代价
lcLink: https://leetcode.com/problems/minimum-total-cost-to-make-arrays-unequal/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2591.frog-jump-ii]] | next: [[2593.number-of-distinct-binary-strings-after-applying-operations]] >>
