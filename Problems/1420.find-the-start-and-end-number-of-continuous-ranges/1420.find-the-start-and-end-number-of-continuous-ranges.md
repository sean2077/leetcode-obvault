...
aliases:
  ...
  - find-the-start-and-end-number-of-continuous-ranges
  - 找到连续区间的开始和结束数字
lcLink: https://leetcode.com/problems/find-the-start-and-end-number-of-continuous-ranges/
lcTopics:
  - '[[database]]'
lcDifficulty: Medium
lcAcRate: 82.3%
...
**Nav:** << previous: [[1419.make-array-non-decreasing-or-non-increasing]] | next: [[1421.find-numbers-with-even-number-of-digits]] >>
