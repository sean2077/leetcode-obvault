...
aliases:
  ...
  - count-subarrays-with-median-k
  - 统计中位数为 K 的子数组
lcLink: https://leetcode.com/problems/count-subarrays-with-median-k/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[prefix-sum]]'
...
similarQuestions:
  ...
  - '[[1445.number-of-sub-arrays-of-size-k-and-average-greater-than-or-equal-to-threshold|1445.大小为
    K 且平均值大于等于阈值的子数组数目]]'
  - '[[2849.sum-of-imbalance-numbers-of-all-subarrays|2849.所有子数组中不平衡数字之和]]'
grade: ⭐⭐⭐⭐⭐
likes: 569
dislikes: 13
favorites: []
...
**Nav:** << previous: [[2573.remove-nodes-from-linked-list]] | next: [[2575.minimum-cuts-to-divide-a-circle]] >>
