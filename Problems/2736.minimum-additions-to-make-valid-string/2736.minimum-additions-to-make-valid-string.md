...
aliases:
  ...
  - minimum-additions-to-make-valid-string
  - 构造有效字符串的最少插入数
lcLink: https://leetcode.com/problems/minimum-additions-to-make-valid-string/
lcTopics:
  - '[[stack]]'
  - '[[greedy]]'
  - '[[string]]'
...
lcAcRate: 50.5%
similarQuestions:
  - '[[1894.merge-strings-alternately|1894.交替合并字符串]]'
grade: ⭐⭐⭐⭐⭐
likes: 539
dislikes: 25
favorites: []
...
**Nav:** << previous: [[2735.json-deep-equal]] | next: [[2737.row-with-maximum-ones]] >>
