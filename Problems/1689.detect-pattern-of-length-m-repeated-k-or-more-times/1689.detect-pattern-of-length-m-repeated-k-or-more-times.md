...
aliases:
  ...
  - detect-pattern-of-length-m-repeated-k-or-more-times
  - 重复至少 K 次且长度为 M 的模式
lcLink: https://leetcode.com/problems/detect-pattern-of-length-m-repeated-k-or-more-times/
lcTopics:
  - '[[array]]'
  - '[[enumeration]]'
lcDifficulty: Easy
lcAcRate: 43.2%
similarQuestions:
  - '[[1764.maximum-repeating-substring|1764.最大重复子字符串]]'
grade: ⭐⭐⭐⭐
likes: 654
dislikes: 134
favorites: []
...
**Nav:** << previous: [[1688.the-most-recent-orders-for-each-product]] | next: [[1690.maximum-length-of-subarray-with-positive-product]] >>
