...
aliases:
  ...
  - maximum-frequency-score-of-a-subarray
  - 子数组的最大频率分数
lcLink: https://leetcode.com/problems/maximum-frequency-score-of-a-subarray/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[math]]'
...
**Nav:** << previous: [[2666.minimum-time-to-eat-all-grains]] | next: [[2668.form-smallest-number-from-two-digit-arrays]] >>
