...
aliases:
  ...
  - lowest-common-ancestor-of-a-binary-tree-ii
  - 二叉树的最近公共祖先 II
lcLink: https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree-ii/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[binary-tree]]'
...
**Nav:** << previous: [[1779.hopper-company-queries-i]] | next: [[1781.check-if-two-string-arrays-are-equivalent]] >>
