...
aliases:
  ...
  - minimum-number-of-flips-to-make-binary-grid-palindromic-ii
  - 最少翻转次数使二进制矩阵回文 II
lcLink: https://leetcode.com/problems/minimum-number-of-flips-to-make-binary-grid-palindromic-ii/
lcTopics: []
lcDifficulty: Medium
lcAcRate: 18.2%
similarQuestions: []
...
**Nav:** << previous: [[3521.count-triplets-with-even-xor-set-bits-ii]] | next: [[3526.minimum-number-of-flips-to-make-binary-grid-palindromic-i]] >>
