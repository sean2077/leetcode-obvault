...
aliases:
  ...
  - max-sum-of-a-pair-with-equal-sum-of-digits
  - 数位和相等数对的最大和
lcLink: https://leetcode.com/problems/max-sum-of-a-pair-with-equal-sum-of-digits/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[2472.build-a-matrix-with-conditions]] | next: [[2474.minimum-adjacent-swaps-to-make-a-valid-array]] >>
