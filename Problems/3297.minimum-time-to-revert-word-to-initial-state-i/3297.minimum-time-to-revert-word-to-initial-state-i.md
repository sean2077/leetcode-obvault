...
aliases:
  ...
  - minimum-time-to-revert-word-to-initial-state-i
  - 将单词恢复初始状态所需的最短时间 I
lcLink: https://leetcode.com/problems/minimum-time-to-revert-word-to-initial-state-i/
lcTopics:
  - '[[string]]'
  - '[[string-matching]]'
  - '[[hash-function]]'
...
lcAcRate: 40.8%
similarQuestions:
  - '[[1508.longest-happy-prefix|1508.最长快乐前缀]]'
grade: ⭐⭐⭐⭐
likes: 139
dislikes: 31
favorites: []
...
**Nav:** << previous: [[3296.minimum-time-to-revert-word-to-initial-state-ii]] | next: [[3298.maximize-consecutive-elements-in-an-array-after-modification]] >>
