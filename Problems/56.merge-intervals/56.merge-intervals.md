...
similarQuestions:
  ...
  - '[[768.partition-labels|768.划分字母区间]]'
  - '[[1028.interval-list-intersections|1028.区间列表的交集]]'
  - '[[2297.amount-of-new-area-painted-each-day|2297.每天绘制新区域的数量]]'
  - '[[2319.longest-substring-of-one-repeating-character|2319.由单个字符重复的最长子字符串]]'
  - '[[2357.count-integers-in-intervals|2357.统计区间中的整数数目]]'
  - '[[2488.divide-intervals-into-minimum-number-of-groups|2488.将区间分为最少组数]]'
  - '[[2536.determine-if-two-events-have-conflict|2536.判断两个事件是否存在冲突]]'
  - '[[2651.count-ways-to-group-overlapping-ranges|2651.统计将重叠区间合并成组的方案数]]'
  - '[[3034.points-that-intersect-with-cars|3034.与车相交的点]]'
  - '[[3430.count-days-without-meetings|3430.无需开会的工作日]]'
grade: ⭐⭐⭐⭐⭐
likes: 22252
dislikes: 782
favorites: []
