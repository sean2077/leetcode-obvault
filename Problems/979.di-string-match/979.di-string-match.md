...
aliases:
  ...
  - di-string-match
  - 增减字符串匹配
lcLink: https://leetcode.com/problems/di-string-match/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[two-pointers]]'
...
lcAcRate: 79.0%
similarQuestions:
  - '[[2456.construct-smallest-number-from-di-string|2456.根据模式串构造最小数字]]'
grade: ⭐⭐⭐
likes: 2463
dislikes: 1019
favorites: []
...
**Nav:** << previous: [[978.valid-mountain-array]] | next: [[980.find-the-shortest-superstring]] >>
