...
aliases:
  ...
  - minimum-cost-of-a-path-with-special-roads
  - 前往目标的最小代价
lcLink: https://leetcode.com/problems/minimum-cost-of-a-path-with-special-roads/
lcTopics:
  - '[[graph]]'
  - '[[array]]'
  - '[[shortest-path]]'
...
**Nav:** << previous: [[2685.first-completely-painted-row-or-column]] | next: [[2687.lexicographically-smallest-beautiful-string]] >>
