...
aliases:
  ...
  - number-of-ways-to-select-buildings
  - 选择建筑的方案数
lcLink: https://leetcode.com/problems/number-of-ways-to-select-buildings/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[2324.find-triangular-sum-of-an-array]] | next: [[2326.sum-of-scores-of-built-strings]] >>
