...
aliases:
  ...
  - number-of-spaces-cleaning-robot-cleaned
  - 扫地机器人清扫过的空间个数
lcLink: https://leetcode.com/problems/number-of-spaces-cleaning-robot-cleaned/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[2202.sum-of-k-mirror-numbers]] | next: [[2204.find-subsequence-of-length-k-with-the-largest-sum]] >>
