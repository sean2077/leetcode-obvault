...
aliases:
  ...
  - maximum-consecutive-floors-without-special-floors
  - 不含特殊楼层的最大连续楼层数
lcLink: https://leetcode.com/problems/maximum-consecutive-floors-without-special-floors/
lcTopics:
  - '[[array]]'
  - '[[sorting]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2273.find-resultant-array-after-removing-anagrams]] | next: [[2275.largest-combination-with-bitwise-and-greater-than-zero]] >>
