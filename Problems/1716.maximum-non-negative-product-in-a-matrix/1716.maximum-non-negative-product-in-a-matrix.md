...
aliases:
  ...
  - maximum-non-negative-product-in-a-matrix
  - 矩阵的最大非负积
lcLink: https://leetcode.com/problems/maximum-non-negative-product-in-a-matrix/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
  - '[[matrix]]'
...
**Nav:** << previous: [[1715.split-a-string-into-the-max-number-of-unique-substrings]] | next: [[1717.minimum-cost-to-connect-two-groups-of-points]] >>
