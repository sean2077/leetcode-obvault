...
aliases:
  ...
  - apple-redistribution-into-boxes
  - 重新分装苹果
lcLink: https://leetcode.com/problems/apple-redistribution-into-boxes/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[3333.find-pattern-in-infinite-stream-i]] | next: [[3335.minimum-operations-to-write-the-letter-y-on-a-grid]] >>
