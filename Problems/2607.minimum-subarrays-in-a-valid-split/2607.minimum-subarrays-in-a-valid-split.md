...
aliases:
  ...
  - minimum-subarrays-in-a-valid-split
  - 有效分割中的最少子数组数目
lcLink: https://leetcode.com/problems/minimum-subarrays-in-a-valid-split/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[dynamic-programming]]'
...
lcAcRate: 54.4%
similarQuestions:
  - '[[2579.minimum-split-into-subarrays-with-gcd-greater-than-one|2579.使子数组最大公约数大于一的最小分割数]]'
grade: ⭐⭐⭐⭐
likes: 29
dislikes: 7
favorites: []
...
**Nav:** << previous: [[2606.difference-between-ones-and-zeros-in-row-and-column]] | next: [[2608.count-the-digits-that-divide-a-number]] >>
