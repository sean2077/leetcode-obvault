...
aliases:
  ...
  - longest-unequal-adjacent-groups-subsequence-i
  - 最长相邻不相等子序列 I
lcLink: https://leetcode.com/problems/longest-unequal-adjacent-groups-subsequence-i/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[string]]'
...
**Nav:** << previous: [[3142.longest-unequal-adjacent-groups-subsequence-ii]] | next: [[3148.sum-of-remoteness-of-all-cells]] >>
