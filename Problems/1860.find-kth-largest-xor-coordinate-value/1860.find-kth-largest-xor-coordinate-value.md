...
aliases:
  ...
  - find-kth-largest-xor-coordinate-value
  - 找出第 K 大的异或坐标值
lcLink: https://leetcode.com/problems/find-kth-largest-xor-coordinate-value/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[array]]'
  - '[[divide-and-conquer]]'
...
**Nav:** << previous: [[1859.change-minimum-characters-to-satisfy-one-of-three-conditions]] | next: [[1861.building-boxes]] >>
