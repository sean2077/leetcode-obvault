...
aliases:
  ...
  - shortest-uncommon-substring-in-an-array
  - 数组中的最短非公共子字符串
lcLink: https://leetcode.com/problems/shortest-uncommon-substring-in-an-array/
lcTopics:
  - '[[trie]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[3355.minimum-levels-to-gain-more-points]] | next: [[3357.employees-project-allocation]] >>
