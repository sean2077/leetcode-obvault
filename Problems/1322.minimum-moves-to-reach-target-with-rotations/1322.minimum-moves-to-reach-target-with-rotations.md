...
aliases:
  ...
  - minimum-moves-to-reach-target-with-rotations
  - 穿过迷宫的最少移动次数
lcLink: https://leetcode.com/problems/minimum-moves-to-reach-target-with-rotations/
lcTopics:
...
**Nav:** << previous: [[1321.get-equal-substrings-within-budget]] | next: [[1324.where-will-the-ball-fall]] >>
