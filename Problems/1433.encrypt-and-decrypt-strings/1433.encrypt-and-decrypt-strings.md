...
aliases:
  ...
  - encrypt-and-decrypt-strings
  - 加密解密字符串
lcLink: https://leetcode.com/problems/encrypt-and-decrypt-strings/
lcTopics:
  - '[[design]]'
  - '[[trie]]'
  - '[[array]]'
...
similarQuestions:
  ...
  - '[[1949.implement-trie-ii-prefix-tree|1949.实现 Trie （前缀树） II]]'
  - '[[3367.find-the-sum-of-encrypted-integers|3367.求出加密整数的和]]'
grade: ⭐⭐⭐⭐
likes: 332
dislikes: 77
favorites: []
...
**Nav:** << previous: [[1432.check-if-a-string-is-a-valid-sequence-from-root-to-leaves-path-in-a-binary-tree]] | next: [[1434.decrypt-string-from-alphabet-to-integer-mapping]] >>
