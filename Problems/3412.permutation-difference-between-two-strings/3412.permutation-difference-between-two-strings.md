...
aliases:
  ...
  - permutation-difference-between-two-strings
  - 两个字符串的排列差
lcLink: https://leetcode.com/problems/permutation-difference-between-two-strings/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3411.find-products-of-elements-of-big-array]] | next: [[3413.find-the-first-player-to-win-k-games-in-a-row]] >>
