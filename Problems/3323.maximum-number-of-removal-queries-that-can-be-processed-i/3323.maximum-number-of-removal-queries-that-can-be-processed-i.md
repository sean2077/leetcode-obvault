...
aliases:
  ...
  - maximum-number-of-removal-queries-that-can-be-processed-i
  - 可处理的最大删除操作数 I
lcLink: https://leetcode.com/problems/maximum-number-of-removal-queries-that-can-be-processed-i/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[3321.type-of-triangle]] | next: [[3324.split-the-array]] >>
