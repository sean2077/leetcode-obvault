...
aliases:
  ...
  - make-two-arrays-equal-by-reversing-subarrays
  - 通过翻转子数组使两个数组相等
lcLink: https://leetcode.com/problems/make-two-arrays-equal-by-reversing-subarrays/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[1555.number-of-ways-of-cutting-a-pizza]] | next: [[1557.check-if-a-string-contains-all-binary-codes-of-size-k]] >>
