...
aliases:
  ...
  - longest-subsequence-repeated-k-times
  - 重复 K 次的最长子序列
lcLink: https://leetcode.com/problems/longest-subsequence-repeated-k-times/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
  - '[[backtracking]]'
...
**Nav:** << previous: [[2139.detect-squares]] | next: [[2141.smallest-greater-multiple-made-of-two-digits]] >>
