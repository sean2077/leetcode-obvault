...
aliases:
  ...
  - minimum-operations-to-make-a-special-number
  - 生成特殊数字的最少操作
lcLink: https://leetcode.com/problems/minimum-operations-to-make-a-special-number/
lcTopics:
  - '[[greedy]]'
  - '[[math]]'
  - '[[string]]'
...
similarQuestions:
  ...
  - '[[2337.remove-digit-from-number-to-maximize-result|2337.移除指定数字得到的最大结果]]'
grade: ⭐⭐⭐⭐
likes: 345
dislikes: 52
favorites: []
...
**Nav:** << previous: [[3045.minimum-right-shifts-to-sort-the-array]] | next: [[3047.maximum-element-sum-of-a-complete-subset-of-indices]] >>
