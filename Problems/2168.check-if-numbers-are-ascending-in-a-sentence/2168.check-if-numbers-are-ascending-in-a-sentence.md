...
aliases:
  ...
  - check-if-numbers-are-ascending-in-a-sentence
  - 检查句子中的数字是否递增
lcLink: https://leetcode.com/problems/check-if-numbers-are-ascending-in-a-sentence/
lcTopics:
  - '[[string]]'
lcDifficulty: Easy
lcAcRate: 69.9%
similarQuestions:
  ...
  - '[[1970.sorting-the-sentence|1970.将句子排序]]'
  - '[[2243.check-if-all-as-appears-before-all-bs|2243.检查是否所有 A 都在 B 之前]]'
grade: ⭐⭐⭐⭐⭐
likes: 613
dislikes: 21
favorites: []
...
**Nav:** << previous: [[2167.number-of-accounts-that-did-not-stream]] | next: [[2169.simple-bank-system]] >>
