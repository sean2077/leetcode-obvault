...
aliases:
  ...
  - minimum-score-triangulation-of-polygon
  - 多边形三角剖分的最低得分
lcLink: https://leetcode.com/problems/minimum-score-triangulation-of-polygon/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1108.analyze-user-website-visit-pattern]] | next: [[1112.find-words-that-can-be-formed-by-characters]] >>
