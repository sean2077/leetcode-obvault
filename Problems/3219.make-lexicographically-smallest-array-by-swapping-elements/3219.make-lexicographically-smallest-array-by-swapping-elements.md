...
aliases:
  ...
  - make-lexicographically-smallest-array-by-swapping-elements
  - 交换得到字典序最小的数组
lcLink: https://leetcode.com/problems/make-lexicographically-smallest-array-by-swapping-elements/
lcTopics:
  - '[[union-find]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[3218.find-number-of-coins-to-place-in-tree-nodes]] | next: [[3220.count-tested-devices-after-test-operations]] >>
