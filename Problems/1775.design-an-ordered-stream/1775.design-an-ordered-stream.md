...
aliases:
  ...
  - design-an-ordered-stream
  - 设计有序流
lcLink: https://leetcode.com/problems/design-an-ordered-stream/
lcTopics:
  - '[[design]]'
  - '[[array]]'
  - '[[hash-table]]'
...
lcAcRate: 84.3%
similarQuestions:
  - '[[2512.longest-uploaded-prefix|2512.最长上传前缀]]'
grade: ⭐
likes: 527
dislikes: 3489
favorites: []
...
**Nav:** << previous: [[1774.add-two-polynomials-represented-as-linked-lists]] | next: [[1776.minimum-operations-to-reduce-x-to-zero]] >>
