...
aliases:
  ...
  - all-ancestors-of-a-node-in-a-directed-acyclic-graph
  - 有向无环图中一个节点的所有祖先
lcLink: https://leetcode.com/problems/all-ancestors-of-a-node-in-a-directed-acyclic-graph/
lcTopics:
  - '[[depth-first-search]]'
...
lcAcRate: 62.2%
similarQuestions:
  - '[[1912.number-of-restricted-paths-from-first-to-last-node|1912.从第一个节点出发到最后一个节点的受限路径数]]'
grade: ⭐⭐⭐⭐⭐
likes: 1600
dislikes: 42
favorites: []
...
**Nav:** << previous: [[1430.find-the-k-beauty-of-a-number]] | next: [[1432.check-if-a-string-is-a-valid-sequence-from-root-to-leaves-path-in-a-binary-tree]] >>
