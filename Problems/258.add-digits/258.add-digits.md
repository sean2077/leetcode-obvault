...
aliases:
  ...
  - add-digits
  - 各位相加
lcLink: https://leetcode.com/problems/add-digits/
lcTopics:
  - '[[math]]'
  - '[[number-theory]]'
  - '[[simulation]]'
...
similarQuestions:
  ...
  - '[[1082.sum-of-digits-in-the-minimum-number|1082.最小元素各数位之和]]'
  ...
  - '[[2361.calculate-digit-sum-of-a-string|2361.计算字符串的数字和]]'
  - '[[2624.difference-between-element-sum-and-digit-sum-of-an-array|2624.数组元素和与数字和的绝对差]]'
  - '[[2630.alternating-digit-sum|2630.交替数字和]]'
grade: ⭐⭐⭐
likes: 4839
dislikes: 1937
favorites: []
