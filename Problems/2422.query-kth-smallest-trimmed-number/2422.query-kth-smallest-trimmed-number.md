...
aliases:
  ...
  - query-kth-smallest-trimmed-number
  - 裁剪数字后查询第 K 小的数字
lcLink: https://leetcode.com/problems/query-kth-smallest-trimmed-number/
lcTopics:
  - '[[array]]'
  - '[[string]]'
  - '[[divide-and-conquer]]'
...
**Nav:** << previous: [[2421.maximum-number-of-pairs-in-array]] | next: [[2423.minimum-deletions-to-make-array-divisible]] >>
