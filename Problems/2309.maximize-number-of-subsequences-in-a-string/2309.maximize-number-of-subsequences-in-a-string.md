...
aliases:
  ...
  - maximize-number-of-subsequences-in-a-string
  - 字符串中最多数目的子序列
lcLink: https://leetcode.com/problems/maximize-number-of-subsequences-in-a-string/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[2308.divide-array-into-equal-pairs]] | next: [[2310.minimum-operations-to-halve-array-sum]] >>
