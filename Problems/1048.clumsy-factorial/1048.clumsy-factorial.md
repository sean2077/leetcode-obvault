...
aliases:
  ...
  - clumsy-factorial
  - 笨阶乘
lcLink: https://leetcode.com/problems/clumsy-factorial/
lcTopics:
  - '[[stack]]'
  - '[[math]]'
  - '[[simulation]]'
...
**Nav:** << previous: [[1047.maximize-sum-of-array-after-k-negations]] | next: [[1049.minimum-domino-rotations-for-equal-row]] >>
