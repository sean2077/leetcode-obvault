...
aliases:
  ...
  - subsequence-of-size-k-with-the-largest-even-sum
  - 长度为 K 的最大偶数和子序列
lcLink: https://leetcode.com/problems/subsequence-of-size-k-with-the-largest-even-sum/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
similarQuestions:
  ...
  - '[[1631.number-of-sub-arrays-with-odd-sum|1631.和为奇数的子数组数目]]'
grade: ⭐⭐⭐⭐⭐
likes: 84
dislikes: 7
favorites: []
...
**Nav:** << previous: [[2241.recover-the-original-array]] | next: [[2243.check-if-all-as-appears-before-all-bs]] >>
