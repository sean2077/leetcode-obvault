...
aliases:
  ...
  - minimum-operations-to-reduce-an-integer-to-0
  - 将整数减少到零需要的最少操作数
lcLink: https://leetcode.com/problems/minimum-operations-to-reduce-an-integer-to-0/
lcTopics:
  - '[[greedy]]'
  - '[[bit-manipulation]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[2709.count-the-number-of-square-free-subsets]] | next: [[2711.minimum-time-to-visit-a-cell-in-a-grid]] >>
