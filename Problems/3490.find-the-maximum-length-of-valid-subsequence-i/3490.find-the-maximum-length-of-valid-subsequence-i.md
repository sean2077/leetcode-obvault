...
aliases:
  ...
  - find-the-maximum-length-of-valid-subsequence-i
  - 找出有效子序列的最大长度 I
lcLink: https://leetcode.com/problems/find-the-maximum-length-of-valid-subsequence-i/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3489.the-number-of-ways-to-make-the-sum]] | next: [[3491.find-the-maximum-length-of-valid-subsequence-ii]] >>
