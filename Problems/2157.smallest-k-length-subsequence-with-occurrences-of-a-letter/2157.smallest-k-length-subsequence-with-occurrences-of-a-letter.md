...
aliases:
  ...
  - smallest-k-length-subsequence-with-occurrences-of-a-letter
  - 含特定字母的最小子序列
lcLink: https://leetcode.com/problems/smallest-k-length-subsequence-with-occurrences-of-a-letter/
lcTopics:
  - '[[stack]]'
  - '[[greedy]]'
  - '[[string]]'
...
**Nav:** << previous: [[2156.stone-game-ix]] | next: [[2158.the-number-of-seniors-and-juniors-to-join-the-company-ii]] >>
