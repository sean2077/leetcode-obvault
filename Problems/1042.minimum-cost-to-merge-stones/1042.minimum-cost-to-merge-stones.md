...
aliases:
  ...
  - minimum-cost-to-merge-stones
  - 合并石头的最低成本
lcLink: https://leetcode.com/problems/minimum-cost-to-merge-stones/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
  - '[[prefix-sum]]'
...
similarQuestions:
  ...
  - '[[1126.minimum-cost-to-connect-sticks|1126.连接木棍的最低费用]]'
grade: ⭐⭐⭐⭐⭐
likes: 2468
dislikes: 110
favorites: []
...
**Nav:** << previous: [[1041.available-captures-for-rook]] | next: [[1043.grid-illumination]] >>
