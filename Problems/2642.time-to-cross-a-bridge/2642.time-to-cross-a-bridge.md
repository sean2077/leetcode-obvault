...
aliases:
  ...
  - time-to-cross-a-bridge
  - 过桥的时间
lcLink: https://leetcode.com/problems/time-to-cross-a-bridge/
lcTopics:
  - '[[array]]'
  - '[[simulation]]'
  - '[[heap-priority-queue]]'
...
similarQuestions:
  ...
  - '[[2553.total-cost-to-hire-k-workers|2553.雇佣 K 位工人的总代价]]'
grade: ⭐
likes: 111
dislikes: 217
favorites: []
...
**Nav:** << previous: [[2641.disconnect-path-in-a-binary-matrix-by-at-most-one-flip]] | next: [[2643.concatenate-the-name-and-the-profession]] >>
