...
aliases:
  ...
  - remove-colored-pieces-if-both-neighbors-are-the-same-color
  - 如果相邻两个颜色均相同则删除当前颜色
lcLink: https://leetcode.com/problems/remove-colored-pieces-if-both-neighbors-are-the-same-color/
lcTopics:
  - '[[greedy]]'
  - '[[math]]'
  - '[[string]]'
...
**Nav:** << previous: [[2148.minimum-number-of-moves-to-seat-everyone]] | next: [[2150.kth-smallest-product-of-two-sorted-arrays]] >>
