...
aliases:
  ...
  - maximum-building-height
  - 最高建筑高度
lcLink: https://leetcode.com/problems/maximum-building-height/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[1967.longest-substring-of-all-vowels-in-order]] | next: [[1969.maximum-number-of-accepted-invitations]] >>
