...
aliases:
  ...
  - make-k-subarray-sums-equal
  - 使子数组元素和相等
lcLink: https://leetcode.com/problems/make-k-subarray-sums-equal/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[number-theory]]'
...
**Nav:** << previous: [[2669.find-the-substring-with-maximum-cost]] | next: [[2671.shortest-cycle-in-a-graph]] >>
