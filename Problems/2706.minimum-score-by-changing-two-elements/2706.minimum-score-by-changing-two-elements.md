...
aliases:
  ...
  - minimum-score-by-changing-two-elements
  - 修改两个元素的最小分数
lcLink: https://leetcode.com/problems/minimum-score-by-changing-two-elements/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[2705.minimum-impossible-or]] | next: [[2707.merge-two-2d-arrays-by-summing-values]] >>
