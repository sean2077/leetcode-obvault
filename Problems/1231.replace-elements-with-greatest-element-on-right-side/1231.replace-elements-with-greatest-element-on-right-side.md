...
aliases:
  ...
  - replace-elements-with-greatest-element-on-right-side
  - 将每个元素替换为右侧最大元素
lcLink: https://leetcode.com/problems/replace-elements-with-greatest-element-on-right-side/
lcTopics:
  - '[[array]]'
lcDifficulty: Easy
lcAcRate: 71.2%
...
**Nav:** << previous: [[1230.maximum-of-absolute-value-expression]] | next: [[1232.sum-of-mutated-array-closest-to-target]] >>
