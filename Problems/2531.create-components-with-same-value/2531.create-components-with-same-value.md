...
aliases:
  ...
  - create-components-with-same-value
  - 创建价值相同的连通块
lcLink: https://leetcode.com/problems/create-components-with-same-value/
lcTopics:
  - '[[tree]]'
  - '[[depth-first-search]]'
  - '[[array]]'
...
similarQuestions:
  ...
  - '[[3058.maximum-number-of-k-divisible-components|3058.可以被 K 整除连通块的最大数目]]'
grade: ⭐⭐⭐⭐⭐
likes: 388
dislikes: 6
favorites: []
...
**Nav:** << previous: [[2530.minimize-maximum-of-array]] | next: [[2532.remove-letter-to-equalize-frequency]] >>
