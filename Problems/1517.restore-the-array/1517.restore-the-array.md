...
aliases:
  ...
  - restore-the-array
  - 恢复数组
lcLink: https://leetcode.com/problems/restore-the-array/
lcTopics:
  - '[[string]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
lcAcRate: 47.5%
similarQuestions:
  - '[[2091.number-of-ways-to-separate-numbers|2091.划分数字的方案数]]'
  - '[[2569.number-of-beautiful-partitions|2569.完美分割的方案数]]'
grade: ⭐⭐⭐⭐⭐
likes: 1598
dislikes: 52
favorites: []
...
**Nav:** << previous: [[1516.the-k-th-lexicographical-string-of-all-happy-strings-of-length-n]] | next: [[1518.total-sales-amount-by-year]] >>
