...
aliases:
  ...
  - find-polygon-with-the-largest-perimeter
  - 找到最大周长的多边形
lcLink: https://leetcode.com/problems/find-polygon-with-the-largest-perimeter/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[3261.minimize-or-of-remaining-elements-using-operations]] | next: [[3263.divide-an-array-into-subarrays-with-minimum-cost-i]] >>
