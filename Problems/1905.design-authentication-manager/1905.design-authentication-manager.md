...
aliases:
  ...
  - design-authentication-manager
  - 设计一个验证系统
lcLink: https://leetcode.com/problems/design-authentication-manager/
lcTopics:
  - '[[design]]'
  - '[[hash-table]]'
  - '[[linked-list]]'
...
**Nav:** << previous: [[1904.second-largest-digit-in-a-string]] | next: [[1906.maximize-score-after-n-operations]] >>
