...
aliases:
  ...
  - longest-ideal-subsequence
  - 最长理想子序列
lcLink: https://leetcode.com/problems/longest-ideal-subsequence/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[2443.check-if-there-is-a-valid-partition-for-the-array]] | next: [[2445.reachable-nodes-with-restrictions]] >>
