...
aliases:
  ...
  - maximum-matrix-sum
  - 最大方阵和
lcLink: https://leetcode.com/problems/maximum-matrix-sum/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[matrix]]'
...
**Nav:** << previous: [[2088.minimum-time-to-type-word-using-special-typewriter]] | next: [[2090.number-of-ways-to-arrive-at-destination]] >>
