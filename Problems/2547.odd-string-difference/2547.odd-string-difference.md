...
aliases:
  ...
  - odd-string-difference
  - 差值数组不同的字符串
lcLink: https://leetcode.com/problems/odd-string-difference/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[2546.number-of-subarrays-with-gcd-equal-to-k]] | next: [[2548.destroy-sequential-targets]] >>
