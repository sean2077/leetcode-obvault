...
aliases:
  ...
  - maximal-score-after-applying-k-operations
  - 执行 K 次操作后的最大分数
lcLink: https://leetcode.com/problems/maximal-score-after-applying-k-operations/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[heap-priority-queue]]'
...
**Nav:** << previous: [[2615.make-number-of-distinct-characters-equal]] | next: [[2617.time-taken-to-cross-the-door]] >>
