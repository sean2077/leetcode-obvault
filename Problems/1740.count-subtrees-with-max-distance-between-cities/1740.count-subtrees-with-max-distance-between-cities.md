...
aliases:
  ...
  - count-subtrees-with-max-distance-between-cities
  - 统计子树中城市之间最大距离
lcLink: https://leetcode.com/problems/count-subtrees-with-max-distance-between-cities/
lcTopics:
  - '[[bit-manipulation]]'
  - '[[tree]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1739.split-two-strings-to-make-palindrome]] | next: [[1741.sort-array-by-increasing-frequency]] >>
