...
aliases:
  ...
  - minimum-number-of-flips-to-make-the-binary-string-alternating
  - 使二进制字符串字符交替的最少反转次数
lcLink: https://leetcode.com/problems/minimum-number-of-flips-to-make-the-binary-string-alternating/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[2016.reduction-operations-to-make-the-array-elements-equal]] | next: [[2018.minimum-space-wasted-from-packaging]] >>
