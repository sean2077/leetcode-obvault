...
aliases:
  ...
  - determine-if-two-strings-are-close
  - 确定两个字符串是否接近
lcLink: https://leetcode.com/problems/determine-if-two-strings-are-close/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
  - '[[counting]]'
...
similarQuestions:
  ...
  - '[[1469.minimum-number-of-steps-to-make-two-strings-anagram|1469.制造字母异位词的最小步骤数]]'
grade: ⭐⭐⭐⭐⭐
likes: 3686
dislikes: 294
favorites: []
...
**Nav:** << previous: [[1776.minimum-operations-to-reduce-x-to-zero]] | next: [[1778.maximize-grid-happiness]] >>
