...
aliases:
  ...
  - existence-of-a-substring-in-a-string-and-its-reverse
  - 字符串及其反转中是否存在同一子字符串
lcLink: https://leetcode.com/problems/existence-of-a-substring-in-a-string-and-its-reverse/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[3352.find-pattern-in-infinite-stream-ii]] | next: [[3354.replace-question-marks-in-string-to-minimize-its-value]] >>
