...
aliases:
  ...
  - find-subsequence-of-length-k-with-the-largest-sum
  - 找到和最大的长度为 K 的子序列
lcLink: https://leetcode.com/problems/find-subsequence-of-length-k-with-the-largest-sum/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sorting]]'
...
similarQuestions:
  ...
  - '[[1047.maximize-sum-of-array-after-k-negations|1047.K 次取反后最大化的数组和]]'
  - '[[1458.sort-integers-by-the-number-of-1-bits|1458.根据数字二进制下 1 的数目排序]]'
  - '[[2267.minimum-difference-in-sums-after-removal-of-elements|2267.删除元素后和的最小差值]]'
grade: ⭐⭐⭐⭐⭐
likes: 1251
dislikes: 131
favorites: []
...
**Nav:** << previous: [[2203.number-of-spaces-cleaning-robot-cleaned]] | next: [[2205.find-good-days-to-rob-the-bank]] >>
