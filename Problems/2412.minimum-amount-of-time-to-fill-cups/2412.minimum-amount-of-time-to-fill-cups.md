...
aliases:
  ...
  - minimum-amount-of-time-to-fill-cups
  - 装满杯子需要的最短总时长
lcLink: https://leetcode.com/problems/minimum-amount-of-time-to-fill-cups/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
lcAcRate: 57.9%
similarQuestions:
  - '[[1479.construct-target-array-with-multiple-sums|1479.多次求和构造目标数组]]'
  - '[[1879.maximum-score-from-removing-stones|1879.移除石子的最大得分]]'
...
**Nav:** << previous: [[2411.spiral-matrix-iv]] | next: [[2413.smallest-number-in-infinite-set]] >>
