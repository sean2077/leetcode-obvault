...
aliases:
  ...
  - maximum-of-absolute-value-expression
  - 绝对值表达式的最大值
lcLink: https://leetcode.com/problems/maximum-of-absolute-value-expression/
lcTopics:
  - '[[array]]'
  - '[[math]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1229.shortest-path-with-alternating-colors]] | next: [[1231.replace-elements-with-greatest-element-on-right-side]] >>
