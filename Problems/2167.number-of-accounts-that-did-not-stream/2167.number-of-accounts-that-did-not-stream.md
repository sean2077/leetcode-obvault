...
aliases:
  ...
  - number-of-accounts-that-did-not-stream
  - 无流量的帐户数
lcLink: https://leetcode.com/problems/number-of-accounts-that-did-not-stream/
lcTopics:
  - '[[database]]'
lcDifficulty: Medium
lcAcRate: 71.9%
...
**Nav:** << previous: [[2166.number-of-valid-move-combinations-on-chessboard]] | next: [[2168.check-if-numbers-are-ascending-in-a-sentence]] >>
