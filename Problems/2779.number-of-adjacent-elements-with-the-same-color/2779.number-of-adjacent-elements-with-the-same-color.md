...
aliases:
  ...
  - number-of-adjacent-elements-with-the-same-color
  - 有相同颜色的相邻元素数目
lcLink: https://leetcode.com/problems/number-of-adjacent-elements-with-the-same-color/
lcTopics:
  - '[[array]]'
lcDifficulty: Medium
lcAcRate: 54.8%
...
**Nav:** << previous: [[2778.frequency-tracker]] | next: [[2780.make-costs-of-paths-equal-in-a-binary-tree]] >>
