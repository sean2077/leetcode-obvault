...
aliases:
  ...
  - string-transformation
  - 字符串转换
lcLink: https://leetcode.com/problems/string-transformation/
lcTopics:
  - '[[math]]'
  - '[[string]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[3019.furthest-point-from-origin]] | next: [[3025.minimum-operations-to-form-subsequence-with-target-sum]] >>
