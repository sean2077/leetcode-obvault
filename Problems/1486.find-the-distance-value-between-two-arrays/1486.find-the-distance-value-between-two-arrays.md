...
aliases:
  ...
  - find-the-distance-value-between-two-arrays
  - 两个数组间的距离值
lcLink: https://leetcode.com/problems/find-the-distance-value-between-two-arrays/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[1485.minimum-cost-to-make-at-least-one-valid-path-in-a-grid]] | next: [[1487.cinema-seat-allocation]] >>
