...
aliases:
  ...
  - check-if-word-is-valid-after-substitutions
  - 检查替换后的词是否有效
lcLink: https://leetcode.com/problems/check-if-word-is-valid-after-substitutions/
lcTopics:
  - '[[stack]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1044.find-common-characters]] | next: [[1046.max-consecutive-ones-iii]] >>
