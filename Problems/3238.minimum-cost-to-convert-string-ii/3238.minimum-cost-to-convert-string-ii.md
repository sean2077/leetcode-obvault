...
aliases:
  ...
  - minimum-cost-to-convert-string-ii
  - 转换字符串的最小成本 II
lcLink: https://leetcode.com/problems/minimum-cost-to-convert-string-ii/
lcTopics:
  - '[[graph]]'
  - '[[trie]]'
  - '[[array]]'
...
**Nav:** << previous: [[3237.number-of-divisible-substrings]] | next: [[3239.minimum-number-of-operations-to-make-x-and-y-equal]] >>
