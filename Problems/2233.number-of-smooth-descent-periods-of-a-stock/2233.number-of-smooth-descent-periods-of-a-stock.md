...
aliases:
  ...
  - number-of-smooth-descent-periods-of-a-stock
  - 股票平滑下跌阶段的数目
lcLink: https://leetcode.com/problems/number-of-smooth-descent-periods-of-a-stock/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[dynamic-programming]]'
...
similarQuestions:
  ...
  - '[[1061.number-of-valid-subarrays|1061.有效子数组的数目]]'
...
**Nav:** << previous: [[2232.adding-spaces-to-a-string]] | next: [[2234.minimum-operations-to-make-the-array-k-increasing]] >>
