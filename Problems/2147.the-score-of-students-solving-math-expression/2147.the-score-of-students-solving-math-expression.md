...
aliases:
  ...
  - the-score-of-students-solving-math-expression
  - 解出数学表达式的学生分数
lcLink: https://leetcode.com/problems/the-score-of-students-solving-math-expression/
lcTopics:
  - '[[stack]]'
  - '[[memoization]]'
  - '[[array]]'
...
**Nav:** << previous: [[2146.check-if-word-can-be-placed-in-crossword]] | next: [[2148.minimum-number-of-moves-to-seat-everyone]] >>
