...
aliases:
  ...
  - find-all-k-distant-indices-in-an-array
  - 找出数组中的所有 K 近邻下标
lcLink: https://leetcode.com/problems/find-all-k-distant-indices-in-an-array/
lcTopics:
  - '[[array]]'
  - '[[two-pointers]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[2319.longest-substring-of-one-repeating-character]] | next: [[2321.minimum-weighted-subgraph-with-the-required-paths]] >>
