...
aliases:
  ...
  - second-largest-digit-in-a-string
  - 字符串中第二大的数字
lcLink: https://leetcode.com/problems/second-largest-digit-in-a-string/
lcTopics:
  - '[[hash-table]]'
  - '[[string]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1903.design-most-recently-used-queue]] | next: [[1905.design-authentication-manager]] >>
