...
aliases:
  ...
  - increment-submatrices-by-one
  - 子矩阵元素加 1
lcLink: https://leetcode.com/problems/increment-submatrices-by-one/
lcTopics:
  - '[[array]]'
  - '[[matrix]]'
  - '[[prefix-sum]]'
...
**Nav:** << previous: [[2624.difference-between-element-sum-and-digit-sum-of-an-array]] | next: [[2626.count-the-number-of-good-subarrays]] >>
