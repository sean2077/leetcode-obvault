...
aliases:
  ...
  - create-target-array-in-the-given-order
  - 按既定顺序创建目标数组
lcLink: https://leetcode.com/problems/create-target-array-in-the-given-order/
lcTopics:
  - '[[array]]'
  - '[[simulation]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1504.get-the-second-most-recent-activity]] | next: [[1507.check-if-there-is-a-valid-path-in-a-grid]] >>
