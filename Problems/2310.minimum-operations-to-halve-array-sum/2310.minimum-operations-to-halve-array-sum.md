...
aliases:
  ...
  - minimum-operations-to-halve-array-sum
  - 将数组和减半的最少操作次数
lcLink: https://leetcode.com/problems/minimum-operations-to-halve-array-sum/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[heap-priority-queue]]'
...
lcAcRate: 46.8%
similarQuestions:
  - '[[2094.remove-stones-to-minimize-the-total|2094.移除石子使总数最小]]'
  - '[[3332.minimum-operations-to-exceed-threshold-value-ii|3332.超过阈值的最少操作数 II]]'
grade: ⭐⭐⭐⭐⭐
likes: 592
dislikes: 29
favorites: []
...
**Nav:** << previous: [[2309.maximize-number-of-subsequences-in-a-string]] | next: [[2311.minimum-white-tiles-after-covering-with-carpets]] >>
