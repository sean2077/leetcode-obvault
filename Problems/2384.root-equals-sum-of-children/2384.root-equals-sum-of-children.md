...
aliases:
  ...
  - root-equals-sum-of-children
  - 判断根结点是否等于子结点之和
lcLink: https://leetcode.com/problems/root-equals-sum-of-children/
lcTopics:
  - '[[tree]]'
  - '[[binary-tree]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[2383.add-two-integers]] | next: [[2385.count-positions-on-street-with-required-brightness]] >>
