...
aliases:
  ...
  - minimum-time-visiting-all-points
  - 访问所有点的最小时间
lcLink: https://leetcode.com/problems/minimum-time-visiting-all-points/
lcTopics:
  - '[[geometry]]'
  - '[[array]]'
  - '[[math]]'
...
**Nav:** << previous: [[1394.minimum-path-cost-in-a-grid]] | next: [[1396.count-servers-that-communicate]] >>
