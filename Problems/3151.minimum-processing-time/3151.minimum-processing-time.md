...
aliases:
  ...
  - minimum-processing-time
  - 最小处理时间
lcLink: https://leetcode.com/problems/minimum-processing-time/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[sorting]]'
...
**Nav:** << previous: [[3150.shortest-and-lexicographically-smallest-beautiful-string]] | next: [[3152.maximum-value-of-an-ordered-triplet-ii]] >>
