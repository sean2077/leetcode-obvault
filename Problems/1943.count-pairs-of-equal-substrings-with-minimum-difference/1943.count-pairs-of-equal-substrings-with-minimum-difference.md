...
aliases:
  ...
  - count-pairs-of-equal-substrings-with-minimum-difference
  - 统计距离最小的子串对个数
lcLink: https://leetcode.com/problems/count-pairs-of-equal-substrings-with-minimum-difference/
lcTopics:
  - '[[greedy]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[1942.primary-department-for-each-employee]] | next: [[1944.truncate-sentence]] >>
