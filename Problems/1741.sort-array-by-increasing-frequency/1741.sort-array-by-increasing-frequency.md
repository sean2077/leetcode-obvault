...
aliases:
  ...
  - sort-array-by-increasing-frequency
  - 按照频率将数组升序排序
lcLink: https://leetcode.com/problems/sort-array-by-increasing-frequency/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[sorting]]'
...
similarQuestions:
  ...
  - '[[2308.divide-array-into-equal-pairs|2308.将数组划分成相等数对]]'
  - '[[2312.most-frequent-number-following-key-in-an-array|2312.数组中紧跟 key 之后出现最频繁的数字]]'
  - '[[2421.maximum-number-of-pairs-in-array|2421.数组能形成多少数对]]'
  - '[[2455.node-with-highest-edge-score|2455.边积分最高的节点]]'
  - '[[2502.sort-the-people|2502.按身高排序]]'
grade: ⭐⭐⭐⭐⭐
likes: 3390
dislikes: 154
favorites: []
...
**Nav:** << previous: [[1740.count-subtrees-with-max-distance-between-cities]] | next: [[1742.widest-vertical-area-between-two-points-containing-no-points]] >>
