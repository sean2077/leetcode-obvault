...
aliases:
  ...
  - replace-employee-id-with-the-unique-identifier
  - 使用唯一标识码替换员工ID
lcLink: https://leetcode.com/problems/replace-employee-id-with-the-unique-identifier/
lcTopics:
  - '[[database]]'
lcDifficulty: Easy
lcAcRate: 83.1%
...
**Nav:** << previous: [[1508.longest-happy-prefix]] | next: [[1510.find-lucky-integer-in-an-array]] >>
