...
aliases:
  ...
  - binary-searchable-numbers-in-an-unsorted-array
  - 未排序数组中的可被二分搜索的数
lcLink: https://leetcode.com/problems/binary-searchable-numbers-in-an-unsorted-array/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2110.employees-with-missing-information]] | next: [[2112.minimum-difference-between-highest-and-lowest-of-k-scores]] >>
