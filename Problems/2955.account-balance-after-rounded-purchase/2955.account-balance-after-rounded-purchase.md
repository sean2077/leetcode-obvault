...
aliases:
  ...
  - account-balance-after-rounded-purchase
  - 取整购买后的账户余额
lcLink: https://leetcode.com/problems/account-balance-after-rounded-purchase/
lcTopics:
  - '[[math]]'
lcDifficulty: Easy
lcAcRate: 52.7%
...
**Nav:** << previous: [[2954.maximum-sum-of-almost-unique-subarray]] | next: [[2977.check-if-a-string-is-an-acronym-of-words]] >>
