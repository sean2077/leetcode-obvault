...
aliases:
  ...
  - flip-columns-for-maximum-number-of-equal-rows
  - 按列翻转得到最大值等行数
lcLink: https://leetcode.com/problems/flip-columns-for-maximum-number-of-equal-rows/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
  - '[[matrix]]'
...
**Nav:** << previous: [[1146.greatest-common-divisor-of-strings]] | next: [[1148.adding-two-negabinary-numbers]] >>
