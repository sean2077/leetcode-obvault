...
aliases:
  ...
  - partitioning-into-minimum-number-of-deci-binary-numbers
  - 十-二进制数的最少数目
lcLink: https://leetcode.com/problems/partitioning-into-minimum-number-of-deci-binary-numbers/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[1806.count-of-matches-in-tournament]] | next: [[1808.stone-game-vii]] >>
