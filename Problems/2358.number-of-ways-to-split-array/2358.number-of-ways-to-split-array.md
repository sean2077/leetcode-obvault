...
aliases:
  ...
  - number-of-ways-to-split-array
  - 分割数组的方案数
lcLink: https://leetcode.com/problems/number-of-ways-to-split-array/
lcTopics:
  - '[[array]]'
  - '[[prefix-sum]]'
lcDifficulty: Medium
...
similarQuestions:
  ...
  - '[[1831.ways-to-split-array-into-three-subarrays|1831.将数组分成三个子数组的方案数]]'
  ...
  - '[[2342.minimum-average-difference|2342.最小平均差]]'
grade: ⭐⭐⭐⭐⭐
likes: 567
dislikes: 52
favorites: []
...
**Nav:** << previous: [[2357.count-integers-in-intervals]] | next: [[2359.maximum-white-tiles-covered-by-a-carpet]] >>
