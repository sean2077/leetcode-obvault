...
aliases:
  ...
  - words-within-two-edits-of-dictionary
  - 距离字典两次编辑以内的单词
lcLink: https://leetcode.com/problems/words-within-two-edits-of-dictionary/
lcTopics:
  - '[[array]]'
  - '[[string]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[2549.next-greater-element-iv]] | next: [[2551.apply-operations-to-an-array]] >>
