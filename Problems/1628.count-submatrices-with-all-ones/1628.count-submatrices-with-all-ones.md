...
aliases:
  ...
  - count-submatrices-with-all-ones
  - 统计全 1 子矩形
lcLink: https://leetcode.com/problems/count-submatrices-with-all-ones/
lcTopics:
  - '[[stack]]'
  - '[[array]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1627.last-moment-before-all-ants-fall-out-of-a-plank]] | next: [[1629.minimum-possible-integer-after-at-most-k-adjacent-swaps-on-digits]] >>
