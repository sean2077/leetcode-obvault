...
aliases:
  ...
  - latest-time-by-replacing-hidden-digits
  - 替换隐藏数字得到的最晚时间
lcLink: https://leetcode.com/problems/latest-time-by-replacing-hidden-digits/
lcTopics:
  - '[[greedy]]'
  - '[[string]]'
lcDifficulty: Easy
lcAcRate: 42.8%
similarQuestions:
  - '[[2528.number-of-valid-clock-times|2528.有效时间的数目]]'
  - '[[3361.latest-time-you-can-obtain-after-replacing-characters|3361.替换字符可以得到的最晚时间]]'
grade: ⭐⭐
likes: 367
dislikes: 182
favorites: []
...
**Nav:** << previous: [[1852.biggest-window-between-visits]] | next: [[1859.change-minimum-characters-to-satisfy-one-of-three-conditions]] >>
