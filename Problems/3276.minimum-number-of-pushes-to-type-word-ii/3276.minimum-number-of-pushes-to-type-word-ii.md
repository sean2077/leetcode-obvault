...
aliases:
  ...
  - minimum-number-of-pushes-to-type-word-ii
  - 输入单词需要的最少按键次数 II
lcLink: https://leetcode.com/problems/minimum-number-of-pushes-to-type-word-ii/
lcTopics:
  - '[[greedy]]'
  - '[[hash-table]]'
  - '[[string]]'
...
**Nav:** << previous: [[3275.minimum-number-of-pushes-to-type-word-i]] | next: [[3277.find-the-number-of-ways-to-place-people-ii]] >>
