...
lcLink: https://leetcode.com/problems/n-repeated-element-in-size-2n-array/
lcTopics:
  - '[[array]]'
  - '[[hash-table]]'
lcDifficulty: Easy
...
**Nav:** << previous: [[1000.delete-columns-to-make-sorted-iii]] | next: [[1002.maximum-width-ramp]] >>
