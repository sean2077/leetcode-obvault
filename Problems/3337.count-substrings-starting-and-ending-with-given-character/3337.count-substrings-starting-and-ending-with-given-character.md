...
aliases:
  ...
  - count-substrings-starting-and-ending-with-given-character
  - 统计以给定字符开头和结尾的子字符串总数
lcLink: https://leetcode.com/problems/count-substrings-starting-and-ending-with-given-character/
lcTopics:
  - '[[math]]'
  - '[[string]]'
  - '[[counting]]'
...
**Nav:** << previous: [[3336.water-bottles-ii]] | next: [[3338.count-submatrices-with-top-left-element-and-sum-less-than-k]] >>
