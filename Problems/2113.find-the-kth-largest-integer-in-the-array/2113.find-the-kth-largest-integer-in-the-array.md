...
aliases:
  ...
  - find-the-kth-largest-integer-in-the-array
  - 找出数组中的第 K 大整数
lcLink: https://leetcode.com/problems/find-the-kth-largest-integer-in-the-array/
lcTopics:
  - '[[array]]'
  - '[[string]]'
  - '[[divide-and-conquer]]'
...
**Nav:** << previous: [[2112.minimum-difference-between-highest-and-lowest-of-k-scores]] | next: [[2114.minimum-number-of-work-sessions-to-finish-the-tasks]] >>
