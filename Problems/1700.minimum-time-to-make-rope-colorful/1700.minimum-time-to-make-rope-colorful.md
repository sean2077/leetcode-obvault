...
aliases:
  ...
  - minimum-time-to-make-rope-colorful
  - 使绳子变成彩色的最短时间
lcLink: https://leetcode.com/problems/minimum-time-to-make-rope-colorful/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[string]]'
...
**Nav:** << previous: [[1699.number-of-ways-where-square-of-number-is-equal-to-product-of-two-numbers]] | next: [[1701.remove-max-number-of-edges-to-keep-graph-fully-traversable]] >>
