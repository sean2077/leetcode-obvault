...
aliases:
  ...
  - reconstruct-a-2-row-binary-matrix
  - 重构 2 行二进制矩阵
lcLink: https://leetcode.com/problems/reconstruct-a-2-row-binary-matrix/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[matrix]]'
...
lcAcRate: 46.7%
similarQuestions:
  - '[[1711.find-valid-matrix-given-row-and-column-sums|1711.给定行和列的和求可行矩阵]]'
grade: ⭐⭐⭐⭐⭐
likes: 462
dislikes: 34
favorites: []
...
**Nav:** << previous: [[1378.cells-with-odd-values-in-a-matrix]] | next: [[1380.number-of-closed-islands]] >>
