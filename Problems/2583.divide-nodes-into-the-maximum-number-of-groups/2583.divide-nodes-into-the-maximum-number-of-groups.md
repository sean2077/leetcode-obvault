...
aliases:
  ...
  - divide-nodes-into-the-maximum-number-of-groups
  - 将节点分成尽可能多的组
lcLink: https://leetcode.com/problems/divide-nodes-into-the-maximum-number-of-groups/
lcTopics:
...
similarQuestions:
  ...
  - '[[801.is-graph-bipartite|801.判断二分图]]'
...
**Nav:** << previous: [[2582.minimum-score-of-a-path-between-two-cities]] | next: [[2584.number-of-nodes-with-value-one]] >>
