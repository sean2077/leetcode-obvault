...
aliases:
  ...
  - matrix-cells-in-distance-order
  - 距离顺序排列矩阵单元格
lcLink: https://leetcode.com/problems/matrix-cells-in-distance-order/
lcTopics:
  - '[[geometry]]'
  - '[[array]]'
  - '[[math]]'
...
lcAcRate: 71.4%
similarQuestions:
  - '[[2304.cells-in-a-range-on-an-excel-sheet|2304.Excel 表中某个范围内的单元格]]'
grade: ⭐⭐
likes: 756
dislikes: 326
favorites: []
...
**Nav:** << previous: [[1093.recover-a-tree-from-preorder-traversal]] | next: [[1095.two-city-scheduling]] >>
