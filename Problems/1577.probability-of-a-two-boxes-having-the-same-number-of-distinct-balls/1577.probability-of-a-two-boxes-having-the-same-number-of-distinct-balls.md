...
aliases:
  ...
  - probability-of-a-two-boxes-having-the-same-number-of-distinct-balls
  - 两个盒子中球的颜色数相同的概率
lcLink: https://leetcode.com/problems/probability-of-a-two-boxes-having-the-same-number-of-distinct-balls/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[dynamic-programming]]'
...
**Nav:** << previous: [[1576.reorder-routes-to-make-all-paths-lead-to-the-city-zero]] | next: [[1578.apples-oranges]] >>
