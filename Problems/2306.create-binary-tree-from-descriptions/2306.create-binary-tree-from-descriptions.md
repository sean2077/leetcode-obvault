...
aliases:
  ...
  - create-binary-tree-from-descriptions
  - 根据描述创建二叉树
lcLink: https://leetcode.com/problems/create-binary-tree-from-descriptions/
lcTopics:
  - '[[tree]]'
  - '[[array]]'
  - '[[hash-table]]'
...
**Nav:** << previous: [[2305.append-k-integers-with-minimal-sum]] | next: [[2307.replace-non-coprime-numbers-in-array]] >>
