...
aliases:
  ...
  - last-substring-in-lexicographical-order
  - 按字典序排在最后的子串
lcLink: https://leetcode.com/problems/last-substring-in-lexicographical-order/
lcTopics:
  - '[[two-pointers]]'
  - '[[string]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[1132.before-and-after-puzzle]] | next: [[1134.shortest-distance-to-target-color]] >>
