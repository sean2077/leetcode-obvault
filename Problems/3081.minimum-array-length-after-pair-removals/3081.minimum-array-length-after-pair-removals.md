...
aliases:
  ...
  - minimum-array-length-after-pair-removals
  - 删除数对后的最小数组长度
lcLink: https://leetcode.com/problems/minimum-array-length-after-pair-removals/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
  - '[[hash-table]]'
...
lcAcRate: 22.5%
similarQuestions:
  - '[[2712.find-the-maximum-number-of-marked-indices|2712.求出最多标记下标]]'
grade: ⭐⭐⭐
likes: 367
dislikes: 96
favorites: []
...
**Nav:** << previous: [[3080.split-array-into-maximum-number-of-subarrays]] | next: [[3088.maximal-range-that-each-element-is-maximum-in-it]] >>
