...
aliases:
  ...
  - maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold
  - 元素和小于等于阈值的正方形的最大边长
lcLink: https://leetcode.com/problems/maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold/
lcTopics:
  - '[[array]]'
  - '[[binary-search]]'
  - '[[matrix]]'
...
**Nav:** << previous: [[1411.convert-binary-number-in-a-linked-list-to-integer]] | next: [[1414.shortest-path-in-a-grid-with-obstacles-elimination]] >>
