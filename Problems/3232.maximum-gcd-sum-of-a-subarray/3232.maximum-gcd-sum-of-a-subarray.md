...
aliases:
  ...
  - maximum-gcd-sum-of-a-subarray
  - 子数组的最大 GCD-Sum
lcLink: https://leetcode.com/problems/maximum-gcd-sum-of-a-subarray/
lcTopics:
  - '[[array]]'
  - '[[math]]'
  - '[[binary-search]]'
...
**Nav:** << previous: [[3231.minimum-number-of-coins-to-be-added]] | next: [[3233.maximize-the-number-of-partitions-after-operations]] >>
