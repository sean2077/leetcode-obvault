...
aliases:
  ...
  - minimum-equal-sum-of-two-arrays-after-replacing-zeros
  - 数组的最小相等和
lcLink: https://leetcode.com/problems/minimum-equal-sum-of-two-arrays-after-replacing-zeros/
lcTopics:
  - '[[greedy]]'
  - '[[array]]'
lcDifficulty: Medium
...
**Nav:** << previous: [[3170.find-indices-with-index-and-value-difference-ii]] | next: [[3172.divisible-and-non-divisible-sums-difference]] >>
