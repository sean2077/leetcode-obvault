...
aliases:
  ...
  - number-of-ways-to-earn-points
  - 获得分数的方法数
lcLink: https://leetcode.com/problems/number-of-ways-to-earn-points/
lcTopics:
  - '[[array]]'
  - '[[dynamic-programming]]'
lcDifficulty: Hard
...
**Nav:** << previous: [[2647.split-the-array-to-make-coprime-products]] | next: [[2649.count-total-number-of-colored-cells]] >>
