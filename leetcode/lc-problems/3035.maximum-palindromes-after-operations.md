...
**Nav:** << previous: [[3034.number-of-subarrays-that-match-a-pattern-i|3034.匹配模式数组的子数组数目 I]] | next: [[3036.number-of-subarrays-that-match-a-pattern-ii|3036.匹配模式数组的子数组数目 II]] >>
