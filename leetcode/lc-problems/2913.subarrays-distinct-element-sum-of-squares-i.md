...
**Nav:** << previous: [[2912.number-of-ways-to-reach-destination-in-the-grid|2912.在网格上移动到目的地的方法数]] | next: [[2914.minimum-number-of-changes-to-make-binary-string-beautiful|2914.使二进制字符串变美丽的最少修改次数]] >>
