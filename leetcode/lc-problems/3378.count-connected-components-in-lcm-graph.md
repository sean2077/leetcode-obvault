...
translatedTitle: 统计最小公倍数图中的连通块数目
...
**Nav:** << previous: [[3377.digit-operations-to-make-two-integers-equal|3377.使两个整数相等的数位操作]] | next: [[3379.transformed-array|3379.转换数组]] >>
...
[submissions](https://leetcode.com/problems/count-connected-components-in-lcm-graph/submissions/) | [solutions](https://leetcode.com/problems/count-connected-components-in-lcm-graph/solutions/)
...
[提交记录](https://leetcode.cn/problems/count-connected-components-in-lcm-graph/submissions/) | [题解](https://leetcode.cn/problems/count-connected-components-in-lcm-graph/solution/)
