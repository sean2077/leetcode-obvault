...
**Nav:** << previous: [[3029.minimum-time-to-revert-word-to-initial-state-i|3029.将单词恢复初始状态所需的最短时间 I]] | next: [[3031.minimum-time-to-revert-word-to-initial-state-ii|3031.将单词恢复初始状态所需的最短时间 II]] >>
