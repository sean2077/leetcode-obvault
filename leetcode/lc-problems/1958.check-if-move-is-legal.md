...
**Nav:** << previous: [[1957.delete-characters-to-make-fancy-string|1957.删除字符使字符串变好]] | next: [[1959.minimum-total-space-wasted-with-k-resizing-operations|1959.K 次调整数组大小浪费的最小总空间]] >>
