...
**Nav:** << previous: [[3397.maximum-number-of-distinct-elements-after-operations|3397.执行操作后不同元素的最大数量]] | next: [[3399.smallest-substring-with-identical-characters-ii|3399.字符相同的最短子字符串 II]] >>
...
[submissions](https://leetcode.com/problems/smallest-substring-with-identical-characters-i/submissions/) | [solutions](https://leetcode.com/problems/smallest-substring-with-identical-characters-i/solutions/)
...
[提交记录](https://leetcode.cn/problems/smallest-substring-with-identical-characters-i/submissions/) | [题解](https://leetcode.cn/problems/smallest-substring-with-identical-characters-i/solution/)
