...
translatedTitle: 子字符串连接后的最长回文串 I
...
**Nav:** << previous: [[3502.minimum-cost-to-reach-every-position|3502.到达每个位置的最小费用]] | next: [[3504.longest-palindrome-after-substring-concatenation-ii|3504.子字符串连接后的最长回文串 II]] >>
...
[submissions](https://leetcode.com/problems/longest-palindrome-after-substring-concatenation-i/submissions/) | [solutions](https://leetcode.com/problems/longest-palindrome-after-substring-concatenation-i/solutions/)
...
[提交记录](https://leetcode.cn/problems/longest-palindrome-after-substring-concatenation-i/submissions/) | [题解](https://leetcode.cn/problems/longest-palindrome-after-substring-concatenation-i/solution/)
