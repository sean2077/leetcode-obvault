...
**Nav:** << previous: [[2036.maximum-alternating-subarray-sum|2036.最大交替子数组和]] | next: [[2038.remove-colored-pieces-if-both-neighbors-are-the-same-color|2038.如果相邻两个颜色均相同则删除当前颜色]] >>
