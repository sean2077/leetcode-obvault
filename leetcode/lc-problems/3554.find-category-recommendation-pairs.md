...
**Nav:** << previous: [[3553.minimum-weighted-subgraph-with-the-required-paths-ii|3553.包含给定路径的最小带权子树 II]] | next: [[3555.smallest-subarray-to-sort-in-every-sliding-window|3555.排序每个滑动窗口中最小的子数组]] >>
...
[submissions](https://leetcode.com/problems/find-category-recommendation-pairs/submissions/) | [solutions](https://leetcode.com/problems/find-category-recommendation-pairs/solutions/)
...
[提交记录](https://leetcode.cn/problems/find-category-recommendation-pairs/submissions/) | [题解](https://leetcode.cn/problems/find-category-recommendation-pairs/solution/)
