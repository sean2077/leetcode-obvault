...
lcLinks:
  ...
  - https://leetcode.cn/problems/find-books-with-no-available-copies/
lcTopics:
  - "[[database]]"
lcDifficulty: Easy
lcAcRate: 53.2%
...
**Nav:** << previous: [[3569.maximize-count-of-distinct-primes-after-split|3569.分割数组后不同质数的最大数目]] | next: [[3571.find-the-shortest-superstring-ii|3571.最短超级串 II]] >>
...
[submissions](https://leetcode.com/problems/find-books-with-no-available-copies/submissions/) | [solutions](https://leetcode.com/problems/find-books-with-no-available-copies/solutions/)
...
[提交记录](https://leetcode.cn/problems/find-books-with-no-available-copies/submissions/) | [题解](https://leetcode.cn/problems/find-books-with-no-available-copies/solution/)
