...
**Nav:** << previous: [[3290.maximum-multiplication-score|3290.最高乘法得分]] | next: [[3292.minimum-number-of-valid-strings-to-form-target-ii|3292.形成目标字符串需要的最少字符串数 II]] >>
...
[submissions](https://leetcode.com/problems/minimum-number-of-valid-strings-to-form-target-i/submissions/) | [solutions](https://leetcode.com/problems/minimum-number-of-valid-strings-to-form-target-i/solutions/)
...
[提交记录](https://leetcode.cn/problems/minimum-number-of-valid-strings-to-form-target-i/submissions/) | [题解](https://leetcode.cn/problems/minimum-number-of-valid-strings-to-form-target-i/solution/)
