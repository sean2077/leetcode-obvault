...
**Nav:** << previous: [[3654.minimum-sum-after-divisible-sum-deletions|3654.删除可整除和后的最小数组和]] | next: [[3656.determine-if-a-simple-graph-exists|3656.判断是否存在简单图]] >>
...
[submissions](https://leetcode.com/problems/xor-after-range-multiplication-queries-ii/submissions/) | [solutions](https://leetcode.com/problems/xor-after-range-multiplication-queries-ii/solutions/)
...
[提交记录](https://leetcode.cn/problems/xor-after-range-multiplication-queries-ii/submissions/) | [题解](https://leetcode.cn/problems/xor-after-range-multiplication-queries-ii/solution/)
